...
#ifdef Lambdab_cxx
Lambdab::Lambdab(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("castor:///castor/cern.ch/user/p/pkoppenb/Lambdab/Lambdab2Jpsippi-MC11a-IncPsi-501.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("castor:///castor/cern.ch/user/p/pkoppenb/Lambdab/Lambdab2Jpsippi-MC11a-IncPsi-501.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("castor:///castor/cern.ch/user/p/pkoppenb/Lambdab/Lambdab2Jpsippi-MC11a-IncPsi-501.root:/Lambdab2Jpsippi_TupleMC");
