...
ToolSvc().EvtGenDecay.UserDecayFile = "Lb_JpsipK,mm=phsp,DecProdCut.dec"
...
#    ApplicationMgr().TopAlg += [ dump ]
    ...
    NTupleSvc().Output  = [ "FILE1 DATAFILE='~/scratch/Tuple-LbK.root' OPT='NEW'"] 
