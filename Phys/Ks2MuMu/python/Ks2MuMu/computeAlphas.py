...
mumucuts_2011 = fiducial_2011.fiducial + ' && mu1ismu && mu2ismu && ' + fiducial_2011.xtos
...
sel_eff_2011 = gen_eff_cut_mumu_2011*ksmumu_2011.GetEntries(fiducial_2011.fiducial + ' && mu1ismu && mu2ismu')*1./ksmumumc_2011.GetEntries()

# Get alpha_2012
import fiducial

gen_eff_cut_mumu_2012 = 0.26510
smb_2012              = 3.39e-7
