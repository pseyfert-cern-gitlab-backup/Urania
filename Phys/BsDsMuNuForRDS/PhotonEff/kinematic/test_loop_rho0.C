{
  ...
  cout<<"-----"<<endl;
  cout<<"Dstar   = "<<RHO0<<endl;
  cout<<"D0PDG   = "<<PiPDG<<endl;
  cout<<"neutral = "<<neutral<<endl;
  cout<<"p_2RF      = "<<P_2bodykinematic(Dstar,PiPDG,neutral)<<endl;
  cout<<"p_2RF_long = "<<P_2bodykinematicL(Dstar,PiPDG,neutral,ANGLE)<<endl;
  cout<<"p_2RF_tran = "<<P_2bodykinematicT(Dstar,PiPDG,neutral,ANGLE)<<endl;
  cout<<"---------------------"<<endl;
  ////////////////////////////////////
  ...
  double Neutral_L = Plongitudinalprime( P_2bodykinematicL(Dstar,PiPDG,neutral,ANGLE), P_2bodykinematicT(Dstar,PiPDG,neutral,ANGLE), neutral,       P_2bodykinematic(B,Dstar,bach), Dstar);
  double Neutral_T = P_2bodykinematicT(Dstar,PiPDG,neutral,ANGLE);
  double D0_L      = Plongitudinalprime(-P_2bodykinematicL(Dstar,PiPDG,neutral,ANGLE),-P_2bodykinematicT(Dstar,PiPDG,neutral,ANGLE), PiPDG,       P_2bodykinematic(B,Dstar,bach), Dstar);
  double D0_T      =-P_2bodykinematicT(Dstar,PiPDG,neutral,ANGLE);
