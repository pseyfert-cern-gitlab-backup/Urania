...
import sys, os
from ROOT import TFile, TTree, gROOT, gDirectory, TLorentzVector, TVector3
gROOT.SetBatch(True)
####################################################################
# Some settings
####################################################################
...
for dataTag in dataTags:
    for polarity in polarities:
        ...
        # Get the Dalitz file.
        fFriendName = getDalitzFileName(dataTag, polarity)
        fFriend = TFile.Open(fFriendName)

        # Make the new file.
        fOutName = getTemporaryFileName(dataTag, polarity)
        ...
        for tName in dataDict[dataTag]['tNames']:
            ...
            if not 'MB2DsMuNuTuple' in tName:
                ...
                c.SetBranchAddress('Ds_0.40_pi0_secPt_PE', Ds_0_40_pi0_secPt_PE)
                c.SetBranchAddress('Ds_0.40_pi0_secPt_PX', Ds_0_40_pi0_secPt_PX)
                c.SetBranchAddress('Ds_0.40_pi0_secPt_PY', Ds_0_40_pi0_secPt_PY)
                c.SetBranchAddress('Ds_0.40_pi0_secPt_PZ', Ds_0_40_pi0_secPt_PZ)

                c.SetBranchAddress('Ds_0.40_pi0_thiPt_PE', Ds_0_40_pi0_thiPt_PE)
                c.SetBranchAddress('Ds_0.40_pi0_thiPt_PX', Ds_0_40_pi0_thiPt_PX)
                c.SetBranchAddress('Ds_0.40_pi0_thiPt_PY', Ds_0_40_pi0_thiPt_PY)
                c.SetBranchAddress('Ds_0.40_pi0_thiPt_PZ', Ds_0_40_pi0_thiPt_PZ)
            ...
            tNew.Branch('triggerTag', triggerTag, 'triggerTag/I')

            # Neutral vars.
            tNew.Branch('MassDsG1_0_40', MassDsG1_0_40, 'MassDsG1_0_40/D')
            tNew.Branch('MassDsG2_0_40', MassDsG2_0_40, 'MassDsG2_0_40/D')
            tNew.Branch('MassDsG3_0_40', MassDsG3_0_40, 'MassDsG3_0_40/D')

            tNew.Branch('isGamma1InCone', isGamma1InCone, 'isGamma1InCone/I')
            tNew.Branch('isGamma2InCone', isGamma2InCone, 'isGamma2InCone/I')
            tNew.Branch('isGamma3InCone', isGamma3InCone, 'isGamma3InCone/I')

            tNew.Branch('MassDsPi01_0_40', MassDsPi01_0_40, 'MassDsPi01_0_40/D')
            tNew.Branch('MassDsPi02_0_40', MassDsPi02_0_40, 'MassDsPi02_0_40/D')
            tNew.Branch('MassDsPi03_0_40', MassDsPi03_0_40, 'MassDsPi03_0_40/D')

            tNew.Branch('isPi01InCone', isPi01InCone, 'isPi01InCone/I')
            tNew.Branch('isPi02InCone', isPi02InCone, 'isPi02InCone/I')
            tNew.Branch('isPi03InCone', isPi03InCone, 'isPi03InCone/I')

            tNew.Branch('MassDsPi0G1_0_40', MassDsPi0G1_0_40, 'MassDsPi0G1_0_40/D')
            tNew.Branch('MassDsPi0G2_0_40', MassDsPi0G2_0_40, 'MassDsPi0G2_0_40/D')
            tNew.Branch('MassDsPi0G3_0_40', MassDsPi0G3_0_40, 'MassDsPi0G3_0_40/D')
            ...
            # Link the Dalitz vars.
            #tFriend.SetBranchAddress(
            ...
            for i in range(numEntries):
                ...
                # Set the triggerTag
                triggerTag[0] =0
                if (Kpl_P[0]>5000 and Kmi_P[0]>5000 and pi_P[0]>5000 and (Kpl_PT[0]>800 or Kmi_PT[0]>800 or pi_PT[0]>800)
                    and Ds_PT[0]>2000 and Bs_0_BDTS_DOCA[0]<0.50 and Bs_0_FDCHI2_TOPPV[0]>50
                    and Ds_MM[0]>1920 and Ds_MM[0]<2010):
                    triggerTag[0]=1
                ...
                MassDsG3_0_40[0] = ( (DPe[0]+Ds_0_40_nc_thiPt_PE[0])**2 -
                                     (DPx[0]+Ds_0_40_nc_thiPt_PX[0])**2 -
                                     (DPy[0]+Ds_0_40_nc_thiPt_PY[0])**2 -
                                     (DPz[0]+Ds_0_40_nc_thiPt_PZ[0])**2 )**0.5 - Ds_MM[0] + mDs_PDG
                ...
                MassDsPi02_0_40[0] = ( (DPe[0]+Ds_0_40_pi0_secPt_PE[0])**2 -
                                     (DPx[0]+Ds_0_40_pi0_secPt_PX[0])**2 -
                                     (DPy[0]+Ds_0_40_pi0_secPt_PY[0])**2 -
                                     (DPz[0]+Ds_0_40_pi0_secPt_PZ[0])**2 )**0.5 - Ds_MM[0] + mDs_PDG
                
                MassDsPi03_0_40[0] = ( (DPe[0]+Ds_0_40_pi0_thiPt_PE[0])**2 -
                                     (DPx[0]+Ds_0_40_pi0_thiPt_PX[0])**2 -
                                     (DPy[0]+Ds_0_40_pi0_thiPt_PY[0])**2 -
                                     (DPz[0]+Ds_0_40_pi0_thiPt_PZ[0])**2 )**0.5 - Ds_MM[0] + mDs_PDG
        ...
        finalName = getFinalFileName(dataTag, polarity)
