...
void CountDs2317(){
  ...
  chain = new TFile("../src/histosPhotonReco_Data_ResolvedPi0_Veto.root");

  TH1F *h1 = (TH1F*) chain->Get("DsMuMassWithFirstG04");
  TH1F *h2 = (TH1F*) chain->Get("DsMuComb04");  
  ...
  total->Draw();
  canvas->SaveAs("CountDs2317_Data_First040.pdf");
  ...
  h2->SetLineColor(2);
  h2->Draw("same");
  canvas2->SaveAs("ScaleDs2317.pdf");
}
