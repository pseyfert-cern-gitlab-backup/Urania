...
histDict = {
    ...
    # Dstar WM vars.
    ,'WM_Dst_FullReco' : { 'name'   : ''
                           ,'units' : 'MeV/c^{2}'
                           ,'label' : 'M(K^{+} K^{-} #pi^{+}) - M(#pi^{+}[K^{+}] K^{-})'
                           ,'range' : [100.0, 1200.0] }

    ,'WM_Dst_SSKaspi_fromDz'   : { 'name'   : ''
                                   ,'units' : 'MeV/c^{2}'
    ...
    ,'WM_Jpsi_SSKasmu'  : { 'name'   : ''
                            ,'units' : 'MeV/c^{2}'
                            ,'label' : 'M(#mu^{+}[K^{+}] #mu^{-})'
                            ,'range' : [500.0, 4000.0] }
    
    ,'WM_Kstar_SSKaspi'  : {'name' : ''
                            ,'units' : 'MeV/c^{2}'
                            ,'label' : 'M(#pi^{+}[K^{+}] K^{-})'
                            ,'range' : [600.0, 1600.0] }

    ,'WM_Kstar_OSKaspi'  : {'name' : ''
                            ,'units' : 'MeV/c^{2}'
                            ,'label' : 'M(#pi^{-}[K^{-}] K^{+})'
                            ,'range' : [600.0, 1600.0] }
