...
// #################
// ##### INFO ######  
// This code makes the mass distribution of the Ds+gamma,pi0 or pi0+gamma for data 
// ################# 
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   float maxGamma = 2600.0;
   float minPi0 = 2050.0;
   float maxPi0 = 2600.0;
   float minPi0G = 2350.0;
   float maxPi0G = 2800.0;
   ...
   TH1F *hDs1MuMassFirstG04 = new TH1F("Ds1MuMassFirstG04", "Ds1MuNu Ds Mass with first photon 0.4", nbinsMu/2., minGamma+350., maxGamma);

   // pi0 mass histograms
   TH1F *hDsMuMassFirstPi004 = new TH1F("DsMuMassFirstPi004", "DsMuNu Ds Mass with first pi0 0.4", nbinsMu/resFactor, minPi0, maxPi0);
   TH1F *hDsMuMassSecondPi004 = new TH1F("DsMuMassSecondPi004", "DsMuNu Ds Mass with second pi0 0.4", nbinsMu/resFactor, minPi0, maxPi0);
   TH1F *hDsMuMassThirdPi004 = new TH1F("DsMuMassThirdPi004", "DsMuNu Ds Mass with third pi0 0.4", nbinsMu/resFactor, minPi0, maxPi0);  
 
   // pi0 gamma mass histograms
   TH1F *hDsMuMassFirstPi0G04 = new TH1F("DsMuMassFirstPi0G04", "DsMuNu Ds Mass with first pi0gamma 0.4", nbinsMu/resFactor, minPi0G, maxPi0G);
   TH1F *hDsMuMassSecondPi0G04 = new TH1F("DsMuMassSecondPi0G04", "DsMuNu Ds Mass with second pi0gamma 0.4", nbinsMu/resFactor, minPi0G, maxPi0G);
   TH1F *hDsMuMassThirdPi0G04 = new TH1F("DsMuMassThirdPi0G04", "DsMuNu Ds Mass with third pi0gamma 0.4", nbinsMu/resFactor, minPi0G, maxPi0G);
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      //if(Kpl_P>5000 && Kmi_P>5000 && pi_P>5000 && (Kpl_PT>800 || Kmi_PT>800 || pi_PT>800) && Ds_PT>2000 && Bs_0_BDTS_DOCA<0.50 && Bs_0_FDCHI2_TOPPV>50 && Ds_MM>1920 && Ds_MM<2010){
        nTrigger += 1;
        // Remove the tau component. Remove the cut of visible mass > 3000 that distorts the shape of the corrected mass
        if(Bs_0_MCORR<8000 && Bs_0_MCORR>3000 && mu_PT>1000 && mu_ProbNNmu>0.3 && Ds_MM>1940 && Ds_MM<2000 && mu_iso_MinBDT_Long>-0.5){
          nCuts += 1;
          // Ds*MuNu decays
          if(Ds_0_40_nc_mult>0 && sqrt(pow(Ds_0_40_nc_maxPt_PX,2)+pow(Ds_0_40_nc_maxPt_PY,2))>0 && Ds_0_40_nc_CL > 0.6){
            ...
            hDs1MuMassFirstG04->Fill(MassDsG1_0_40-Ds_MM+MassDsPDG);
          }
          ...
          if(Ds_0_40_trig_mult>0 && sqrt(pow(Ds_0_40_trig_maxPt_PX,2)+pow(Ds_0_40_trig_maxPt_PY,2))>0 && abs(Ds_0_40_trig_maxPt_MM-MassPi0PDG)<20 && Ds_0_40_fCL > 0.6 && Ds_0_40_sCL > 0.6 && Ds_0_40_tCL > 0.6){
            nPi0GFirst040 += 1;
            ...
            float PX_G = Ds_0_40_trig_maxPt_PX-Ds_0_40_fmaxPt_PX-Ds_0_40_smaxPt_PX;
            float PY_G = Ds_0_40_trig_maxPt_PY-Ds_0_40_fmaxPt_PY-Ds_0_40_smaxPt_PY;
            float PZ_G = Ds_0_40_trig_maxPt_PZ-Ds_0_40_fmaxPt_PZ-Ds_0_40_smaxPt_PZ;
            float E_G = sqrt(pow(PX_G,2)+pow(PY_G,2)+pow(PZ_G,2));
            float MassDsG_ForTriG = sqrt( pow(E_G+Ds_PE,2) - ( pow(PX_G+Ds_PX,2)+pow(PY_G+Ds_PY,2)+pow(PZ_G+Ds_PZ,2) ) ); 
            //float MassDsG_ForTriG = sqrt( pow((Ds_0_40_nc_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_nc_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_nc_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_nc_maxPt_PZ+Ds_PZ,2) ) );
            if(MassDsG_ForTriG<2150 && MassDsG_ForTriG>2080){ 
              hDsMuMassFirstPi0G04->Fill(MassDsPi0G1_0_40-Ds_MM+MassDsPDG);
            }
          }
          if(Ds_0_40_trig_mult>1 && sqrt(pow(Ds_0_40_trig_secPt_PX,2)+pow(Ds_0_40_trig_secPt_PY,2))>0 && abs(Ds_0_40_trig_secPt_MM-MassPi0PDG)<20 && Ds_0_40_fCL > 0.6 && Ds_0_40_sCL > 0.6 && Ds_0_40_tCL > 0.6){
            nPi0GSecond040 += 1;
          ...
          if(Ds_0_40_trig_mult>2 && sqrt(pow(Ds_0_40_trig_thiPt_PX,2)+pow(Ds_0_40_trig_thiPt_PY,2))>0 && abs(Ds_0_40_trig_thiPt_MM-MassPi0PDG)<20 && Ds_0_40_fCL > 0.6 && Ds_0_40_sCL > 0.6 && Ds_0_40_tCL > 0.6){
            nPi0GThird040 += 1;
