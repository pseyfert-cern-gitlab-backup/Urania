...
#ifndef PhotonRecoData_h
#define PhotonRecoData_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   PhotonRecoData(TTree *tree=0);
   virtual ~PhotonRecoData();
...
#ifdef PhotonRecoData_cxx
PhotonRecoData::PhotonRecoData(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      /*
      TFile *f = TFile::Open("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagDown_S24_RDS_FromTauMu_1.root");
      if (!f || !f->IsOpen()) {
        f = new TFile("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagDown_S24_RDS_FromTauMu_1.root");
      }
      tree = (TTree*)f->Get("B2DsMuNuTuple/DecayTree");

      TChain *chain = new TChain("B2DsMuNuTuple/DecayTree");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagDown_S24_RDS_FromTauMu_1.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagDown_S24_RDS_FromTauMu_2.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagUp_S24_RDS_FromTauMu.root");
      */
      /*
      TFile *f = TFile::Open("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DataMagUp_S24_RDS_FromTauMu.root");
      if (!f || !f->IsOpen()) {
        f = new TFile("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DataMagUp_S24_RDS_FromTauMu.root");
      }
      tree = (TTree*)f->Get("B2DsMuNuTuple/DecayTree");

      TChain *chain = new TChain("B2DsMuNuTuple/DecayTree");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DataMagUp_S24_RDS_FromTauMu.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DataMagDown_S24_RDS_FromTauMu.root"); 
      //tree = chain;  
      */ 
      ...
      f->GetObject("B2DsMuNuTuple/DecayTree",tree);
      ...
      TChain * chain = new TChain("B2DsMuNuTuple/DecayTree","");
      /*
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownPi0_1.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownPi0_2.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownPi0_3.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownPi0_4.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpPi0_1.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpPi0_2.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpPi0_3.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpPi04.root");
      */
      // StdLooseMergedPi0
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DownPi0.root");
      
      // StdLoosePi02gg (resolved wide mass)
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownDataPi02gg_1.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownDataPi02gg_2.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DownDataPi02gg_3.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpDataPi02gg_1.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpDataPi02gg_2.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpDataPi02gg_3.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/UpDataPi02gg_4.root");

      // StdLooseResolvedPi0
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DataDownResolvedPi0.root");
      chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/s/sogilvy/RDs/WithDsVetoes/DataUpResolvedPi0.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataDownResolvedPi0_1.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataDownResolvedPi0_2.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataDownResolvedPi0_3.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataDownResolvedPi0_4.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataUpResolvedPi0_1.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataUpResolvedPi0_2.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataUpResolvedPi0_3.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataUpResolvedPi0_4.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataUpResolvedPi0_5.root");

      // Data
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagUp_S24_RDS_FromTauMu.root/B2DsMuNuTuple/DecayTree");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagDown_S24_RDS_FromTauMu_1.root/B2DsMuNuTuple/DecayTree");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/DataMagDown_S24_RDS_FromTauMu_2.root/B2DsMuNuTuple/DecayTree");
      tree = chain;
#endif // SINGLE_TREE 
...
PhotonRecoData::~PhotonRecoData()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t PhotonRecoData::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t PhotonRecoData::LoadTree(Long64_t entry)
{
...
void PhotonRecoData::Init(TTree *tree)
{
...
void PhotonRecoData::Show(Long64_t entry)
{
...
Int_t PhotonRecoData::Cut(Long64_t entry)
{
...
#endif // #ifdef PhotonRecoData_cxx
