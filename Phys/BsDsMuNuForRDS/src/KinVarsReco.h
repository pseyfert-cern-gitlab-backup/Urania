...
// Wed Dec  2 17:23:11 2015 by ROOT version 6.03/02
// from TTree DecayTree/DecayTree
// found on file: /data/Shared/TupleProd_Dec15/DiMuon_RDS_Down.root
//////////////////////////////////////////////////////////

#ifndef KinVarsReco_h
#define KinVarsReco_h
...
#ifdef KinVarsReco_cxx
KinVarsReco::KinVarsReco(TTree *tree) : fChain(0) 
{
...
KinVarsReco::~KinVarsReco()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t KinVarsReco::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KinVarsReco::LoadTree(Long64_t entry)
{
...
void KinVarsReco::Init(TTree *tree)
{
...
void KinVarsReco::Show(Long64_t entry)
{
...
Int_t KinVarsReco::Cut(Long64_t entry)
{
