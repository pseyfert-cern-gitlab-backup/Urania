...
#ifndef DataNeutralAll_h
#define DataNeutralAll_h
...
public :
   ...
   DataNeutralAll(TTree *tree=0);
   virtual ~DataNeutralAll();
...
#ifdef DataNeutralAll_cxx
DataNeutralAll::DataNeutralAll(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      // no veto
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/TupleRDS_DataUp_1_allNeutrals.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/TupleRDS_DataUp_2_allNeutrals.root");
      //chain->Add("root://eoslhcb.cern.ch//eos/lhcb/user/r/rvazquez/RDS/TupleRDS_DataDown_1_allNeutrals.root");
...
DataNeutralAll::~DataNeutralAll()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t DataNeutralAll::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t DataNeutralAll::LoadTree(Long64_t entry)
{
...
void DataNeutralAll::Init(TTree *tree)
{
...
void DataNeutralAll::Show(Long64_t entry)
{
...
Int_t DataNeutralAll::Cut(Long64_t entry)
{
...
#endif // #ifdef DataNeutralAll_cxx
