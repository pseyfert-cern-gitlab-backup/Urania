...
// Wed Dec  2 17:23:22 2015 by ROOT version 6.03/02
// from TTree DecayTree/DecayTree
// found on file: /data/Shared/TupleProd_Dec15/DiMuon_RDS_Down.root
//////////////////////////////////////////////////////////

#ifndef KinVarsMatched_h
#define KinVarsMatched_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   KinVarsMatched(TTree *tree=0);
   virtual ~KinVarsMatched();
...
#ifdef KinVarsMatched_cxx
KinVarsMatched::KinVarsMatched(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      tree = (TTree*)f->Get("MBsDMuNuTuple/DecayTree");
      TChain *chain = new TChain("MBsDMuNuTuple/DecayTree");
...
KinVarsMatched::~KinVarsMatched()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t KinVarsMatched::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t KinVarsMatched::LoadTree(Long64_t entry)
{
...
void KinVarsMatched::Init(TTree *tree)
{
...
void KinVarsMatched::Show(Long64_t entry)
{
...
Int_t KinVarsMatched::Cut(Long64_t entry)
{
...
#endif // #ifdef KinVarsMatched_cxx
