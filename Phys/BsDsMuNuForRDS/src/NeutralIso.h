...
#ifdef NeutralIso_cxx
NeutralIso::NeutralIso(TTree *tree) : fChain(0) 
{
...
Int_t NeutralIso::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t NeutralIso::LoadTree(Long64_t entry)
{
...
void NeutralIso::Init(TTree *tree)
{
...
void NeutralIso::Show(Long64_t entry)
{
...
Int_t NeutralIso::Cut(Long64_t entry)
{
