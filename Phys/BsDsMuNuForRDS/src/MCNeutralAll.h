...
// Mon Apr  4 11:12:12 2016 by ROOT version 5.34/32
// from TTree DecayTree/DecayTree
// found on file: /afs/cern.ch/user/r/rvazquez/gangadir/workspace/rvazquez/LocalXML/609/MCDown_RDS_AllNeutrals.root
//////////////////////////////////////////////////////////

#ifndef MCNeutralAll_h
#define MCNeutralAll_h
...
public :
   ...
   Double_t        Bs_0_M;
   Int_t           Bs_0_TRUEID;
   Int_t           Bs_0_MC_MOTHER_ID;
   Int_t           Bs_0_MC_MOTHER_KEY;
   Int_t           Bs_0_MC_GD_MOTHER_ID;
   Int_t           Bs_0_MC_GD_MOTHER_KEY;
   Int_t           Bs_0_MC_GD_GD_MOTHER_ID;
   Int_t           Bs_0_MC_GD_GD_MOTHER_KEY;
   Double_t        Bs_0_TRUEP_E;
   Double_t        Bs_0_TRUEP_X;
   Double_t        Bs_0_TRUEP_Y;
   Double_t        Bs_0_TRUEP_Z;
   Double_t        Bs_0_TRUEPT;
   Double_t        Bs_0_TRUEORIGINVERTEX_X;
   Double_t        Bs_0_TRUEORIGINVERTEX_Y;
   Double_t        Bs_0_TRUEORIGINVERTEX_Z;
   Double_t        Bs_0_TRUEENDVERTEX_X;
   Double_t        Bs_0_TRUEENDVERTEX_Y;
   Double_t        Bs_0_TRUEENDVERTEX_Z;
   Bool_t          Bs_0_TRUEISSTABLE;
   Double_t        Bs_0_TRUETAU;
   Int_t           Bs_0_ID;
   Double_t        Bs_0_eta;
   Double_t        Bs_0_phi;
   Double_t        Bs_0_doca;
   Double_t        Bs_0_D1_isolation_Giampi;
   Double_t        Bs_0_D1_isolation_Giampi_tc;
   Double_t        Bs_0_D1_isolation_Giampi_new1;
   Double_t        Bs_0_D1_isolation_Giampi_new2;
   Double_t        Bs_0_D1_isolation_Giampi_newD0;
   Double_t        Bs_0_cosnk;
   ...
   Double_t        Bs_0_D1_isobdt1_1st;
   Double_t        Bs_0_D1_isobdt1_2nd;
   Double_t        Bs_0_D1_isobdt1_3rd;
   Double_t        Bs_0_D1_isobdt2_1st;
   Double_t        Bs_0_D1_isobdt2_2nd;
   Double_t        Bs_0_D1_isobdt2_3rd;
   Double_t        Bs_0_D1_isobdt3_1st;
   Double_t        Bs_0_D1_isobdt3_2nd;
   Double_t        Bs_0_D1_isobdt3_3rd;
   Double_t        Bs_0_D1_isobdt4_1st;
   ...
   Bool_t          Bs_0_Hlt2XcMuXForTauB2XcMuDecision_Dec;
   Bool_t          Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TIS;
   Bool_t          Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TOS;
   Bool_t          Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_Dec;
   Bool_t          Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TIS;
   Bool_t          Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TOS;
   ...
   Double_t        Ds_Dalitz_piplus_Kplus_M2;
   Double_t        Ds_Dalitz_Kminus_Kplus_M2;
   Double_t        Ds_Dalitz_Kminus_piplus_M2;
   Double_t        Ds_MINIP;
   ...
   Double_t        Ds_eta;
   Double_t        Ds_phi;
   Double_t        Ds_typeOriginVtx;
   Double_t        Ds_nEndVertices;
   Double_t        Ds_ancestorpid;
   Double_t        Ds_MCI;
   Double_t        Ds_TAU;
   Double_t        Ds_TAUERR;
   Double_t        Ds_TAUCHI2;
   ...
   Double_t        Ds_0_40_nc_thiPt_PX;
   Double_t        Ds_0_40_nc_thiPt_PY;
   Double_t        Ds_0_40_nc_thiPt_PZ;
   Double_t        Ds_0_40_nc_thiPt_PE;
   Double_t        Ds_0_40_nc_CL;
   Double_t        Ds_0_40_nc_Shape;
   Double_t        Ds_0_40_nc_Match;
   Double_t        Ds_0_40_nc_PID;
   Double_t        Ds_0_40_nc_CNV;
   Double_t        Ds_0_40_nc_PRS;
   Int_t           Ds_0_40_pi0_mult;
   Double_t        Ds_0_40_pi0_vPT;
   Double_t        Ds_0_40_pi0_sPT;
   Double_t        Ds_0_40_pi0_PX;
   Double_t        Ds_0_40_pi0_PY;
   Double_t        Ds_0_40_pi0_PZ;
   Double_t        Ds_0_40_pi0_maxPt_PT;
   ...
   Double_t        Ds_0_40_pi0_secPt_PX;
   Double_t        Ds_0_40_pi0_secPt_PY;
   Double_t        Ds_0_40_pi0_secPt_PZ;
   Double_t        Ds_0_40_pi0_secPt_MM;
   Double_t        Ds_0_40_pi0_secPt_PE;
   Double_t        Ds_0_40_pi0_thiPt_PX;
   Double_t        Ds_0_40_pi0_thiPt_PY;
   Double_t        Ds_0_40_pi0_thiPt_PZ;
   Double_t        Ds_0_40_pi0_thiPt_MM;
   Double_t        Ds_0_40_pi0_thiPt_PE;
   Double_t        Ds_0_40_pi0_CL;
   Double_t        Ds_0_40_g1_CL;
   Double_t        Ds_0_40_g2_CL;
   Double_t        Ds_0_40_g1maxPt_PX;
   Double_t        Ds_0_40_g1maxPt_PY;
   Double_t        Ds_0_40_g1maxPt_PZ;
   Double_t        Ds_0_40_g2maxPt_PX;
   Double_t        Ds_0_40_g2maxPt_PY;
   Double_t        Ds_0_40_g2maxPt_PZ;
   Int_t           Ds_0_40_trig_mult;
   Double_t        Ds_0_40_trig_vPT;
   Double_t        Ds_0_40_trig_sPT;
   Double_t        Ds_0_40_trig_PX;
   Double_t        Ds_0_40_trig_PY;
   Double_t        Ds_0_40_trig_PZ;
   Double_t        Ds_0_40_trig_maxPt_PT;
   Double_t        Ds_0_40_trig_maxPt_PX;
   Double_t        Ds_0_40_trig_maxPt_PY;
   Double_t        Ds_0_40_trig_maxPt_PZ;
   Double_t        Ds_0_40_trig_maxPt_MM;
   Double_t        Ds_0_40_trig_secPt_PX;
   Double_t        Ds_0_40_trig_secPt_PY;
   Double_t        Ds_0_40_trig_secPt_PZ;
   Double_t        Ds_0_40_trig_secPt_MM;
   Double_t        Ds_0_40_trig_thiPt_PX;
   Double_t        Ds_0_40_trig_thiPt_PY;
   Double_t        Ds_0_40_trig_thiPt_PZ;
   Double_t        Ds_0_40_trig_thiPt_MM;
   Double_t        Ds_0_40_fCL;
   Double_t        Ds_0_40_sCL;
   Double_t        Ds_0_40_tCL;
   Double_t        Ds_0_40_fmaxPt_PX;
   Double_t        Ds_0_40_fmaxPt_PY;
   Double_t        Ds_0_40_fmaxPt_PZ;
   Double_t        Ds_0_40_smaxPt_PX;
   Double_t        Ds_0_40_smaxPt_PY;
   Double_t        Ds_0_40_smaxPt_PZ;
   ...
   Double_t        Kmi_M;
   Int_t           Kmi_TRUEID;
   Int_t           Kmi_MC_MOTHER_ID;
   Int_t           Kmi_MC_MOTHER_KEY;
   Int_t           Kmi_MC_GD_MOTHER_ID;
   Int_t           Kmi_MC_GD_MOTHER_KEY;
   Int_t           Kmi_MC_GD_GD_MOTHER_ID;
   Int_t           Kmi_MC_GD_GD_MOTHER_KEY;
   Double_t        Kmi_TRUEP_E;
   Double_t        Kmi_TRUEP_X;
   Double_t        Kmi_TRUEP_Y;
   Double_t        Kmi_TRUEP_Z;
   Double_t        Kmi_TRUEPT;
   Double_t        Kmi_TRUEORIGINVERTEX_X;
   Double_t        Kmi_TRUEORIGINVERTEX_Y;
   Double_t        Kmi_TRUEORIGINVERTEX_Z;
   Double_t        Kmi_TRUEENDVERTEX_X;
   Double_t        Kmi_TRUEENDVERTEX_Y;
   Double_t        Kmi_TRUEENDVERTEX_Z;
   Bool_t          Kmi_TRUEISSTABLE;
   Double_t        Kmi_TRUETAU;
   Int_t           Kmi_ID;
   Double_t        Kmi_eta;
   Double_t        Kmi_phi;
   Double_t        Kmi_typeOriginVtx;
   Double_t        Kmi_nEndVertices;
   Double_t        Kmi_ancestorpid;
   Double_t        Kmi_MCI;
   Double_t        Kmi_PIDe;
   Double_t        Kmi_PIDmu;
   Double_t        Kmi_PIDK;
   ...
   Double_t        Kpl_M;
   Int_t           Kpl_TRUEID;
   Int_t           Kpl_MC_MOTHER_ID;
   Int_t           Kpl_MC_MOTHER_KEY;
   Int_t           Kpl_MC_GD_MOTHER_ID;
   Int_t           Kpl_MC_GD_MOTHER_KEY;
   Int_t           Kpl_MC_GD_GD_MOTHER_ID;
   Int_t           Kpl_MC_GD_GD_MOTHER_KEY;
   Double_t        Kpl_TRUEP_E;
   Double_t        Kpl_TRUEP_X;
   Double_t        Kpl_TRUEP_Y;
   Double_t        Kpl_TRUEP_Z;
   Double_t        Kpl_TRUEPT;
   Double_t        Kpl_TRUEORIGINVERTEX_X;
   Double_t        Kpl_TRUEORIGINVERTEX_Y;
   Double_t        Kpl_TRUEORIGINVERTEX_Z;
   Double_t        Kpl_TRUEENDVERTEX_X;
   Double_t        Kpl_TRUEENDVERTEX_Y;
   Double_t        Kpl_TRUEENDVERTEX_Z;
   Bool_t          Kpl_TRUEISSTABLE;
   Double_t        Kpl_TRUETAU;
   Int_t           Kpl_ID;
   Double_t        Kpl_eta;
   Double_t        Kpl_phi;
   Double_t        Kpl_typeOriginVtx;
   Double_t        Kpl_nEndVertices;
   Double_t        Kpl_ancestorpid;
   Double_t        Kpl_MCI;
   Double_t        Kpl_PIDe;
   Double_t        Kpl_PIDmu;
   Double_t        Kpl_PIDK;
   ...
   Double_t        pi_eta;
   Double_t        pi_phi;
   Double_t        pi_typeOriginVtx;
   Double_t        pi_nEndVertices;
   Double_t        pi_ancestorpid;
   Double_t        pi_MCI;
   Double_t        pi_PIDe;
   Double_t        pi_PIDmu;
   Double_t        pi_PIDK;
   ...
   Double_t        mu_eta;
   Double_t        mu_phi;
   Double_t        mu_typeOriginVtx;
   Double_t        mu_nEndVertices;
   Double_t        mu_ancestorpid;
   Double_t        mu_MCI;
   Double_t        mu_PIDe;
   Double_t        mu_PIDmu;
   Double_t        mu_PIDK;
   ...
   Double_t        mu_0_40_nc_maxPt_PT;
   Double_t        mu_0_40_nc_maxPt_PX;
   Double_t        mu_0_40_nc_maxPt_PY;
   Double_t        mu_0_40_nc_maxPt_PZ;
   Double_t        mu_0_40_nc_maxPt_PE;
   Double_t        mu_0_40_nc_secPt_PX;
   Double_t        mu_0_40_nc_secPt_PY;
   Double_t        mu_0_40_nc_secPt_PZ;
   Double_t        mu_0_40_nc_secPt_PE;
   Double_t        mu_0_40_nc_thiPt_PX;
   Double_t        mu_0_40_nc_thiPt_PY;
   Double_t        mu_0_40_nc_thiPt_PZ;
   Double_t        mu_0_40_nc_thiPt_PE;
   Double_t        mu_0_40_nc_CL;
   Double_t        mu_0_40_nc_Shape;
   Double_t        mu_0_40_nc_Match;
   Double_t        mu_0_40_nc_PID;
   Double_t        mu_0_40_nc_CNV;
   Double_t        mu_0_40_nc_PRS;
   Int_t           mu_0_40_pi0_mult;
   Double_t        mu_0_40_pi0_vPT;
   Double_t        mu_0_40_pi0_sPT;
   Double_t        mu_0_40_pi0_PX;
   Double_t        mu_0_40_pi0_PY;
   Double_t        mu_0_40_pi0_PZ;
   Double_t        mu_0_40_pi0_maxPt_PT;
   Double_t        mu_0_40_pi0_maxPt_PX;
   Double_t        mu_0_40_pi0_maxPt_PY;
   Double_t        mu_0_40_pi0_maxPt_PZ;
   Double_t        mu_0_40_pi0_maxPt_MM;
   Double_t        mu_0_40_pi0_maxPt_PE;
   Double_t        mu_0_40_pi0_secPt_PX;
   Double_t        mu_0_40_pi0_secPt_PY;
   Double_t        mu_0_40_pi0_secPt_PZ;
   Double_t        mu_0_40_pi0_secPt_MM;
   Double_t        mu_0_40_pi0_secPt_PE;
   Double_t        mu_0_40_pi0_thiPt_PX;
   Double_t        mu_0_40_pi0_thiPt_PY;
   Double_t        mu_0_40_pi0_thiPt_PZ;
   Double_t        mu_0_40_pi0_thiPt_MM;
   Double_t        mu_0_40_pi0_thiPt_PE;
   Double_t        mu_0_40_pi0_CL;
   Double_t        mu_0_40_g1_CL;
   Double_t        mu_0_40_g2_CL;
   Double_t        mu_0_40_g1maxPt_PX;
   Double_t        mu_0_40_g1maxPt_PY;
   Double_t        mu_0_40_g1maxPt_PZ;
   Double_t        mu_0_40_g2maxPt_PX;
   Double_t        mu_0_40_g2maxPt_PY;
   Double_t        mu_0_40_g2maxPt_PZ;
   Int_t           mu_0_40_trig_mult;
   Double_t        mu_0_40_trig_vPT;
   Double_t        mu_0_40_trig_sPT;
   Double_t        mu_0_40_trig_PX;
   Double_t        mu_0_40_trig_PY;
   Double_t        mu_0_40_trig_PZ;
   Double_t        mu_0_40_trig_maxPt_PT;
   Double_t        mu_0_40_trig_maxPt_PX;
   Double_t        mu_0_40_trig_maxPt_PY;
   Double_t        mu_0_40_trig_maxPt_PZ;
   Double_t        mu_0_40_trig_maxPt_MM;
   Double_t        mu_0_40_trig_secPt_PX;
   Double_t        mu_0_40_trig_secPt_PY;
   Double_t        mu_0_40_trig_secPt_PZ;
   Double_t        mu_0_40_trig_secPt_MM;
   Double_t        mu_0_40_trig_thiPt_PX;
   Double_t        mu_0_40_trig_thiPt_PY;
   Double_t        mu_0_40_trig_thiPt_PZ;
   Double_t        mu_0_40_trig_thiPt_MM;
   Double_t        mu_0_40_fCL;
   Double_t        mu_0_40_sCL;
   Double_t        mu_0_40_tCL;
   Double_t        mu_0_40_fmaxPt_PX;
   Double_t        mu_0_40_fmaxPt_PY;
   Double_t        mu_0_40_fmaxPt_PZ;
   ...
   TBranch        *b_Bs_0_M;   //!
   TBranch        *b_Bs_0_TRUEID;   //!
   TBranch        *b_Bs_0_MC_MOTHER_ID;   //!
   TBranch        *b_Bs_0_MC_MOTHER_KEY;   //!
   TBranch        *b_Bs_0_MC_GD_MOTHER_ID;   //!
   TBranch        *b_Bs_0_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_Bs_0_MC_GD_GD_MOTHER_ID;   //!
   TBranch        *b_Bs_0_MC_GD_GD_MOTHER_KEY;   //!
   TBranch        *b_Bs_0_TRUEP_E;   //!
   TBranch        *b_Bs_0_TRUEP_X;   //!
   TBranch        *b_Bs_0_TRUEP_Y;   //!
   TBranch        *b_Bs_0_TRUEP_Z;   //!
   TBranch        *b_Bs_0_TRUEPT;   //!
   TBranch        *b_Bs_0_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_Bs_0_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_Bs_0_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_Bs_0_TRUEENDVERTEX_X;   //!
   TBranch        *b_Bs_0_TRUEENDVERTEX_Y;   //!
   TBranch        *b_Bs_0_TRUEENDVERTEX_Z;   //!
   TBranch        *b_Bs_0_TRUEISSTABLE;   //!
   TBranch        *b_Bs_0_TRUETAU;   //!
   TBranch        *b_Bs_0_ID;   //!
   TBranch        *b_Bs_0_eta;   //!
   TBranch        *b_Bs_0_phi;   //!
   TBranch        *b_Bs_0_doca;   //!
   TBranch        *b_Bs_0_D1_isolation_Giampi;   //!
   TBranch        *b_Bs_0_D1_isolation_Giampi_tc;   //!
   TBranch        *b_Bs_0_D1_isolation_Giampi_new1;   //!
   TBranch        *b_Bs_0_D1_isolation_Giampi_new2;   //!
   TBranch        *b_Bs_0_D1_isolation_Giampi_newD0;   //!
   TBranch        *b_Bs_0_cosnk;   //!
   ...
   TBranch        *b_Bs_0_D1_isobdt1_1st;   //!
   TBranch        *b_Bs_0_D1_isobdt1_2nd;   //!
   TBranch        *b_Bs_0_D1_isobdt1_3rd;   //!
   TBranch        *b_Bs_0_D1_isobdt2_1st;   //!
   TBranch        *b_Bs_0_D1_isobdt2_2nd;   //!
   TBranch        *b_Bs_0_D1_isobdt2_3rd;   //!
   TBranch        *b_Bs_0_D1_isobdt3_1st;   //!
   TBranch        *b_Bs_0_D1_isobdt3_2nd;   //!
   TBranch        *b_Bs_0_D1_isobdt3_3rd;   //!
   TBranch        *b_Bs_0_D1_isobdt4_1st;   //!
   TBranch        *b_Bs_0_D1_isobdt4_2nd;   //!
   TBranch        *b_Bs_0_D1_isobdt4_3rd;   //!
   TBranch        *b_MCGEN_num;   //!
   ...
   TBranch        *b_Bs_0_typeOriginVtx;   //!
   TBranch        *b_Bs_0_nEndVertices;   //!
   TBranch        *b_Bs_0_ancestorpid;   //!
   TBranch        *b_Bs_0_MCI;   //!
   TBranch        *b_Bs_0_TAU;   //!
   ...
   TBranch        *b_Bs_0_Hlt2XcMuXForTauB2XcMuDecision_Dec;   //!
   TBranch        *b_Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TIS;   //!
   TBranch        *b_Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TOS;   //!
   TBranch        *b_Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_Dec;   //!
   TBranch        *b_Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TIS;   //!
   TBranch        *b_Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TOS;   //!
   ...
   TBranch        *b_Ds_Dalitz_piplus_Kplus_M2;   //!
   TBranch        *b_Ds_Dalitz_Kminus_Kplus_M2;   //!
   TBranch        *b_Ds_Dalitz_Kminus_piplus_M2;   //!
   TBranch        *b_Ds_MINIP;   //!
   ...
   TBranch        *b_Ds_eta;   //!
   TBranch        *b_Ds_phi;   //!
   TBranch        *b_Ds_typeOriginVtx;   //!
   TBranch        *b_Ds_nEndVertices;   //!
   TBranch        *b_Ds_ancestorpid;   //!
   TBranch        *b_Ds_MCI;   //!
   TBranch        *b_Ds_TAU;   //!
   TBranch        *b_Ds_TAUERR;   //!
   ...
   TBranch        *b_Ds_0_40_nc_thiPt_PX;   //!
   TBranch        *b_Ds_0_40_nc_thiPt_PY;   //!
   TBranch        *b_Ds_0_40_nc_thiPt_PZ;   //!
   TBranch        *b_Ds_0_40_nc_thiPt_PE;   //!
   TBranch        *b_Ds_0_40_nc_CL;   //!
   TBranch        *b_Ds_0_40_nc_Shape;   //!
   TBranch        *b_Ds_0_40_nc_Match;   //!
   TBranch        *b_Ds_0_40_nc_PID;   //!
   TBranch        *b_Ds_0_40_nc_CNV;   //!
   TBranch        *b_Ds_0_40_nc_PRS;   //!
   TBranch        *b_Ds_0_40_pi0_mult;   //!
   TBranch        *b_Ds_0_40_pi0_vPT;   //!
   TBranch        *b_Ds_0_40_pi0_sPT;   //!
   TBranch        *b_Ds_0_40_pi0_PX;   //!
   TBranch        *b_Ds_0_40_pi0_PY;   //!
   TBranch        *b_Ds_0_40_pi0_PZ;   //!
   TBranch        *b_Ds_0_40_pi0_maxPt_PT;   //!
   ...
   TBranch        *b_Ds_0_40_pi0_secPt_PX;   //!
   TBranch        *b_Ds_0_40_pi0_secPt_PY;   //!
   TBranch        *b_Ds_0_40_pi0_secPt_PZ;   //!
   TBranch        *b_Ds_0_40_pi0_secPt_MM;   //!
   TBranch        *b_Ds_0_40_pi0_secPt_PE;   //!
   TBranch        *b_Ds_0_40_pi0_thiPt_PX;   //!
   TBranch        *b_Ds_0_40_pi0_thiPt_PY;   //!
   TBranch        *b_Ds_0_40_pi0_thiPt_PZ;   //!
   TBranch        *b_Ds_0_40_pi0_thiPt_MM;   //!
   TBranch        *b_Ds_0_40_pi0_thiPt_PE;   //!
   TBranch        *b_Ds_0_40_pi0_CL;   //!
   TBranch        *b_Ds_0_40_g1_CL;   //!
   TBranch        *b_Ds_0_40_g2_CL;   //!
   TBranch        *b_Ds_0_40_g1maxPt_PX;   //!
   TBranch        *b_Ds_0_40_g1maxPt_PY;   //!
   TBranch        *b_Ds_0_40_g1maxPt_PZ;   //!
   TBranch        *b_Ds_0_40_g2maxPt_PX;   //!
   TBranch        *b_Ds_0_40_g2maxPt_PY;   //!
   TBranch        *b_Ds_0_40_g2maxPt_PZ;   //!
   TBranch        *b_Ds_0_40_trig_mult;   //!
   TBranch        *b_Ds_0_40_trig_vPT;   //!
   TBranch        *b_Ds_0_40_trig_sPT;   //!
   TBranch        *b_Ds_0_40_trig_PX;   //!
   TBranch        *b_Ds_0_40_trig_PY;   //!
   TBranch        *b_Ds_0_40_trig_PZ;   //!
   TBranch        *b_Ds_0_40_trig_maxPt_PT;   //!
   TBranch        *b_Ds_0_40_trig_maxPt_PX;   //!
   TBranch        *b_Ds_0_40_trig_maxPt_PY;   //!
   TBranch        *b_Ds_0_40_trig_maxPt_PZ;   //!
   TBranch        *b_Ds_0_40_trig_maxPt_MM;   //!
   TBranch        *b_Ds_0_40_trig_secPt_PX;   //!
   TBranch        *b_Ds_0_40_trig_secPt_PY;   //!
   TBranch        *b_Ds_0_40_trig_secPt_PZ;   //!
   TBranch        *b_Ds_0_40_trig_secPt_MM;   //!
   TBranch        *b_Ds_0_40_trig_thiPt_PX;   //!
   TBranch        *b_Ds_0_40_trig_thiPt_PY;   //!
   TBranch        *b_Ds_0_40_trig_thiPt_PZ;   //!
   TBranch        *b_Ds_0_40_trig_thiPt_MM;   //!
   TBranch        *b_Ds_0_40_fCL;   //!
   TBranch        *b_Ds_0_40_sCL;   //!
   TBranch        *b_Ds_0_40_tCL;   //!
   TBranch        *b_Ds_0_40_fmaxPt_PX;   //!
   TBranch        *b_Ds_0_40_fmaxPt_PY;   //!
   TBranch        *b_Ds_0_40_fmaxPt_PZ;   //!
   TBranch        *b_Ds_0_40_smaxPt_PX;   //!
   TBranch        *b_Ds_0_40_smaxPt_PY;   //!
   TBranch        *b_Ds_0_40_smaxPt_PZ;   //!
   ...
   TBranch        *b_Kmi_PZ;   //!
   TBranch        *b_Kmi_M;   //!
   TBranch        *b_Kmi_TRUEID;   //!
   TBranch        *b_Kmi_MC_MOTHER_ID;   //!
   TBranch        *b_Kmi_MC_MOTHER_KEY;   //!
   TBranch        *b_Kmi_MC_GD_MOTHER_ID;   //!
   TBranch        *b_Kmi_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_Kmi_MC_GD_GD_MOTHER_ID;   //!
   TBranch        *b_Kmi_MC_GD_GD_MOTHER_KEY;   //!
   TBranch        *b_Kmi_TRUEP_E;   //!
   TBranch        *b_Kmi_TRUEP_X;   //!
   TBranch        *b_Kmi_TRUEP_Y;   //!
   TBranch        *b_Kmi_TRUEP_Z;   //!
   TBranch        *b_Kmi_TRUEPT;   //!
   TBranch        *b_Kmi_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_Kmi_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_Kmi_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_Kmi_TRUEENDVERTEX_X;   //!
   TBranch        *b_Kmi_TRUEENDVERTEX_Y;   //!
   TBranch        *b_Kmi_TRUEENDVERTEX_Z;   //!
   TBranch        *b_Kmi_TRUEISSTABLE;   //!
   TBranch        *b_Kmi_TRUETAU;   //!
   TBranch        *b_Kmi_ID;   //!
   TBranch        *b_Kmi_eta;   //!
   TBranch        *b_Kmi_phi;   //!
   TBranch        *b_Kmi_typeOriginVtx;   //!
   TBranch        *b_Kmi_nEndVertices;   //!
   TBranch        *b_Kmi_ancestorpid;   //!
   TBranch        *b_Kmi_MCI;   //!
   TBranch        *b_Kmi_PIDe;   //!
   TBranch        *b_Kmi_PIDmu;   //!
   TBranch        *b_Kmi_PIDK;   //!
   ...
   TBranch        *b_Kpl_PZ;   //!
   TBranch        *b_Kpl_M;   //!
   TBranch        *b_Kpl_TRUEID;   //!
   TBranch        *b_Kpl_MC_MOTHER_ID;   //!
   TBranch        *b_Kpl_MC_MOTHER_KEY;   //!
   TBranch        *b_Kpl_MC_GD_MOTHER_ID;   //!
   TBranch        *b_Kpl_MC_GD_MOTHER_KEY;   //!
   TBranch        *b_Kpl_MC_GD_GD_MOTHER_ID;   //!
   TBranch        *b_Kpl_MC_GD_GD_MOTHER_KEY;   //!
   TBranch        *b_Kpl_TRUEP_E;   //!
   TBranch        *b_Kpl_TRUEP_X;   //!
   TBranch        *b_Kpl_TRUEP_Y;   //!
   TBranch        *b_Kpl_TRUEP_Z;   //!
   TBranch        *b_Kpl_TRUEPT;   //!
   TBranch        *b_Kpl_TRUEORIGINVERTEX_X;   //!
   TBranch        *b_Kpl_TRUEORIGINVERTEX_Y;   //!
   TBranch        *b_Kpl_TRUEORIGINVERTEX_Z;   //!
   TBranch        *b_Kpl_TRUEENDVERTEX_X;   //!
   TBranch        *b_Kpl_TRUEENDVERTEX_Y;   //!
   TBranch        *b_Kpl_TRUEENDVERTEX_Z;   //!
   TBranch        *b_Kpl_TRUEISSTABLE;   //!
   TBranch        *b_Kpl_TRUETAU;   //!
   TBranch        *b_Kpl_ID;   //!
   TBranch        *b_Kpl_eta;   //!
   TBranch        *b_Kpl_phi;   //!
   TBranch        *b_Kpl_typeOriginVtx;   //!
   TBranch        *b_Kpl_nEndVertices;   //!
   TBranch        *b_Kpl_ancestorpid;   //!
   TBranch        *b_Kpl_MCI;   //!
   TBranch        *b_Kpl_PIDe;   //!
   TBranch        *b_Kpl_PIDmu;   //!
   TBranch        *b_Kpl_PIDK;   //!
   ...
   TBranch        *b_pi_eta;   //!
   TBranch        *b_pi_phi;   //!
   TBranch        *b_pi_typeOriginVtx;   //!
   TBranch        *b_pi_nEndVertices;   //!
   TBranch        *b_pi_ancestorpid;   //!
   TBranch        *b_pi_MCI;   //!
   TBranch        *b_pi_PIDe;   //!
   TBranch        *b_pi_PIDmu;   //!
   TBranch        *b_pi_PIDK;   //!
   ...
   TBranch        *b_mu_eta;   //!
   TBranch        *b_mu_phi;   //!
   TBranch        *b_mu_typeOriginVtx;   //!
   TBranch        *b_mu_nEndVertices;   //!
   TBranch        *b_mu_ancestorpid;   //!
   TBranch        *b_mu_MCI;   //!
   TBranch        *b_mu_PIDe;   //!
   TBranch        *b_mu_PIDmu;   //!
   TBranch        *b_mu_PIDK;   //!
   ...
   TBranch        *b_mu_0_40_nc_maxPt_PT;   //!
   TBranch        *b_mu_0_40_nc_maxPt_PX;   //!
   TBranch        *b_mu_0_40_nc_maxPt_PY;   //!
   TBranch        *b_mu_0_40_nc_maxPt_PZ;   //!
   TBranch        *b_mu_0_40_nc_maxPt_PE;   //!
   TBranch        *b_mu_0_40_nc_secPt_PX;   //!
   TBranch        *b_mu_0_40_nc_secPt_PY;   //!
   TBranch        *b_mu_0_40_nc_secPt_PZ;   //!
   TBranch        *b_mu_0_40_nc_secPt_PE;   //!
   TBranch        *b_mu_0_40_nc_thiPt_PX;   //!
   TBranch        *b_mu_0_40_nc_thiPt_PY;   //!
   TBranch        *b_mu_0_40_nc_thiPt_PZ;   //!
   TBranch        *b_mu_0_40_nc_thiPt_PE;   //!
   TBranch        *b_mu_0_40_nc_CL;   //!
   TBranch        *b_mu_0_40_nc_Shape;   //!
   TBranch        *b_mu_0_40_nc_Match;   //!
   TBranch        *b_mu_0_40_nc_PID;   //!
   TBranch        *b_mu_0_40_nc_CNV;   //!
   TBranch        *b_mu_0_40_nc_PRS;   //!
   TBranch        *b_mu_0_40_pi0_mult;   //!
   TBranch        *b_mu_0_40_pi0_vPT;   //!
   TBranch        *b_mu_0_40_pi0_sPT;   //!
   TBranch        *b_mu_0_40_pi0_PX;   //!
   TBranch        *b_mu_0_40_pi0_PY;   //!
   TBranch        *b_mu_0_40_pi0_PZ;   //!
   TBranch        *b_mu_0_40_pi0_maxPt_PT;   //!
   TBranch        *b_mu_0_40_pi0_maxPt_PX;   //!
   TBranch        *b_mu_0_40_pi0_maxPt_PY;   //!
   TBranch        *b_mu_0_40_pi0_maxPt_PZ;   //!
   TBranch        *b_mu_0_40_pi0_maxPt_MM;   //!
   TBranch        *b_mu_0_40_pi0_maxPt_PE;   //!
   TBranch        *b_mu_0_40_pi0_secPt_PX;   //!
   TBranch        *b_mu_0_40_pi0_secPt_PY;   //!
   TBranch        *b_mu_0_40_pi0_secPt_PZ;   //!
   TBranch        *b_mu_0_40_pi0_secPt_MM;   //!
   TBranch        *b_mu_0_40_pi0_secPt_PE;   //!
   TBranch        *b_mu_0_40_pi0_thiPt_PX;   //!
   TBranch        *b_mu_0_40_pi0_thiPt_PY;   //!
   TBranch        *b_mu_0_40_pi0_thiPt_PZ;   //!
   TBranch        *b_mu_0_40_pi0_thiPt_MM;   //!
   TBranch        *b_mu_0_40_pi0_thiPt_PE;   //!
   TBranch        *b_mu_0_40_pi0_CL;   //!
   TBranch        *b_mu_0_40_g1_CL;   //!
   TBranch        *b_mu_0_40_g2_CL;   //!
   TBranch        *b_mu_0_40_g1maxPt_PX;   //!
   TBranch        *b_mu_0_40_g1maxPt_PY;   //!
   TBranch        *b_mu_0_40_g1maxPt_PZ;   //!
   TBranch        *b_mu_0_40_g2maxPt_PX;   //!
   TBranch        *b_mu_0_40_g2maxPt_PY;   //!
   TBranch        *b_mu_0_40_g2maxPt_PZ;   //!
   TBranch        *b_mu_0_40_trig_mult;   //!
   TBranch        *b_mu_0_40_trig_vPT;   //!
   TBranch        *b_mu_0_40_trig_sPT;   //!
   TBranch        *b_mu_0_40_trig_PX;   //!
   TBranch        *b_mu_0_40_trig_PY;   //!
   TBranch        *b_mu_0_40_trig_PZ;   //!
   TBranch        *b_mu_0_40_trig_maxPt_PT;   //!
   TBranch        *b_mu_0_40_trig_maxPt_PX;   //!
   TBranch        *b_mu_0_40_trig_maxPt_PY;   //!
   TBranch        *b_mu_0_40_trig_maxPt_PZ;   //!
   TBranch        *b_mu_0_40_trig_maxPt_MM;   //!
   TBranch        *b_mu_0_40_trig_secPt_PX;   //!
   TBranch        *b_mu_0_40_trig_secPt_PY;   //!
   TBranch        *b_mu_0_40_trig_secPt_PZ;   //!
   TBranch        *b_mu_0_40_trig_secPt_MM;   //!
   TBranch        *b_mu_0_40_trig_thiPt_PX;   //!
   TBranch        *b_mu_0_40_trig_thiPt_PY;   //!
   TBranch        *b_mu_0_40_trig_thiPt_PZ;   //!
   TBranch        *b_mu_0_40_trig_thiPt_MM;   //!
   TBranch        *b_mu_0_40_fCL;   //!
   TBranch        *b_mu_0_40_sCL;   //!
   TBranch        *b_mu_0_40_tCL;   //!
   TBranch        *b_mu_0_40_fmaxPt_PX;   //!
   TBranch        *b_mu_0_40_fmaxPt_PY;   //!
   TBranch        *b_mu_0_40_fmaxPt_PZ;   //!
   ...
   MCNeutralAll(TTree *tree=0);
   virtual ~MCNeutralAll();
...
#ifdef MCNeutralAll_cxx
MCNeutralAll::MCNeutralAll(TTree *tree) : fChain(0) 
{
...
MCNeutralAll::~MCNeutralAll()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MCNeutralAll::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MCNeutralAll::LoadTree(Long64_t entry)
{
...
void MCNeutralAll::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("Bs_0_TRUEID", &Bs_0_TRUEID, &b_Bs_0_TRUEID);
   fChain->SetBranchAddress("Bs_0_MC_MOTHER_ID", &Bs_0_MC_MOTHER_ID, &b_Bs_0_MC_MOTHER_ID);
   fChain->SetBranchAddress("Bs_0_MC_MOTHER_KEY", &Bs_0_MC_MOTHER_KEY, &b_Bs_0_MC_MOTHER_KEY);
   fChain->SetBranchAddress("Bs_0_MC_GD_MOTHER_ID", &Bs_0_MC_GD_MOTHER_ID, &b_Bs_0_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("Bs_0_MC_GD_MOTHER_KEY", &Bs_0_MC_GD_MOTHER_KEY, &b_Bs_0_MC_GD_MOTHER_KEY);
   fChain->SetBranchAddress("Bs_0_MC_GD_GD_MOTHER_ID", &Bs_0_MC_GD_GD_MOTHER_ID, &b_Bs_0_MC_GD_GD_MOTHER_ID);
   fChain->SetBranchAddress("Bs_0_MC_GD_GD_MOTHER_KEY", &Bs_0_MC_GD_GD_MOTHER_KEY, &b_Bs_0_MC_GD_GD_MOTHER_KEY);
   ...
   fChain->SetBranchAddress("Bs_0_TRUEPT", &Bs_0_TRUEPT, &b_Bs_0_TRUEPT);
   fChain->SetBranchAddress("Bs_0_TRUEORIGINVERTEX_X", &Bs_0_TRUEORIGINVERTEX_X, &b_Bs_0_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("Bs_0_TRUEORIGINVERTEX_Y", &Bs_0_TRUEORIGINVERTEX_Y, &b_Bs_0_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("Bs_0_TRUEORIGINVERTEX_Z", &Bs_0_TRUEORIGINVERTEX_Z, &b_Bs_0_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("Bs_0_TRUEENDVERTEX_X", &Bs_0_TRUEENDVERTEX_X, &b_Bs_0_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("Bs_0_TRUEENDVERTEX_Y", &Bs_0_TRUEENDVERTEX_Y, &b_Bs_0_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("Bs_0_TRUEENDVERTEX_Z", &Bs_0_TRUEENDVERTEX_Z, &b_Bs_0_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("Bs_0_TRUEISSTABLE", &Bs_0_TRUEISSTABLE, &b_Bs_0_TRUEISSTABLE);
   fChain->SetBranchAddress("Bs_0_TRUETAU", &Bs_0_TRUETAU, &b_Bs_0_TRUETAU);
   ...
   fChain->SetBranchAddress("Bs_0_doca", &Bs_0_doca, &b_Bs_0_doca);
   fChain->SetBranchAddress("Bs_0_D1_isolation_Giampi", &Bs_0_D1_isolation_Giampi, &b_Bs_0_D1_isolation_Giampi);
   fChain->SetBranchAddress("Bs_0_D1_isolation_Giampi_tc", &Bs_0_D1_isolation_Giampi_tc, &b_Bs_0_D1_isolation_Giampi_tc);
   fChain->SetBranchAddress("Bs_0_D1_isolation_Giampi_new1", &Bs_0_D1_isolation_Giampi_new1, &b_Bs_0_D1_isolation_Giampi_new1);
   fChain->SetBranchAddress("Bs_0_D1_isolation_Giampi_new2", &Bs_0_D1_isolation_Giampi_new2, &b_Bs_0_D1_isolation_Giampi_new2);
   fChain->SetBranchAddress("Bs_0_D1_isolation_Giampi_newD0", &Bs_0_D1_isolation_Giampi_newD0, &b_Bs_0_D1_isolation_Giampi_newD0);
   fChain->SetBranchAddress("Bs_0_cosnk", &Bs_0_cosnk, &b_Bs_0_cosnk);
   ...
   fChain->SetBranchAddress("Bs_0_D1_isobdt1_1st", &Bs_0_D1_isobdt1_1st, &b_Bs_0_D1_isobdt1_1st);
   fChain->SetBranchAddress("Bs_0_D1_isobdt1_2nd", &Bs_0_D1_isobdt1_2nd, &b_Bs_0_D1_isobdt1_2nd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt1_3rd", &Bs_0_D1_isobdt1_3rd, &b_Bs_0_D1_isobdt1_3rd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt2_1st", &Bs_0_D1_isobdt2_1st, &b_Bs_0_D1_isobdt2_1st);
   fChain->SetBranchAddress("Bs_0_D1_isobdt2_2nd", &Bs_0_D1_isobdt2_2nd, &b_Bs_0_D1_isobdt2_2nd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt2_3rd", &Bs_0_D1_isobdt2_3rd, &b_Bs_0_D1_isobdt2_3rd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt3_1st", &Bs_0_D1_isobdt3_1st, &b_Bs_0_D1_isobdt3_1st);
   fChain->SetBranchAddress("Bs_0_D1_isobdt3_2nd", &Bs_0_D1_isobdt3_2nd, &b_Bs_0_D1_isobdt3_2nd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt3_3rd", &Bs_0_D1_isobdt3_3rd, &b_Bs_0_D1_isobdt3_3rd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt4_1st", &Bs_0_D1_isobdt4_1st, &b_Bs_0_D1_isobdt4_1st);
   fChain->SetBranchAddress("Bs_0_D1_isobdt4_2nd", &Bs_0_D1_isobdt4_2nd, &b_Bs_0_D1_isobdt4_2nd);
   fChain->SetBranchAddress("Bs_0_D1_isobdt4_3rd", &Bs_0_D1_isobdt4_3rd, &b_Bs_0_D1_isobdt4_3rd);
   ...
   fChain->SetBranchAddress("Bs_0_typeOriginVtx", &Bs_0_typeOriginVtx, &b_Bs_0_typeOriginVtx);
   fChain->SetBranchAddress("Bs_0_nEndVertices", &Bs_0_nEndVertices, &b_Bs_0_nEndVertices);
   fChain->SetBranchAddress("Bs_0_ancestorpid", &Bs_0_ancestorpid, &b_Bs_0_ancestorpid);
   fChain->SetBranchAddress("Bs_0_MCI", &Bs_0_MCI, &b_Bs_0_MCI);
   ...
   fChain->SetBranchAddress("Bs_0_Hlt2XcMuXForTauB2XcMuDecision_Dec", &Bs_0_Hlt2XcMuXForTauB2XcMuDecision_Dec, &b_Bs_0_Hlt2XcMuXForTauB2XcMuDecision_Dec);
   fChain->SetBranchAddress("Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TIS", &Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TIS, &b_Bs_0_Hlt2XcMuXForTauB2XcMuDecision_TIS);
   ...
   fChain->SetBranchAddress("Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_Dec", &Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_Dec, &b_Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_Dec);
   fChain->SetBranchAddress("Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TIS", &Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TIS, &b_Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TIS);
   fChain->SetBranchAddress("Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TOS", &Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TOS, &b_Bs_0_Hlt2XcMuXForTauB2XcFakeMuDecisionHlt2TopoMu2BodyBBDTDecision_TOS);
   ...
   fChain->SetBranchAddress("Ds_Dalitz_piplus_Kplus_M2", &Ds_Dalitz_piplus_Kplus_M2, &b_Ds_Dalitz_piplus_Kplus_M2);
   fChain->SetBranchAddress("Ds_Dalitz_Kminus_Kplus_M2", &Ds_Dalitz_Kminus_Kplus_M2, &b_Ds_Dalitz_Kminus_Kplus_M2);
   fChain->SetBranchAddress("Ds_Dalitz_Kminus_piplus_M2", &Ds_Dalitz_Kminus_piplus_M2, &b_Ds_Dalitz_Kminus_piplus_M2);
   ...
   fChain->SetBranchAddress("Ds_typeOriginVtx", &Ds_typeOriginVtx, &b_Ds_typeOriginVtx);
   fChain->SetBranchAddress("Ds_nEndVertices", &Ds_nEndVertices, &b_Ds_nEndVertices);
   fChain->SetBranchAddress("Ds_ancestorpid", &Ds_ancestorpid, &b_Ds_ancestorpid);
   fChain->SetBranchAddress("Ds_MCI", &Ds_MCI, &b_Ds_MCI);
   ...
   fChain->SetBranchAddress("Ds_0.40_nc_thiPt_PX", &Ds_0_40_nc_thiPt_PX, &b_Ds_0_40_nc_thiPt_PX);
   fChain->SetBranchAddress("Ds_0.40_nc_thiPt_PY", &Ds_0_40_nc_thiPt_PY, &b_Ds_0_40_nc_thiPt_PY);
   fChain->SetBranchAddress("Ds_0.40_nc_thiPt_PZ", &Ds_0_40_nc_thiPt_PZ, &b_Ds_0_40_nc_thiPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_nc_thiPt_PE", &Ds_0_40_nc_thiPt_PE, &b_Ds_0_40_nc_thiPt_PE);
   fChain->SetBranchAddress("Ds_0.40_nc_CL", &Ds_0_40_nc_CL, &b_Ds_0_40_nc_CL);
   fChain->SetBranchAddress("Ds_0.40_nc_Shape", &Ds_0_40_nc_Shape, &b_Ds_0_40_nc_Shape);
   fChain->SetBranchAddress("Ds_0.40_nc_Match", &Ds_0_40_nc_Match, &b_Ds_0_40_nc_Match);
   fChain->SetBranchAddress("Ds_0.40_nc_PID", &Ds_0_40_nc_PID, &b_Ds_0_40_nc_PID);
   fChain->SetBranchAddress("Ds_0.40_nc_CNV", &Ds_0_40_nc_CNV, &b_Ds_0_40_nc_CNV);
   fChain->SetBranchAddress("Ds_0.40_nc_PRS", &Ds_0_40_nc_PRS, &b_Ds_0_40_nc_PRS);
   fChain->SetBranchAddress("Ds_0.40_pi0_mult", &Ds_0_40_pi0_mult, &b_Ds_0_40_pi0_mult);
   fChain->SetBranchAddress("Ds_0.40_pi0_vPT", &Ds_0_40_pi0_vPT, &b_Ds_0_40_pi0_vPT);
   fChain->SetBranchAddress("Ds_0.40_pi0_sPT", &Ds_0_40_pi0_sPT, &b_Ds_0_40_pi0_sPT);
   fChain->SetBranchAddress("Ds_0.40_pi0_PX", &Ds_0_40_pi0_PX, &b_Ds_0_40_pi0_PX);
   fChain->SetBranchAddress("Ds_0.40_pi0_PY", &Ds_0_40_pi0_PY, &b_Ds_0_40_pi0_PY);
   fChain->SetBranchAddress("Ds_0.40_pi0_PZ", &Ds_0_40_pi0_PZ, &b_Ds_0_40_pi0_PZ);
   fChain->SetBranchAddress("Ds_0.40_pi0_maxPt_PT", &Ds_0_40_pi0_maxPt_PT, &b_Ds_0_40_pi0_maxPt_PT);
   ...
   fChain->SetBranchAddress("Ds_0.40_pi0_secPt_PX", &Ds_0_40_pi0_secPt_PX, &b_Ds_0_40_pi0_secPt_PX);
   fChain->SetBranchAddress("Ds_0.40_pi0_secPt_PY", &Ds_0_40_pi0_secPt_PY, &b_Ds_0_40_pi0_secPt_PY);
   fChain->SetBranchAddress("Ds_0.40_pi0_secPt_PZ", &Ds_0_40_pi0_secPt_PZ, &b_Ds_0_40_pi0_secPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_pi0_secPt_MM", &Ds_0_40_pi0_secPt_MM, &b_Ds_0_40_pi0_secPt_MM);
   fChain->SetBranchAddress("Ds_0.40_pi0_secPt_PE", &Ds_0_40_pi0_secPt_PE, &b_Ds_0_40_pi0_secPt_PE);
   fChain->SetBranchAddress("Ds_0.40_pi0_thiPt_PX", &Ds_0_40_pi0_thiPt_PX, &b_Ds_0_40_pi0_thiPt_PX);
   fChain->SetBranchAddress("Ds_0.40_pi0_thiPt_PY", &Ds_0_40_pi0_thiPt_PY, &b_Ds_0_40_pi0_thiPt_PY);
   fChain->SetBranchAddress("Ds_0.40_pi0_thiPt_PZ", &Ds_0_40_pi0_thiPt_PZ, &b_Ds_0_40_pi0_thiPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_pi0_thiPt_MM", &Ds_0_40_pi0_thiPt_MM, &b_Ds_0_40_pi0_thiPt_MM);
   fChain->SetBranchAddress("Ds_0.40_pi0_thiPt_PE", &Ds_0_40_pi0_thiPt_PE, &b_Ds_0_40_pi0_thiPt_PE);
   fChain->SetBranchAddress("Ds_0.40_pi0_CL", &Ds_0_40_pi0_CL, &b_Ds_0_40_pi0_CL);
   ...
   fChain->SetBranchAddress("Ds_0.40_g1maxPt_PX", &Ds_0_40_g1maxPt_PX, &b_Ds_0_40_g1maxPt_PX);
   fChain->SetBranchAddress("Ds_0.40_g1maxPt_PY", &Ds_0_40_g1maxPt_PY, &b_Ds_0_40_g1maxPt_PY);
   fChain->SetBranchAddress("Ds_0.40_g1maxPt_PZ", &Ds_0_40_g1maxPt_PZ, &b_Ds_0_40_g1maxPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_g2maxPt_PX", &Ds_0_40_g2maxPt_PX, &b_Ds_0_40_g2maxPt_PX);
   fChain->SetBranchAddress("Ds_0.40_g2maxPt_PY", &Ds_0_40_g2maxPt_PY, &b_Ds_0_40_g2maxPt_PY);
   fChain->SetBranchAddress("Ds_0.40_g2maxPt_PZ", &Ds_0_40_g2maxPt_PZ, &b_Ds_0_40_g2maxPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_trig_mult", &Ds_0_40_trig_mult, &b_Ds_0_40_trig_mult);
   fChain->SetBranchAddress("Ds_0.40_trig_vPT", &Ds_0_40_trig_vPT, &b_Ds_0_40_trig_vPT);
   fChain->SetBranchAddress("Ds_0.40_trig_sPT", &Ds_0_40_trig_sPT, &b_Ds_0_40_trig_sPT);
   fChain->SetBranchAddress("Ds_0.40_trig_PX", &Ds_0_40_trig_PX, &b_Ds_0_40_trig_PX);
   fChain->SetBranchAddress("Ds_0.40_trig_PY", &Ds_0_40_trig_PY, &b_Ds_0_40_trig_PY);
   fChain->SetBranchAddress("Ds_0.40_trig_PZ", &Ds_0_40_trig_PZ, &b_Ds_0_40_trig_PZ);
   fChain->SetBranchAddress("Ds_0.40_trig_maxPt_PT", &Ds_0_40_trig_maxPt_PT, &b_Ds_0_40_trig_maxPt_PT);
   fChain->SetBranchAddress("Ds_0.40_trig_maxPt_PX", &Ds_0_40_trig_maxPt_PX, &b_Ds_0_40_trig_maxPt_PX);
   fChain->SetBranchAddress("Ds_0.40_trig_maxPt_PY", &Ds_0_40_trig_maxPt_PY, &b_Ds_0_40_trig_maxPt_PY);
   fChain->SetBranchAddress("Ds_0.40_trig_maxPt_PZ", &Ds_0_40_trig_maxPt_PZ, &b_Ds_0_40_trig_maxPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_trig_maxPt_MM", &Ds_0_40_trig_maxPt_MM, &b_Ds_0_40_trig_maxPt_MM);
   fChain->SetBranchAddress("Ds_0.40_trig_secPt_PX", &Ds_0_40_trig_secPt_PX, &b_Ds_0_40_trig_secPt_PX);
   fChain->SetBranchAddress("Ds_0.40_trig_secPt_PY", &Ds_0_40_trig_secPt_PY, &b_Ds_0_40_trig_secPt_PY);
   fChain->SetBranchAddress("Ds_0.40_trig_secPt_PZ", &Ds_0_40_trig_secPt_PZ, &b_Ds_0_40_trig_secPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_trig_secPt_MM", &Ds_0_40_trig_secPt_MM, &b_Ds_0_40_trig_secPt_MM);
   fChain->SetBranchAddress("Ds_0.40_trig_thiPt_PX", &Ds_0_40_trig_thiPt_PX, &b_Ds_0_40_trig_thiPt_PX);
   fChain->SetBranchAddress("Ds_0.40_trig_thiPt_PY", &Ds_0_40_trig_thiPt_PY, &b_Ds_0_40_trig_thiPt_PY);
   fChain->SetBranchAddress("Ds_0.40_trig_thiPt_PZ", &Ds_0_40_trig_thiPt_PZ, &b_Ds_0_40_trig_thiPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_trig_thiPt_MM", &Ds_0_40_trig_thiPt_MM, &b_Ds_0_40_trig_thiPt_MM);
   fChain->SetBranchAddress("Ds_0.40_fCL", &Ds_0_40_fCL, &b_Ds_0_40_fCL);
   fChain->SetBranchAddress("Ds_0.40_sCL", &Ds_0_40_sCL, &b_Ds_0_40_sCL);
   fChain->SetBranchAddress("Ds_0.40_tCL", &Ds_0_40_tCL, &b_Ds_0_40_tCL);
   fChain->SetBranchAddress("Ds_0.40_fmaxPt_PX", &Ds_0_40_fmaxPt_PX, &b_Ds_0_40_fmaxPt_PX);
   fChain->SetBranchAddress("Ds_0.40_fmaxPt_PY", &Ds_0_40_fmaxPt_PY, &b_Ds_0_40_fmaxPt_PY);
   fChain->SetBranchAddress("Ds_0.40_fmaxPt_PZ", &Ds_0_40_fmaxPt_PZ, &b_Ds_0_40_fmaxPt_PZ);
   fChain->SetBranchAddress("Ds_0.40_smaxPt_PX", &Ds_0_40_smaxPt_PX, &b_Ds_0_40_smaxPt_PX);
   fChain->SetBranchAddress("Ds_0.40_smaxPt_PY", &Ds_0_40_smaxPt_PY, &b_Ds_0_40_smaxPt_PY);
   fChain->SetBranchAddress("Ds_0.40_smaxPt_PZ", &Ds_0_40_smaxPt_PZ, &b_Ds_0_40_smaxPt_PZ);
   ...
   fChain->SetBranchAddress("Kmi_TRUEID", &Kmi_TRUEID, &b_Kmi_TRUEID);
   fChain->SetBranchAddress("Kmi_MC_MOTHER_ID", &Kmi_MC_MOTHER_ID, &b_Kmi_MC_MOTHER_ID);
   fChain->SetBranchAddress("Kmi_MC_MOTHER_KEY", &Kmi_MC_MOTHER_KEY, &b_Kmi_MC_MOTHER_KEY);
   fChain->SetBranchAddress("Kmi_MC_GD_MOTHER_ID", &Kmi_MC_GD_MOTHER_ID, &b_Kmi_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("Kmi_MC_GD_MOTHER_KEY", &Kmi_MC_GD_MOTHER_KEY, &b_Kmi_MC_GD_MOTHER_KEY);
   fChain->SetBranchAddress("Kmi_MC_GD_GD_MOTHER_ID", &Kmi_MC_GD_GD_MOTHER_ID, &b_Kmi_MC_GD_GD_MOTHER_ID);
   fChain->SetBranchAddress("Kmi_MC_GD_GD_MOTHER_KEY", &Kmi_MC_GD_GD_MOTHER_KEY, &b_Kmi_MC_GD_GD_MOTHER_KEY);
   fChain->SetBranchAddress("Kmi_TRUEP_E", &Kmi_TRUEP_E, &b_Kmi_TRUEP_E);
   fChain->SetBranchAddress("Kmi_TRUEP_X", &Kmi_TRUEP_X, &b_Kmi_TRUEP_X);
   fChain->SetBranchAddress("Kmi_TRUEP_Y", &Kmi_TRUEP_Y, &b_Kmi_TRUEP_Y);
   fChain->SetBranchAddress("Kmi_TRUEP_Z", &Kmi_TRUEP_Z, &b_Kmi_TRUEP_Z);
   fChain->SetBranchAddress("Kmi_TRUEPT", &Kmi_TRUEPT, &b_Kmi_TRUEPT);
   fChain->SetBranchAddress("Kmi_TRUEORIGINVERTEX_X", &Kmi_TRUEORIGINVERTEX_X, &b_Kmi_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("Kmi_TRUEORIGINVERTEX_Y", &Kmi_TRUEORIGINVERTEX_Y, &b_Kmi_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("Kmi_TRUEORIGINVERTEX_Z", &Kmi_TRUEORIGINVERTEX_Z, &b_Kmi_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("Kmi_TRUEENDVERTEX_X", &Kmi_TRUEENDVERTEX_X, &b_Kmi_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("Kmi_TRUEENDVERTEX_Y", &Kmi_TRUEENDVERTEX_Y, &b_Kmi_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("Kmi_TRUEENDVERTEX_Z", &Kmi_TRUEENDVERTEX_Z, &b_Kmi_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("Kmi_TRUEISSTABLE", &Kmi_TRUEISSTABLE, &b_Kmi_TRUEISSTABLE);
   fChain->SetBranchAddress("Kmi_TRUETAU", &Kmi_TRUETAU, &b_Kmi_TRUETAU);
   ...
   fChain->SetBranchAddress("Kmi_typeOriginVtx", &Kmi_typeOriginVtx, &b_Kmi_typeOriginVtx);
   fChain->SetBranchAddress("Kmi_nEndVertices", &Kmi_nEndVertices, &b_Kmi_nEndVertices);
   fChain->SetBranchAddress("Kmi_ancestorpid", &Kmi_ancestorpid, &b_Kmi_ancestorpid);
   fChain->SetBranchAddress("Kmi_MCI", &Kmi_MCI, &b_Kmi_MCI);
   ...
   fChain->SetBranchAddress("Kpl_TRUEID", &Kpl_TRUEID, &b_Kpl_TRUEID);
   fChain->SetBranchAddress("Kpl_MC_MOTHER_ID", &Kpl_MC_MOTHER_ID, &b_Kpl_MC_MOTHER_ID);
   fChain->SetBranchAddress("Kpl_MC_MOTHER_KEY", &Kpl_MC_MOTHER_KEY, &b_Kpl_MC_MOTHER_KEY);
   fChain->SetBranchAddress("Kpl_MC_GD_MOTHER_ID", &Kpl_MC_GD_MOTHER_ID, &b_Kpl_MC_GD_MOTHER_ID);
   fChain->SetBranchAddress("Kpl_MC_GD_MOTHER_KEY", &Kpl_MC_GD_MOTHER_KEY, &b_Kpl_MC_GD_MOTHER_KEY);
   fChain->SetBranchAddress("Kpl_MC_GD_GD_MOTHER_ID", &Kpl_MC_GD_GD_MOTHER_ID, &b_Kpl_MC_GD_GD_MOTHER_ID);
   fChain->SetBranchAddress("Kpl_MC_GD_GD_MOTHER_KEY", &Kpl_MC_GD_GD_MOTHER_KEY, &b_Kpl_MC_GD_GD_MOTHER_KEY);
   fChain->SetBranchAddress("Kpl_TRUEP_E", &Kpl_TRUEP_E, &b_Kpl_TRUEP_E);
   fChain->SetBranchAddress("Kpl_TRUEP_X", &Kpl_TRUEP_X, &b_Kpl_TRUEP_X);
   fChain->SetBranchAddress("Kpl_TRUEP_Y", &Kpl_TRUEP_Y, &b_Kpl_TRUEP_Y);
   fChain->SetBranchAddress("Kpl_TRUEP_Z", &Kpl_TRUEP_Z, &b_Kpl_TRUEP_Z);
   fChain->SetBranchAddress("Kpl_TRUEPT", &Kpl_TRUEPT, &b_Kpl_TRUEPT);
   fChain->SetBranchAddress("Kpl_TRUEORIGINVERTEX_X", &Kpl_TRUEORIGINVERTEX_X, &b_Kpl_TRUEORIGINVERTEX_X);
   fChain->SetBranchAddress("Kpl_TRUEORIGINVERTEX_Y", &Kpl_TRUEORIGINVERTEX_Y, &b_Kpl_TRUEORIGINVERTEX_Y);
   fChain->SetBranchAddress("Kpl_TRUEORIGINVERTEX_Z", &Kpl_TRUEORIGINVERTEX_Z, &b_Kpl_TRUEORIGINVERTEX_Z);
   fChain->SetBranchAddress("Kpl_TRUEENDVERTEX_X", &Kpl_TRUEENDVERTEX_X, &b_Kpl_TRUEENDVERTEX_X);
   fChain->SetBranchAddress("Kpl_TRUEENDVERTEX_Y", &Kpl_TRUEENDVERTEX_Y, &b_Kpl_TRUEENDVERTEX_Y);
   fChain->SetBranchAddress("Kpl_TRUEENDVERTEX_Z", &Kpl_TRUEENDVERTEX_Z, &b_Kpl_TRUEENDVERTEX_Z);
   fChain->SetBranchAddress("Kpl_TRUEISSTABLE", &Kpl_TRUEISSTABLE, &b_Kpl_TRUEISSTABLE);
   fChain->SetBranchAddress("Kpl_TRUETAU", &Kpl_TRUETAU, &b_Kpl_TRUETAU);
   ...
   fChain->SetBranchAddress("Kpl_typeOriginVtx", &Kpl_typeOriginVtx, &b_Kpl_typeOriginVtx);
   fChain->SetBranchAddress("Kpl_nEndVertices", &Kpl_nEndVertices, &b_Kpl_nEndVertices);
   fChain->SetBranchAddress("Kpl_ancestorpid", &Kpl_ancestorpid, &b_Kpl_ancestorpid);
   fChain->SetBranchAddress("Kpl_MCI", &Kpl_MCI, &b_Kpl_MCI);
   ...
   fChain->SetBranchAddress("pi_typeOriginVtx", &pi_typeOriginVtx, &b_pi_typeOriginVtx);
   fChain->SetBranchAddress("pi_nEndVertices", &pi_nEndVertices, &b_pi_nEndVertices);
   fChain->SetBranchAddress("pi_ancestorpid", &pi_ancestorpid, &b_pi_ancestorpid);
   fChain->SetBranchAddress("pi_MCI", &pi_MCI, &b_pi_MCI);
   ...
   fChain->SetBranchAddress("mu_typeOriginVtx", &mu_typeOriginVtx, &b_mu_typeOriginVtx);
   fChain->SetBranchAddress("mu_nEndVertices", &mu_nEndVertices, &b_mu_nEndVertices);
   fChain->SetBranchAddress("mu_ancestorpid", &mu_ancestorpid, &b_mu_ancestorpid);
   fChain->SetBranchAddress("mu_MCI", &mu_MCI, &b_mu_MCI);
   ...
   fChain->SetBranchAddress("mu_0.40_nc_maxPt_PT", &mu_0_40_nc_maxPt_PT, &b_mu_0_40_nc_maxPt_PT);
   fChain->SetBranchAddress("mu_0.40_nc_maxPt_PX", &mu_0_40_nc_maxPt_PX, &b_mu_0_40_nc_maxPt_PX);
   fChain->SetBranchAddress("mu_0.40_nc_maxPt_PY", &mu_0_40_nc_maxPt_PY, &b_mu_0_40_nc_maxPt_PY);
   fChain->SetBranchAddress("mu_0.40_nc_maxPt_PZ", &mu_0_40_nc_maxPt_PZ, &b_mu_0_40_nc_maxPt_PZ);
   fChain->SetBranchAddress("mu_0.40_nc_maxPt_PE", &mu_0_40_nc_maxPt_PE, &b_mu_0_40_nc_maxPt_PE);
   fChain->SetBranchAddress("mu_0.40_nc_secPt_PX", &mu_0_40_nc_secPt_PX, &b_mu_0_40_nc_secPt_PX);
   fChain->SetBranchAddress("mu_0.40_nc_secPt_PY", &mu_0_40_nc_secPt_PY, &b_mu_0_40_nc_secPt_PY);
   fChain->SetBranchAddress("mu_0.40_nc_secPt_PZ", &mu_0_40_nc_secPt_PZ, &b_mu_0_40_nc_secPt_PZ);
   fChain->SetBranchAddress("mu_0.40_nc_secPt_PE", &mu_0_40_nc_secPt_PE, &b_mu_0_40_nc_secPt_PE);
   fChain->SetBranchAddress("mu_0.40_nc_thiPt_PX", &mu_0_40_nc_thiPt_PX, &b_mu_0_40_nc_thiPt_PX);
   fChain->SetBranchAddress("mu_0.40_nc_thiPt_PY", &mu_0_40_nc_thiPt_PY, &b_mu_0_40_nc_thiPt_PY);
   fChain->SetBranchAddress("mu_0.40_nc_thiPt_PZ", &mu_0_40_nc_thiPt_PZ, &b_mu_0_40_nc_thiPt_PZ);
   fChain->SetBranchAddress("mu_0.40_nc_thiPt_PE", &mu_0_40_nc_thiPt_PE, &b_mu_0_40_nc_thiPt_PE);
   fChain->SetBranchAddress("mu_0.40_nc_CL", &mu_0_40_nc_CL, &b_mu_0_40_nc_CL);
   fChain->SetBranchAddress("mu_0.40_nc_Shape", &mu_0_40_nc_Shape, &b_mu_0_40_nc_Shape);
   fChain->SetBranchAddress("mu_0.40_nc_Match", &mu_0_40_nc_Match, &b_mu_0_40_nc_Match);
   fChain->SetBranchAddress("mu_0.40_nc_PID", &mu_0_40_nc_PID, &b_mu_0_40_nc_PID);
   fChain->SetBranchAddress("mu_0.40_nc_CNV", &mu_0_40_nc_CNV, &b_mu_0_40_nc_CNV);
   fChain->SetBranchAddress("mu_0.40_nc_PRS", &mu_0_40_nc_PRS, &b_mu_0_40_nc_PRS);
   fChain->SetBranchAddress("mu_0.40_pi0_mult", &mu_0_40_pi0_mult, &b_mu_0_40_pi0_mult);
   fChain->SetBranchAddress("mu_0.40_pi0_vPT", &mu_0_40_pi0_vPT, &b_mu_0_40_pi0_vPT);
   fChain->SetBranchAddress("mu_0.40_pi0_sPT", &mu_0_40_pi0_sPT, &b_mu_0_40_pi0_sPT);
   fChain->SetBranchAddress("mu_0.40_pi0_PX", &mu_0_40_pi0_PX, &b_mu_0_40_pi0_PX);
   fChain->SetBranchAddress("mu_0.40_pi0_PY", &mu_0_40_pi0_PY, &b_mu_0_40_pi0_PY);
   fChain->SetBranchAddress("mu_0.40_pi0_PZ", &mu_0_40_pi0_PZ, &b_mu_0_40_pi0_PZ);
   fChain->SetBranchAddress("mu_0.40_pi0_maxPt_PT", &mu_0_40_pi0_maxPt_PT, &b_mu_0_40_pi0_maxPt_PT);
   fChain->SetBranchAddress("mu_0.40_pi0_maxPt_PX", &mu_0_40_pi0_maxPt_PX, &b_mu_0_40_pi0_maxPt_PX);
   fChain->SetBranchAddress("mu_0.40_pi0_maxPt_PY", &mu_0_40_pi0_maxPt_PY, &b_mu_0_40_pi0_maxPt_PY);
   fChain->SetBranchAddress("mu_0.40_pi0_maxPt_PZ", &mu_0_40_pi0_maxPt_PZ, &b_mu_0_40_pi0_maxPt_PZ);
   fChain->SetBranchAddress("mu_0.40_pi0_maxPt_MM", &mu_0_40_pi0_maxPt_MM, &b_mu_0_40_pi0_maxPt_MM);
   fChain->SetBranchAddress("mu_0.40_pi0_maxPt_PE", &mu_0_40_pi0_maxPt_PE, &b_mu_0_40_pi0_maxPt_PE);
   fChain->SetBranchAddress("mu_0.40_pi0_secPt_PX", &mu_0_40_pi0_secPt_PX, &b_mu_0_40_pi0_secPt_PX);
   fChain->SetBranchAddress("mu_0.40_pi0_secPt_PY", &mu_0_40_pi0_secPt_PY, &b_mu_0_40_pi0_secPt_PY);
   fChain->SetBranchAddress("mu_0.40_pi0_secPt_PZ", &mu_0_40_pi0_secPt_PZ, &b_mu_0_40_pi0_secPt_PZ);
   fChain->SetBranchAddress("mu_0.40_pi0_secPt_MM", &mu_0_40_pi0_secPt_MM, &b_mu_0_40_pi0_secPt_MM);
   fChain->SetBranchAddress("mu_0.40_pi0_secPt_PE", &mu_0_40_pi0_secPt_PE, &b_mu_0_40_pi0_secPt_PE);
   fChain->SetBranchAddress("mu_0.40_pi0_thiPt_PX", &mu_0_40_pi0_thiPt_PX, &b_mu_0_40_pi0_thiPt_PX);
   fChain->SetBranchAddress("mu_0.40_pi0_thiPt_PY", &mu_0_40_pi0_thiPt_PY, &b_mu_0_40_pi0_thiPt_PY);
   fChain->SetBranchAddress("mu_0.40_pi0_thiPt_PZ", &mu_0_40_pi0_thiPt_PZ, &b_mu_0_40_pi0_thiPt_PZ);
   fChain->SetBranchAddress("mu_0.40_pi0_thiPt_MM", &mu_0_40_pi0_thiPt_MM, &b_mu_0_40_pi0_thiPt_MM);
   fChain->SetBranchAddress("mu_0.40_pi0_thiPt_PE", &mu_0_40_pi0_thiPt_PE, &b_mu_0_40_pi0_thiPt_PE);
   fChain->SetBranchAddress("mu_0.40_pi0_CL", &mu_0_40_pi0_CL, &b_mu_0_40_pi0_CL);
   fChain->SetBranchAddress("mu_0.40_g1_CL", &mu_0_40_g1_CL, &b_mu_0_40_g1_CL);
   fChain->SetBranchAddress("mu_0.40_g2_CL", &mu_0_40_g2_CL, &b_mu_0_40_g2_CL);
   fChain->SetBranchAddress("mu_0.40_g1maxPt_PX", &mu_0_40_g1maxPt_PX, &b_mu_0_40_g1maxPt_PX);
   fChain->SetBranchAddress("mu_0.40_g1maxPt_PY", &mu_0_40_g1maxPt_PY, &b_mu_0_40_g1maxPt_PY);
   fChain->SetBranchAddress("mu_0.40_g1maxPt_PZ", &mu_0_40_g1maxPt_PZ, &b_mu_0_40_g1maxPt_PZ);
   fChain->SetBranchAddress("mu_0.40_g2maxPt_PX", &mu_0_40_g2maxPt_PX, &b_mu_0_40_g2maxPt_PX);
   fChain->SetBranchAddress("mu_0.40_g2maxPt_PY", &mu_0_40_g2maxPt_PY, &b_mu_0_40_g2maxPt_PY);
   fChain->SetBranchAddress("mu_0.40_g2maxPt_PZ", &mu_0_40_g2maxPt_PZ, &b_mu_0_40_g2maxPt_PZ);
   fChain->SetBranchAddress("mu_0.40_trig_mult", &mu_0_40_trig_mult, &b_mu_0_40_trig_mult);
   fChain->SetBranchAddress("mu_0.40_trig_vPT", &mu_0_40_trig_vPT, &b_mu_0_40_trig_vPT);
   fChain->SetBranchAddress("mu_0.40_trig_sPT", &mu_0_40_trig_sPT, &b_mu_0_40_trig_sPT);
   fChain->SetBranchAddress("mu_0.40_trig_PX", &mu_0_40_trig_PX, &b_mu_0_40_trig_PX);
   fChain->SetBranchAddress("mu_0.40_trig_PY", &mu_0_40_trig_PY, &b_mu_0_40_trig_PY);
   fChain->SetBranchAddress("mu_0.40_trig_PZ", &mu_0_40_trig_PZ, &b_mu_0_40_trig_PZ);
   fChain->SetBranchAddress("mu_0.40_trig_maxPt_PT", &mu_0_40_trig_maxPt_PT, &b_mu_0_40_trig_maxPt_PT);
   fChain->SetBranchAddress("mu_0.40_trig_maxPt_PX", &mu_0_40_trig_maxPt_PX, &b_mu_0_40_trig_maxPt_PX);
   fChain->SetBranchAddress("mu_0.40_trig_maxPt_PY", &mu_0_40_trig_maxPt_PY, &b_mu_0_40_trig_maxPt_PY);
   fChain->SetBranchAddress("mu_0.40_trig_maxPt_PZ", &mu_0_40_trig_maxPt_PZ, &b_mu_0_40_trig_maxPt_PZ);
   fChain->SetBranchAddress("mu_0.40_trig_maxPt_MM", &mu_0_40_trig_maxPt_MM, &b_mu_0_40_trig_maxPt_MM);
   fChain->SetBranchAddress("mu_0.40_trig_secPt_PX", &mu_0_40_trig_secPt_PX, &b_mu_0_40_trig_secPt_PX);
   fChain->SetBranchAddress("mu_0.40_trig_secPt_PY", &mu_0_40_trig_secPt_PY, &b_mu_0_40_trig_secPt_PY);
   fChain->SetBranchAddress("mu_0.40_trig_secPt_PZ", &mu_0_40_trig_secPt_PZ, &b_mu_0_40_trig_secPt_PZ);
   fChain->SetBranchAddress("mu_0.40_trig_secPt_MM", &mu_0_40_trig_secPt_MM, &b_mu_0_40_trig_secPt_MM);
   fChain->SetBranchAddress("mu_0.40_trig_thiPt_PX", &mu_0_40_trig_thiPt_PX, &b_mu_0_40_trig_thiPt_PX);
   fChain->SetBranchAddress("mu_0.40_trig_thiPt_PY", &mu_0_40_trig_thiPt_PY, &b_mu_0_40_trig_thiPt_PY);
   fChain->SetBranchAddress("mu_0.40_trig_thiPt_PZ", &mu_0_40_trig_thiPt_PZ, &b_mu_0_40_trig_thiPt_PZ);
   fChain->SetBranchAddress("mu_0.40_trig_thiPt_MM", &mu_0_40_trig_thiPt_MM, &b_mu_0_40_trig_thiPt_MM);
   fChain->SetBranchAddress("mu_0.40_fCL", &mu_0_40_fCL, &b_mu_0_40_fCL);
   fChain->SetBranchAddress("mu_0.40_sCL", &mu_0_40_sCL, &b_mu_0_40_sCL);
   fChain->SetBranchAddress("mu_0.40_tCL", &mu_0_40_tCL, &b_mu_0_40_tCL);
   fChain->SetBranchAddress("mu_0.40_fmaxPt_PX", &mu_0_40_fmaxPt_PX, &b_mu_0_40_fmaxPt_PX);
   fChain->SetBranchAddress("mu_0.40_fmaxPt_PY", &mu_0_40_fmaxPt_PY, &b_mu_0_40_fmaxPt_PY);
   fChain->SetBranchAddress("mu_0.40_fmaxPt_PZ", &mu_0_40_fmaxPt_PZ, &b_mu_0_40_fmaxPt_PZ);
...
void MCNeutralAll::Show(Long64_t entry)
{
...
Int_t MCNeutralAll::Cut(Long64_t entry)
{
