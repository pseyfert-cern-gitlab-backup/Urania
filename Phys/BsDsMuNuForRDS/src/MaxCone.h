...
#ifdef MaxCone_cxx
MaxCone::MaxCone(TTree *tree) : fChain(0) 
{
...
Int_t MaxCone::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MaxCone::LoadTree(Long64_t entry)
{
...
void MaxCone::Show(Long64_t entry)
{
...
Int_t MaxCone::Cut(Long64_t entry)
{
