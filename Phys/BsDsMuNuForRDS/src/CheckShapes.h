...
#ifndef CheckShapes_h
#define CheckShapes_h
...
#ifdef CheckShapes_cxx
CheckShapes::CheckShapes(TTree *tree) : fChain(0) 
{
...
Int_t CheckShapes::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t CheckShapes::LoadTree(Long64_t entry)
{
...
void CheckShapes::Init(TTree *tree)
{
...
void CheckShapes::Show(Long64_t entry)
{
...
Int_t CheckShapes::Cut(Long64_t entry)
{
