// $Id: TupleToolMuonIsolation.h 
#ifndef TUPLETOOLMUONISOLATION_H 
#define TUPLETOOLMUONISOLATION_H 1
...
/** @class TupleToolMuonIsolation TupleToolMuonIsolation.h
...
class TupleToolMuonIsolation : public TupleToolBase, virtual public IParticleTupleTool {
public: 
  /// Standard constructor
  TupleToolMuonIsolation( const std::string& type, 
  ...
  virtual ~TupleToolMuonIsolation( ); ///< Destructor
...
#endif // TUPLETOOLMUONISOLATION_H
