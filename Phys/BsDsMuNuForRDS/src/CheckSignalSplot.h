#ifndef CheckSignalSplot_h
#define CheckSignalSplot_h
...
class CheckSignalSplot {

 public:

  CheckSignalSplot(string inf, string fl, int dbg, bool sigO, bool addCon);
