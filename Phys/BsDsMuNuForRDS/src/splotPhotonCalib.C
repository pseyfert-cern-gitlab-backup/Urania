...
void AddData(RooWorkspace*, float, TString, TString, TString);
void DoSPlot(RooWorkspace*, float, TString);
void MakePlots(RooWorkspace*, TString, TString, TString);
float getEntries(TString);

void splotPhotonCalib(TString resonance, TString type, TString cone){
  ...
  float nentries = getEntries(cone); 
  //float nentries = 200000;
  AddModel(wspace, nentries, resonance);

  // add data to the workspace
  AddData(wspace, nentries, resonance, type, cone);
...
void AddModel(RooWorkspace* ws, float nentries, TString resonance){
  ...
  if(resonance == "Ds0"){
    thMass = new RooRealVar("thMass", "thMass", 2190, 2100, 2250, "MeV/c^{2}");
  }
...
//____________________________________
void AddData(RooWorkspace* ws, float nentries, TString resonance, TString type, TString cone){
  ...
  if(cone=="1.0"){
    fChain->Add("/afs/cern.ch/user/r/rvazquez/gangadir/workspace/rvazquez/LocalXML/1412/photonCalib.root");
  }
  if(cone=="0.4"){
    fChain->Add("/afs/cern.ch/user/r/rvazquez/gangadir/workspace/rvazquez/LocalXML/1436/photonCalib.root");
  }  

  Double_t        Ds_PT;
  Double_t        Ds_MM;
  Int_t           Ds_1_00_pi0_mult;
  Double_t        Ds_1_00_pi0_maxPt_PX;
  Double_t        Ds_1_00_pi0_maxPt_PY;
  Double_t        Ds_1_00_pi0_maxPt_PZ;
  Double_t        Ds_1_00_pi0_maxPt_MM;
  Double_t        Ds_1_00_g1_CL;
  Double_t        Ds_1_00_g2_CL;
  Double_t        Ds_1_00_pi0_maxPt_PE;
  Double_t        Ds_1_00_pi0_radius;
  ...
  Double_t        Ds_1_00_nc_secPt_PX;
  Double_t        Ds_1_00_nc_secPt_PY;
  Double_t        Ds_1_00_nc_secPt_PZ;
  Double_t        Ds_1_00_nc_secPt_PE;
  ...
  TBranch        *b_Ds_MM;   //!
  TBranch        *b_q2;    //!
  TBranch        *b_Ds_1_00_pi0_mult;   //!
  TBranch        *b_Ds_1_00_pi0_maxPt_PX;   //!
  TBranch        *b_Ds_1_00_pi0_maxPt_PY;   //!
  TBranch        *b_Ds_1_00_pi0_maxPt_PZ;   //!
  TBranch        *b_Ds_1_00_pi0_maxPt_MM;   //!
  TBranch        *b_Ds_1_00_g1_CL;   //!
  TBranch        *b_Ds_1_00_g2_CL;   //!
  TBranch        *b_Ds_1_00_pi0_maxPt_PE;   //!
  TBranch        *b_Ds_1_00_pi0_radius;
  ...
  TBranch        *b_Ds_1_00_nc_secPt_PX;
  TBranch        *b_Ds_1_00_nc_secPt_PY;
  TBranch        *b_Ds_1_00_nc_secPt_PZ;
  TBranch        *b_Ds_1_00_nc_secPt_PE;
  ...
  fChain->SetBranchAddress("Ds_1.00_pi0_mult", &Ds_1_00_pi0_mult, &b_Ds_1_00_pi0_mult);
  fChain->SetBranchAddress("Ds_1.00_pi0_maxPt_PX", &Ds_1_00_pi0_maxPt_PX, &b_Ds_1_00_pi0_maxPt_PX);
  fChain->SetBranchAddress("Ds_1.00_pi0_maxPt_PY", &Ds_1_00_pi0_maxPt_PY, &b_Ds_1_00_pi0_maxPt_PY);
  fChain->SetBranchAddress("Ds_1.00_pi0_maxPt_PZ", &Ds_1_00_pi0_maxPt_PZ, &b_Ds_1_00_pi0_maxPt_PZ);
  fChain->SetBranchAddress("Ds_1.00_pi0_maxPt_MM", &Ds_1_00_pi0_maxPt_MM, &b_Ds_1_00_pi0_maxPt_MM);
  fChain->SetBranchAddress("Ds_1.00_g1_CL", &Ds_1_00_g1_CL, &b_Ds_1_00_g1_CL);
  fChain->SetBranchAddress("Ds_1.00_g2_CL", &Ds_1_00_g2_CL, &b_Ds_1_00_g2_CL);
  fChain->SetBranchAddress("Ds_1.00_pi0_maxPt_PE", &Ds_1_00_pi0_maxPt_PE, &b_Ds_1_00_pi0_maxPt_PE);
  fChain->SetBranchAddress("Ds_1.00_pi0_radius", &Ds_1_00_pi0_radius, &b_Ds_1_00_pi0_radius);
  ...
  fChain->SetBranchAddress("Ds_0.40_pi0_radius", &Ds_0_40_pi0_radius, &b_Ds_0_40_pi0_radius);
  ...
  fChain->SetBranchAddress("Ds_1.00_nc_maxPt_PX", &Ds_1_00_nc_maxPt_PX, &b_Ds_1_00_nc_maxPt_PX);
  fChain->SetBranchAddress("Ds_1.00_nc_maxPt_PY", &Ds_1_00_nc_maxPt_PY, &b_Ds_1_00_nc_maxPt_PY);
  fChain->SetBranchAddress("Ds_1.00_nc_maxPt_PZ", &Ds_1_00_nc_maxPt_PZ, &b_Ds_1_00_nc_maxPt_PZ);
  fChain->SetBranchAddress("Ds_1.00_nc_maxPt_PE", &Ds_1_00_nc_maxPt_PE, &b_Ds_1_00_nc_maxPt_PE); 
  fChain->SetBranchAddress("Ds_1.00_nc_CL", &Ds_1_00_nc_CL, &b_Ds_1_00_nc_CL);
  fChain->SetBranchAddress("Ds_1.00_nc_mult", &Ds_1_00_nc_mult, &b_Ds_1_00_nc_mult); 
  fChain->SetBranchAddress("Ds_1.00_nc_radius", &Ds_1_00_nc_radius, &b_Ds_1_00_nc_radius);
  fChain->SetBranchAddress("Ds_1.00_nc_secPt_PX", &Ds_1_00_nc_secPt_PX, &b_Ds_1_00_nc_secPt_PX);
  fChain->SetBranchAddress("Ds_1.00_nc_secPt_PY", &Ds_1_00_nc_secPt_PY, &b_Ds_1_00_nc_secPt_PY);
  fChain->SetBranchAddress("Ds_1.00_nc_secPt_PZ", &Ds_1_00_nc_secPt_PZ, &b_Ds_1_00_nc_secPt_PZ);
  fChain->SetBranchAddress("Ds_1.00_nc_secPt_PE", &Ds_1_00_nc_secPt_PE, &b_Ds_1_00_nc_secPt_PE);
  ...
  if(resonance == "Dsst"){
    ...
    //fitMass = new RooRealVar("resMass", "resMass", 2350., 2600.);
  }
  if(resonance == "Ds0"){
    fitMass = new RooRealVar("resMass", "resMass", 2240., 2500.);
  }  
  ...
  RooRealVar *pi0rad = new RooRealVar("pi0rad", "pi0rad", 0., 4.);
  ...
  RooRealVar *MassDsPi0 = new RooRealVar("MassDsPi0", "MassDsPi0", 0., 3000.);
  ...
  vars.add(RooArgSet(*pi0mult,*pi0px,*pi0py,*pi0pz,*pi0mm,*pi0pe,*g1CL,*g2CL,*pi0rad));
  ...
  if(resonance == "Dsst"){
    for(int i = 0; i!=nentries; ++i){
      ...
      bool cuts;
      if(type=="max"){
        if(cone=="1.0") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_1_00_nc_mult>0 && sqrt(pow(Ds_1_00_nc_maxPt_PX,2)+pow(Ds_1_00_nc_maxPt_PY,2))>0;
        if(cone=="0.4") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_0_40_nc_mult>0 && sqrt(pow(Ds_0_40_nc_maxPt_PX,2)+pow(Ds_0_40_nc_maxPt_PY,2))>0;
        //if(cone=="0.4") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_0_40_pi0_mult>0 && sqrt(pow(Ds_0_40_pi0_maxPt_PX,2)+pow(Ds_0_40_pi0_maxPt_PY,2))>0 && abs(Ds_0_40_pi0_maxPt_MM-134.9766)<20;
      }
      if(type=="sec"){
        if(cone=="1.0") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_1_00_nc_mult>0 && sqrt(pow(Ds_1_00_nc_secPt_PX,2)+pow(Ds_1_00_nc_secPt_PY,2))>0;
        if(cone=="0.4") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_0_40_nc_mult>0 && sqrt(pow(Ds_0_40_nc_secPt_PX,2)+pow(Ds_0_40_nc_secPt_PY,2))>0;
      }
      if (cuts) {
        float mass;
        if(type=="max"){
          if(cone=="1.0") mass = sqrt( pow((Ds_1_00_nc_maxPt_PE+Ds_PE),2) - ( pow(Ds_1_00_nc_maxPt_PX+Ds_PX,2)+pow(Ds_1_00_nc_maxPt_PY+Ds_PY,2)+pow(Ds_1_00_nc_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
          if(cone=="0.4") mass = sqrt( pow((Ds_0_40_nc_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_nc_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_nc_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_nc_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
          //if(cone=="0.4") mass = sqrt( pow((Ds_0_40_pi0_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_pi0_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_pi0_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_pi0_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        }
        if(type=="sec"){
          if(cone=="1.0") mass = sqrt( pow((Ds_1_00_nc_secPt_PE+Ds_PE),2) - ( pow(Ds_1_00_nc_secPt_PX+Ds_PX,2)+pow(Ds_1_00_nc_secPt_PY+Ds_PY,2)+pow(Ds_1_00_nc_secPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
          if(cone=="0.4") mass = sqrt( pow((Ds_0_40_nc_secPt_PE+Ds_PE),2) - ( pow(Ds_0_40_nc_secPt_PX+Ds_PX,2)+pow(Ds_0_40_nc_secPt_PY+Ds_PY,2)+pow(Ds_0_40_nc_secPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        } 
        if(mass < 2050. || mass > 2250.) continue; // for Ds*
        //if(mass < 2350. || mass > 2600.) continue; 
        if(type=="max"){
          if(cone=="1.0") *fitMass = sqrt( pow((Ds_1_00_nc_maxPt_PE+Ds_PE),2) - ( pow(Ds_1_00_nc_maxPt_PX+Ds_PX,2)+pow(Ds_1_00_nc_maxPt_PY+Ds_PY,2)+pow(Ds_1_00_nc_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
          if(cone=="0.4") *fitMass = sqrt( pow((Ds_0_40_nc_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_nc_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_nc_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_nc_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
          //if(cone=="0.4") *fitMass = sqrt( pow((Ds_0_40_pi0_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_pi0_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_pi0_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_pi0_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        }
        if(type=="sec"){
          if(cone=="1.0") *fitMass = sqrt( pow((Ds_1_00_nc_secPt_PE+Ds_PE),2) - ( pow(Ds_1_00_nc_secPt_PX+Ds_PX,2)+pow(Ds_1_00_nc_secPt_PY+Ds_PY,2)+pow(Ds_1_00_nc_secPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
          if(cone=="0.4") *fitMass = sqrt( pow((Ds_0_40_nc_secPt_PE+Ds_PE),2) - ( pow(Ds_0_40_nc_secPt_PX+Ds_PX,2)+pow(Ds_0_40_nc_secPt_PY+Ds_PY,2)+pow(Ds_0_40_nc_secPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        }
        *dspt = Ds_PT;
        *dsmm = Ds_MM;
        ...
        *MassDsG = sqrt(((Ds_PE+Ds_0_40_nc_maxPt_PE)*(Ds_PE+Ds_0_40_nc_maxPt_PE)-
        ...
        upvars.add(RooArgSet(*pi0mult,*pi0px,*pi0py,*pi0pz,*pi0mm,*pi0pe,*g1CL,*g2CL,*pi0rad));
  ...
  if(resonance == "Ds0"){
    for(int i = 0; i!=nentries; ++i){
      ...
      // apply the cuts to add only good data
      bool cuts;
      if(cone=="1.0") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_1_00_pi0_mult>0 && sqrt(pow(Ds_1_00_pi0_maxPt_PX,2)+pow(Ds_1_00_pi0_maxPt_PY,2))>0 && abs(Ds_1_00_pi0_maxPt_MM-134.9766)<20;
      if(cone=="0.4") cuts = Ds_MM>1940 && Ds_MM<2000 && Ds_0_40_pi0_mult>0 && sqrt(pow(Ds_0_40_pi0_maxPt_PX,2)+pow(Ds_0_40_pi0_maxPt_PY,2))>0 && abs(Ds_0_40_pi0_maxPt_MM-134.9766)<20;
      if(cuts){
        float mass; 
        if(cone=="1.0") mass = sqrt( pow((Ds_1_00_pi0_maxPt_PE+Ds_PE),2) - ( pow(Ds_1_00_pi0_maxPt_PX+Ds_PX,2)+pow(Ds_1_00_pi0_maxPt_PY+Ds_PY,2)+pow(Ds_1_00_pi0_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        if(cone=="0.4") mass = sqrt( pow((Ds_0_40_pi0_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_pi0_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_pi0_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_pi0_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        if(mass < 2240. || mass > 2500.) continue;     
        if(cone=="1.0") *fitMass = sqrt( pow((Ds_1_00_pi0_maxPt_PE+Ds_PE),2) - ( pow(Ds_1_00_pi0_maxPt_PX+Ds_PX,2)+pow(Ds_1_00_pi0_maxPt_PY+Ds_PY,2)+pow(Ds_1_00_pi0_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        if(cone=="0.4") *fitMass = sqrt( pow((Ds_0_40_pi0_maxPt_PE+Ds_PE),2) - ( pow(Ds_0_40_pi0_maxPt_PX+Ds_PX,2)+pow(Ds_0_40_pi0_maxPt_PY+Ds_PY,2)+pow(Ds_0_40_pi0_maxPt_PZ+Ds_PZ,2) ) )-Ds_MM+DsMassPDG;
        *dspt = Ds_PT;
        *dsmm = Ds_MM;
        *ncmult = Ds_1_00_nc_mult;
        *ncpx = Ds_1_00_nc_maxPt_PX;
        *ncpy = Ds_1_00_nc_maxPt_PY;
        *ncpz = Ds_1_00_nc_maxPt_PZ;
        *ncpe = Ds_1_00_nc_maxPt_PE;
        *ncCL = Ds_1_00_nc_CL;
        *ncrad = Ds_1_00_nc_radius;
        *pi0mult = Ds_1_00_pi0_mult;
        *pi0px = Ds_1_00_pi0_maxPt_PX;
        *pi0py = Ds_1_00_pi0_maxPt_PY;
        *pi0pz = Ds_1_00_pi0_maxPt_PZ;
        *pi0mm = Ds_1_00_pi0_maxPt_MM;
        *pi0pe = Ds_1_00_pi0_maxPt_PE;
        *g1CL = Ds_1_00_g1_CL;
        *g2CL = Ds_1_00_g2_CL;
        *pi0rad = Ds_1_00_pi0_radius;
        *dspe = Ds_PE;
        *dspx = Ds_PX;
        *dspy = Ds_PY;
        *dspz = Ds_PZ;
        // compute the helicity angle
        TLorentzVector gamma(Ds_0_40_pi0_maxPt_PX,Ds_0_40_pi0_maxPt_PY,Ds_0_40_pi0_maxPt_PZ,Ds_0_40_pi0_maxPt_PE);
        TLorentzVector Dsst(Ds_PX+Ds_0_40_pi0_maxPt_PX,Ds_PY+Ds_0_40_pi0_maxPt_PY,Ds_PZ+Ds_0_40_pi0_maxPt_PZ,Ds_PE+Ds_0_40_pi0_maxPt_PE);
        gamma.Boost(-Dsst.BoostVector());
        Double_t angle = cos(gamma.Vect().Angle(Dsst.BoostVector()));
        *helicity = angle;
        *MassDsPi0 = sqrt(((Ds_PE+Ds_1_00_pi0_maxPt_PE)*(Ds_PE+Ds_1_00_pi0_maxPt_PE)-
                           (Ds_PX+Ds_1_00_pi0_maxPt_PX)*(Ds_PX+Ds_1_00_pi0_maxPt_PX)-
                           (Ds_PY+Ds_1_00_pi0_maxPt_PY)*(Ds_PY+Ds_1_00_pi0_maxPt_PY)-
                           (Ds_PZ+Ds_1_00_pi0_maxPt_PZ)*(Ds_PZ+Ds_1_00_pi0_maxPt_PZ))/1000000)-
                           Ds_MM/1000+DsMassPDG/1000;
        RooArgSet upvars(*fitMass, *dsmm);
        upvars.add(RooArgSet(*ncmult,*ncpx,*ncpy,*ncpz,*ncpe,*ncCL,*ncrad));
        upvars.add(RooArgSet(*pi0mult,*pi0px,*pi0py,*pi0pz,*pi0mm,*pi0pe,*g1CL,*g2CL,*pi0rad));
        upvars.add(RooArgSet(*dspe,*dspx,*dspy,*dspz));
        upvars.add(RooArgSet(*MassDsPi0));
        upvars.add(RooArgSet(*helicity));
        data->add(upvars);
      }
    }
...
//____________________________________
void DoSPlot(RooWorkspace* ws, float nentries, TString resonance){
  ...
  TFile *file = new TFile("DsMass_WithSWeighted_"+resonance+"_PhotonCalib_CB_highPT.root","RECREATE");
  ...
  Double_t pi0mult, pi0px, pi0py, pi0pz, pi0mm, pi0pe, g1CL, g2CL, pi0rad;
  ...
  if(resonance == "Dsst"){
    ...
    finalTree->Branch("MassDsPi0",&MassDsPi0,"MassDsPi0/D");
  }
  ...
  finalTree->Branch("Ds_0.40_pi0_radius", &pi0rad, "Ds_0.40_pi0_radius/D");
  ...
  for (int i = 0; i!=nen; ++i){
    ...
    pi0rad = Dset->getRealValue("pi0rad");
    ...
    if(resonance == "Dsst"){
      ...
      MassDsPi0 = Dset->getRealValue("MassDsPi0");
    }
    finalTree->Fill();
  }
  finalTree->Write();
...
void MakePlots(RooWorkspace* ws, TString resonance, TString type, TString cone){
  ...
  if(resonance=="Dsst"){
    ...
    //frame_1 = invMass->frame(2350.,2600.,100);
  }
  if(resonance=="Ds0"){
    frame_1 = invMass->frame(2240.,2500.,100);
  }
...
/*
  ...
  RooPlot* frame2_1 = helicity->frame(-1.1,1.1,80);
  dataw_sig_1->plotOn(frame2_1, DataError(RooAbsData::SumW2), MarkerStyle(1) ) ;
  frame2_1->SetTitle("Photon cone radius for signal");
  frame2_1->Draw() ;
  ...
  RooPlot* frame3_1 = helicity->frame(-1.1,1.1,80);
  dataw_bkg_1->plotOn(frame3_1,DataError(RooAbsData::SumW2), MarkerStyle(1) ) ;
  frame3_1->SetTitle("Photon cone radius for background");
  frame3_1->Draw() ;
*/
  cdata1->SaveAs("SPlot_"+resonance+"_PhotonCalib_"+cone+"_"+type+".pdf");

}

float getEntries(TString cone){
  int nentries;
  TChain *fChain;
  fChain = new TChain("B2DsMuNuTuple/DecayTree");
  if(cone=="1.0"){
