...
# exponents
BkgMassk1 = EValAsym(-6.62e-4,3e-5  ,3e-5   )# (-6.66e-4,3e-5  ,3e-5   )  # Marco 150212
BkgMassk2 = EValAsym(-7.7e-4 ,1.8e-4,1.7e-4 )# (-8.1e-4 ,1.7e-4,1.7e-4 )  # Marco 250112
BkgMassk3 = EValAsym(-9.3e-4 ,3.4e-4,3.3e-4 )# (-9.0e-4 ,3.4e-4,3.3e-4 )  # Marco 250112
BkgMassk4 = EValAsym(-9.2e-4 ,6.5e-4,6.2e-4 )# (-9.0e-4 ,6.3e-4,6.0e-4 )  # Marco 250112
BkgMassk5 = EValAsym(-4.6e-4 ,8.0e-4,7.4e-4 )# (-7.9e-4 ,7.4e-4,6.9e-4 )  # Marco 250112
BkgMassk6 = EValAsym(-10e-4  ,13e-4 ,12e-4  )# (-10e-4  ,13e-4 ,12e-4  )  # Marco 250112
BkgMassk7 = EValAsym(-28.6e-4,9.6e-4,10.4e-4)# (-28.6e-4,9.6e-4,10.4e-4)  # Marco 250112
BkgMassk8 = EValAsym(-28.6e-4,9.6e-4,10.4e-4)# (-28.6e-4,9.6e-4,10.4e-4)  # Marco 250112

# total number of events in the (used to fit) bkg sidebands
SbGL1 = 9173. #9227. # Marco 150212   
SbGL2 = 269.  #274.  # Marco 250112
SbGL3 = 71.   #73.   # Marco 250112
SbGL4 = 20.   #21.   # Marco 250112
SbGL5 = 15.   #16.   # Marco 250112
SbGL6 = 5.    # Marco 250112
SbGL7 = 6.    # Marco 250112
SbGL8 = 2.    # Marco 250112
      

# additional systematics
SystBkgBin1 = 0.018  #0.016  # Marco 150212
SystBkgBin2 = 0.176  #0.178  # Marco 250112
SystBkgBin3 = 0.212  #0.215  # Marco 250112
