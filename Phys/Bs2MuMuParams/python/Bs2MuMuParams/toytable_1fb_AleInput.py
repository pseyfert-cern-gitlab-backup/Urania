...
from PeakingParam_1fb import *
from alphaparam_Autumn2012 import BmmE_mw, BmmE_49006000

right = False #True #

if right:
    from BDTparam_1fb_AleInput_right import * 
else:
    from BDTparam_1fb_AleInput import * 

def toytable():
    keys = [
            #'Norm_comment'
             'NormPhi_fullmass','NormPhi_fullmassErr', 'NormBu_fullmass','NormBu_fullmassErr','NormKPi_fullmass','NormKPi_fullmassErr'
...
, 'meanPiMuMu1ErrMinus', 'meanPiMuMu2ErrMinus', 'meanPiMuMu3ErrMinus', 'meanPiMuMu4ErrMinus', 'meanPiMuMu5ErrMinus', 'meanPiMuMu6ErrMinus', 'meanPiMuMu7ErrMinus', 'meanPiMuMu8ErrMinus'
    ...
    operator['NormPhi_fullmass']    = val(Bsb*BmmE_mw/BmmE_49006000)
    operator['NormPhi_fullmassErr'] = err(Bsb*BmmE_mw/BmmE_49006000)
    operator['NormBu_fullmass']     = val(Bub*BmmE_mw/BmmE_49006000)
    operator['NormBu_fullmassErr']  = err(Bub*BmmE_mw/BmmE_49006000)
    operator['NormKPi_fullmass']    = val(Bdb*BmmE_mw/BmmE_49006000)
    operator['NormKPi_fullmassErr'] = err(Bdb*BmmE_mw/BmmE_49006000)  
...
#
    ...
    if right:
        out_name = 'toytable_test_1fb_AleInput_right.py'
    else:
        out_name = 'toytable_test_1fb_AleInput.py'
