...
JpsiE_trg = EVal(0.880,[0.005,0.025]) # Justine 20130704
...
#https://indico.cern.ch/getFile.py/access?contribId=6&resId=0&materialId=slides&confId=250103
BuRatE_trg = EVal(0.955,[0.007,0.019]) # Justine 20130704
...
TISE_trg = EVal(0.05046, 0.0004) # Siim 03072013
...
BuNcan = EVal(355232.4, 608.0)# Siim 04072013 from 1018 pb (new ntuples)
...
#BdKpiNcan = EVal(10472, 430)  #Christian 04062013
BdKpiNcan = EVal(10809, 439)  #Chrsitian 03072013
BdNcan = BdKpiNcan
