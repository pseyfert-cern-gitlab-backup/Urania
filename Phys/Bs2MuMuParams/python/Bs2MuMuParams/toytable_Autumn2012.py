...
# for the toys
#
#  2012 -- Analysis for Autumn 2012 data
#
#---------------------------------------------------

from errors import *
from alphaparam_Autumn2012 import *
from BDTparam_Autumn2012 import *
from PeakingParam_Autumn2012 import *
...
def toytable():
    keys = [
            ...
            #,'BDTSig_comment'
            ,'TisTot', 'TisErrTot'
            ,'BDT_sig1','BDT_sig2','BDT_sig3','BDT_sig4','BDT_sig5','BDT_sig6','BDT_sig7' 
            ,'BDT_sigErr1','BDT_sigErr2','BDT_sigErr3','BDT_sigErr4','BDT_sigErr5','BDT_sigErr6','BDT_sigErr7' 
            ,'Justine1','Justine2','Justine3','Justine4','Justine5','Justine6','Justine7'
            #,'BKG_comment'
...
##              # PMuNu
##             ,'PMuNuYield','PMuNuYieldErr'
##             ,'PMuNu1','PMuNu2','PMuNu3','PMuNu4','PMuNu5','PMuNu6','PMuNu7'#,'PMuNu8'
##             ,'PMuNu1Err','PMuNu2Err','PMuNu3Err','PMuNu4Err','PMuNu5Err','PMuNu6Err','PMuNu7Err'#,'PMuNu8Err'
##              #
##              ,'sigmaPMuNu1', 'sigmaPMuNu2', 'sigmaPMuNu3', 'sigmaPMuNu4', 'sigmaPMuNu5', 'sigmaPMuNu6', 'sigmaPMuNu7'#, 'sigmaPMuNu8'
## , 'sigmaPMuNu1ErrPlus', 'sigmaPMuNu2ErrPlus', 'sigmaPMuNu3ErrPlus', 'sigmaPMuNu4ErrPlus', 'sigmaPMuNu5ErrPlus', 'sigmaPMuNu6ErrPlus', 'sigmaPMuNu7ErrPlus'#, 'sigmaPMuNu8ErrPlus'                  
## ,'sigmaPMuNu1ErrMinus', 'sigmaPMuNu2ErrMinus', 'sigmaPMuNu3ErrMinus', 'sigmaPMuNu4ErrMinus', 'sigmaPMuNu5ErrMinus', 'sigmaPMuNu6ErrMinus', 'sigmaPMuNu7ErrMinus'#, 'sigmaPMuNu8ErrMinus'     
## ,'meanPMuNu1', 'meanPMuNu2', 'meanPMuNu3', 'meanPMuNu4', 'meanPMuNu5', 'meanPMuNu6', 'meanPMuNu7'#, 'meanPMuNu8'
## , 'meanPMuNu1ErrPlus', 'meanPMuNu2ErrPlus', 'meanPMuNu3ErrPlus', 'meanPMuNu4ErrPlus', 'meanPMuNu5ErrPlus', 'meanPMuNu6ErrPlus', 'meanPMuNu7ErrPlus'#, 'meanPMuNu8ErrPlus'
## , 'meanPMuNu1ErrMinus', 'meanPMuNu2ErrMinus', 'meanPMuNu3ErrMinus', 'meanPMuNu4ErrMinus', 'meanPMuNu5ErrMinus', 'meanPMuNu6ErrMinus', 'meanPMuNu7ErrMinus'#, 'meanPMuNu8ErrMinus'
             ]
    ...
    operator['TisTot']    = val(BhhNcanTis)
    operator['TisErrTot'] = err(BhhNcanTis)
...
#
    ...
    operator['sigmaPiMuNu1ErrPlus'] =  errpos(PiMuNuSigma1)
    operator['sigmaPiMuNu2ErrPlus'] =  errpos(PiMuNuSigma2)
    operator['sigmaPiMuNu3ErrPlus'] =  errpos(PiMuNuSigma3)
    operator['sigmaPiMuNu4ErrPlus'] =  errpos(PiMuNuSigma4)
    operator['sigmaPiMuNu5ErrPlus'] =  errpos(PiMuNuSigma5)
    operator['sigmaPiMuNu6ErrPlus'] =  errpos(PiMuNuSigma6)
    operator['sigmaPiMuNu7ErrPlus'] =  errpos(PiMuNuSigma7)
    #operator['sigmaPiMuNu8ErrPlus'] =  errpos(PiMuNuSigma8)                   
    operator['sigmaPiMuNu1ErrMinus'] = -errneg(PiMuNuSigma1)
    operator['sigmaPiMuNu2ErrMinus'] = -errneg(PiMuNuSigma2)
    operator['sigmaPiMuNu3ErrMinus'] = -errneg(PiMuNuSigma3)
    operator['sigmaPiMuNu4ErrMinus'] = -errneg(PiMuNuSigma4)
    operator['sigmaPiMuNu5ErrMinus'] = -errneg(PiMuNuSigma5)
    operator['sigmaPiMuNu6ErrMinus'] = -errneg(PiMuNuSigma6)
    operator['sigmaPiMuNu7ErrMinus'] = -errneg(PiMuNuSigma7)
    #operator['sigmaPiMuNu8ErrMinus'] = -errneg(PiMuNuSigma8)
    ...
    operator['meanPiMuNu1ErrPlus'] =  errpos(PiMuNuMean1)
    operator['meanPiMuNu2ErrPlus'] =  errpos(PiMuNuMean2)
    operator['meanPiMuNu3ErrPlus'] =  errpos(PiMuNuMean3)
    operator['meanPiMuNu4ErrPlus'] =  errpos(PiMuNuMean4)
    operator['meanPiMuNu5ErrPlus'] =  errpos(PiMuNuMean5)
    operator['meanPiMuNu6ErrPlus'] =  errpos(PiMuNuMean6)
    operator['meanPiMuNu7ErrPlus'] =  errpos(PiMuNuMean7)
    #operator['meanPiMuNu8ErrPlus'] =  errpos(PiMuNuMean8)
    operator['meanPiMuNu1ErrMinus'] = -errneg(PiMuNuMean1)
    operator['meanPiMuNu2ErrMinus'] = -errneg(PiMuNuMean2)
    operator['meanPiMuNu3ErrMinus'] = -errneg(PiMuNuMean3)
    operator['meanPiMuNu4ErrMinus'] = -errneg(PiMuNuMean4)
    operator['meanPiMuNu5ErrMinus'] = -errneg(PiMuNuMean5)
    operator['meanPiMuNu6ErrMinus'] = -errneg(PiMuNuMean6)
    operator['meanPiMuNu7ErrMinus'] = -errneg(PiMuNuMean7)
    #operator['meanPiMuNu8ErrMinus'] = -errneg(PiMuNuMean8)
