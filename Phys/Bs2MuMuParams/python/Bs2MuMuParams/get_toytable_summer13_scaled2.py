...
from errors import *
import alphaparam_summer13_scaled2 as alpha_comb
import alphaparam_spring13_2011 as alpha11
import alphaparam_spring13_2012_scaled2 as alpha12
from BDTparam_summer13_scaled2 import *
from PeakingParam_summer13 import *
...
def toytable():
    keys = [
            ...
            ,'MisIDTotYield', 'MisIDTotYieldErr'
...
, 'meanPiMuMu1ErrMinus', 'meanPiMuMu2ErrMinus', 'meanPiMuMu3ErrMinus', 'meanPiMuMu4ErrMinus', 'meanPiMuMu5ErrMinus', 'meanPiMuMu6ErrMinus', 'meanPiMuMu7ErrMinus', 'meanPiMuMu8ErrMinus'
    ...
    operator['BuJpsiK_BF']   = val(alpha12.BuBR)
    operator['BuJpsiK_BFErr']= err(alpha12.BuBR)
    operator['BdKpi_BF']     = val(alpha12.BdBR)
    operator['BdKpi_BFErr']  = err(alpha12.BdBR)
    ...
    operator['NormBu']     = val(alpha_comb.BuComb_mw)
    operator['NormBuErr']  = err(alpha_comb.BuComb_mw)
    operator['NormKPi']    = val(alpha_comb.BdComb_mw)
    operator['NormKPiErr'] = err(alpha_comb.BdComb_mw) 
    operator['NormBu_fullmass']     = val(alpha_comb.BuComb_fit)
    operator['NormBu_fullmassErr']  = err(alpha_comb.BuComb_fit)
    operator['NormKPi_fullmass']    = val(alpha_comb.BdComb_fit)
    operator['NormKPi_fullmassErr'] = err(alpha_comb.BdComb_fit)
    
    operator['fsfd']     = val(alpha12.fdfs)
    operator['fsfdErrP'] = err(alpha12.fdfs)
    operator['fsfdErrN'] =-err(alpha12.fdfs)
...
##     operator['MisIDGlobalFactorErr'] = err(MisIDGlobalFactor)
    ...
    operator['sigmaPiMuNu1ErrPlus'] =  err(PiMuNuSigma1) 
    operator['sigmaPiMuNu2ErrPlus'] =  err(PiMuNuSigma2) 
    operator['sigmaPiMuNu3ErrPlus'] =  err(PiMuNuSigma3) 
    operator['sigmaPiMuNu4ErrPlus'] =  err(PiMuNuSigma4) 
    operator['sigmaPiMuNu5ErrPlus'] =  err(PiMuNuSigma5) 
    operator['sigmaPiMuNu6ErrPlus'] =  err(PiMuNuSigma6) 
    operator['sigmaPiMuNu7ErrPlus'] =  err(PiMuNuSigma7) 
    operator['sigmaPiMuNu8ErrPlus'] =  err(PiMuNuSigma8)                
    operator['sigmaPiMuNu1ErrMinus'] =-err(PiMuNuSigma1)
    operator['sigmaPiMuNu2ErrMinus'] =-err(PiMuNuSigma2)
    operator['sigmaPiMuNu3ErrMinus'] =-err(PiMuNuSigma3)
    operator['sigmaPiMuNu4ErrMinus'] =-err(PiMuNuSigma4)
    operator['sigmaPiMuNu5ErrMinus'] =-err(PiMuNuSigma5)
    operator['sigmaPiMuNu6ErrMinus'] =-err(PiMuNuSigma6)
    operator['sigmaPiMuNu7ErrMinus'] =-err(PiMuNuSigma7)
    operator['sigmaPiMuNu8ErrMinus'] =-err(PiMuNuSigma8)
    ...
    operator['meanPiMuNu1ErrPlus'] =  err(PiMuNuMean1)
    operator['meanPiMuNu2ErrPlus'] =  err(PiMuNuMean2)
    operator['meanPiMuNu3ErrPlus'] =  err(PiMuNuMean3)
    operator['meanPiMuNu4ErrPlus'] =  err(PiMuNuMean4)
    operator['meanPiMuNu5ErrPlus'] =  err(PiMuNuMean5)
    operator['meanPiMuNu6ErrPlus'] =  err(PiMuNuMean6)
    operator['meanPiMuNu7ErrPlus'] =  err(PiMuNuMean7)
    operator['meanPiMuNu8ErrPlus'] =  err(PiMuNuMean8)
    operator['meanPiMuNu1ErrMinus'] =-err(PiMuNuMean1)
    operator['meanPiMuNu2ErrMinus'] =-err(PiMuNuMean2)
    operator['meanPiMuNu3ErrMinus'] =-err(PiMuNuMean3)
    operator['meanPiMuNu4ErrMinus'] =-err(PiMuNuMean4)
    operator['meanPiMuNu5ErrMinus'] =-err(PiMuNuMean5)
    operator['meanPiMuNu6ErrMinus'] =-err(PiMuNuMean6)
    operator['meanPiMuNu7ErrMinus'] =-err(PiMuNuMean7)
    operator['meanPiMuNu8ErrMinus'] =-err(PiMuNuMean8)
#
    ...
    f = open('toytable_summer13_scaled2.py','w')
    for key in keys:
