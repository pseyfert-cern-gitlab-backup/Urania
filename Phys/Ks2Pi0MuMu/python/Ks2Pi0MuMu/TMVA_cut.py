...
variables_cont_nopi0 = ["DOCA", "mu1ips", "mu2ips", "Bips", "Bpt", "mu1_probNNmu", "mu2_probNNmu", "Vchi2", "Bdissig", "mu1_track_Chi2DoF", "mu2_track_Chi2DoF", "ProbNNghost1", "ProbNNghost2", "mu1GP", "mu2GP"]#LF_time, KIP, 
...
for i in range(len(variables_cont_nopi0)-1): 
