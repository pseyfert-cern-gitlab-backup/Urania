...
factory.AddSpectator( "KSmass",  "Spectator 1", "units")#, 'F' )
...
##FILES
signal_train, f1      = getTuple("kspi0mumu_ntupleMC12_Strip_Up",thing = "BenderKspi0mumuSignal/BenderKspi0mumuSignal")
signal_test, f2      = getTuple("kspi0mumu_ntupleMC12_Strip_Down",thing = "BenderKspi0mumuSignal/BenderKspi0mumuSignal")
bkg_train, f3      = getTuple("bkgMini", thing = "BenderKspi0mumuSignal/BenderKspi0mumuSignal")
bkg_test, f4     = getTuple("bkgMini", thing = "BenderKspi0mumuSignal/BenderKspi0mumuSignal")
