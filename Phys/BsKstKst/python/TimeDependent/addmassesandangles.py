...
KpPx_name = 'Kplus_TRUEP_X'
KpPy_name = 'Kplus_TRUEP_Y'
KpPz_name = 'Kplus_TRUEP_Z'
KmPx_name = 'Kminus_TRUEP_X'
KmPy_name = 'Kminus_TRUEP_Y'
KmPz_name = 'Kminus_TRUEP_Z'
PipPx_name = 'piplus_TRUEP_X'
PipPy_name = 'piplus_TRUEP_Y'
PipPz_name = 'piplus_TRUEP_Z'
PimPx_name = 'piminus_TRUEP_X'
PimPy_name = 'piminus_TRUEP_Y'
PimPz_name = 'piminus_TRUEP_Z'
ctau_name = ''
truetau_name = ''
ctauerr_name = ''
...
def AddAngles():
	...
	fcosin = TFile(NTUPLE_PATH+'DVntuple.root')
	tcosin = fcosin.Get('MCDecayTreeTuple/MCDecayTree')
	fcosout = TFile(NTUPLE_PATH+'DVntuple_AllBranches.root','RECREATE')
	print "Copying the original tree ..."
	tcosout = tcosin.CopyTree("")
	print "Tree copied."

	m1 = MyStruct()
	newBranchm1 = tcosout.Branch('B_s0_DTF_KST1_M', AddressOf(m1,'afloat'), 'B_s0_DTF_KST1_M/F')
	m2 = MyStruct()
	newBranchm2 = tcosout.Branch('B_s0_DTF_KST2_M', AddressOf(m2,'afloat'), 'B_s0_DTF_KST2_M/F')
	cos1 = MyStruct()
