...
flat_acc = 0
nw_acc = 0 # 0 for parametric factorized acceptance / 1 for normalization weights.
...
data_file = 'Bs2KpiKpi_Data1112_withCuts_sWeighted.root'
...
inf_t_res,wide_window,fix_wave_fractions,fix_dirCP_asyms,fix_strong_phases,fix_weak_phases,fix_mixing_params,fix_calib_params,pw_alternative_model)
	...
	# Data importation.
	data, hist_mistag_SSK, hist_mistag_OS, hist_deltat = loadData(NTUPLE_PATH,data_type,data_file,MC_file,sweighted,flat_acc,wide_window,evnum_limit)
...
pw_alternative_model,f_Kst1410_rel2_Kst892,delta_Kst1410_rel2_Kst892,f_Kst1680_rel2_Kst892,delta_Kst1680_rel2_Kst892)
	...
	result = DoFit(model,data,num_CPU,activ_minos,fix_mixing_params,fix_calib_params)
...
pw_alternative_model,f_Kst1410_rel2_Kst892,delta_Kst1410_rel2_Kst892,f_Kst1680_rel2_Kst892,delta_Kst1680_rel2_Kst892)
	...
	plot61Ddata(data, wide_window, m_binning, cos_binning, phi_binning, t_binning) # Plotting the dataset.
	plot61Dmodel(model, wide_window) # Plotting the full model.
	plot61Dcomponent(model, wide_window) # Plotting the KstKst component.
...
def MCSJob(job_ID,nevs,nexps,outtag,GRID):
	...
	# Data importation.
	if GRID: data, hist_mistag_SSK, hist_mistag_OS, hist_deltat = loadData('',data_type,data_file,MC_file,sweighted,flat_acc,wide_window,evnum_limit)
	else: data, hist_mistag_SSK, hist_mistag_OS, hist_deltat = loadData(NTUPLE_PATH,data_type,data_file,MC_file,sweighted,flat_acc,wide_window,evnum_limit)
...
pw_alternative_model,f_Kst1410_rel2_Kst892,delta_Kst1410_rel2_Kst892,f_Kst1680_rel2_Kst892,delta_Kst1680_rel2_Kst892)
	...
	doToyMCStudy(nexps,nevs,model,outtag,job_ID,GRID)
