...
def LoadDataNW(evnum_limit = 0):
	...
	data_file = 'DVntuple_AllBranches'
	...
	tree_full = file_in.Get(data_tree)
	file_out = TFile(NTUPLE_PATH + "trash.root","RECREATE")
	tree_2011_wide = tree_full.CopyTree(t_name_MC+">=0. && "+t_name_MC+"<=12.")
	tree_2012_wide = tree_full.CopyTree(t_name_MC+">=0. && "+t_name_MC+"<=12.")
	tree_2011_narrow = tree_full.CopyTree("abs("+m1_name_MC+"-900.)<150. && abs("+m2_name_MC+"-900.)<150. && "+t_name_MC+">=0. && "+t_name_MC+"<=12.")
	tree_2012_narrow = tree_full.CopyTree("abs("+m1_name_MC+"-900.)<150. && abs("+m2_name_MC+"-900.)<150. && "+t_name_MC+">=0. && "+t_name_MC+"<=12.")
...
data0_2011_wide, data0_2012_wide, data0_2011_narrow, data0_2012_narrow = LoadDataNW()
