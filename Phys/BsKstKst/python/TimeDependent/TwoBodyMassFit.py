...
f00.setVal(0.303301505031)
f01.setVal(1.48950825477)
f02.setVal(0.629137586696)
f12.setVal(4.78454781683)
f22.setVal(1.99152240019)
c1.setVal(0.00491636810678)
c2.setVal(2.12489529189)
c3.setVal(0.560041794845)
c4.setVal(0.0)
c5.setVal(-4.20943829183)
c6.setVal(-1.2110147687)
c7.setVal(2.28474898994)
c8.setVal(5.93332582489)
c9.setVal(0.0)

#for c in [c1,c2,c3,c4,c5,c6,c7,c8,c9]: c.setConstant()
for c in [c4,c9]: c.setConstant()
