...
Jobname  = 'FitnGentry.py'
Script = [ 'FitnGentry.py' ]
Args  = ["fitnplot"]
...
Inputsandbox += [
    '/afs/cern.ch/user/j/jugarcia/cmtuser/Phys/BsKstKst/python/TimeDependent/FitnGentry.py',
...
fit_job.backend.settings['CPUTime'] = 2*24*60*60
