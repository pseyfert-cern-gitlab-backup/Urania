...
Jobname  = 'FitnGennarrowfast.py'
Script = [ 'FitnGennarrowfast.py' ]
Args  = ["fitnplot"]
...
Inputsandbox += [
    '/afs/cern.ch/user/j/jugarcia/cmtuser/Phys/BsKstKst/python/TimeDependent/FitnGennarrowfast.py',
...
fit_job.backend.settings['CPUTime'] = 6*24*60*60
