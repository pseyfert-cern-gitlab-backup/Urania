...
Jobname  = 'FitnGenNarrow.py'
Script = [ 'FitnGenNarrow.py' ]
Args  = ["fitnplot"]
...
Inputsandbox += [
    '/afs/cern.ch/user/j/jugarcia/cmtuser/Phys/BsKstKst/python/TimeDependent/FitnGenNarrow.py',
...
Outputsandbox = ["plot61D.root","plot61D.pdf","FitParams.tex"]
