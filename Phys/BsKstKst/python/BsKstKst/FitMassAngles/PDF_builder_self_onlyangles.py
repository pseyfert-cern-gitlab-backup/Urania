...
gROOT.ProcessLine(".L ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngAbsFunc.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF1.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF2.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF3.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF5.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF7.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF7_int.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF8.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF9.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF10.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF11.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF13.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF14.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/AngF15.cxx+")
gROOT.ProcessLine(".L ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassAbsFunc.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK1.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK7.cxx++")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK7_int.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK8.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK9.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK10.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK11.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK13.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK14.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/MassK15.cxx+")



gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/FourB.cxx+")
gROOT.ProcessLine(".x ${BSKSTKSTROOT}/src/TimeIntegratedRephase/FourB_Mass.cxx+")
...
class AngularPDF:
    def __init__(self,name):
        ...
        self.Csp_arg_name = "Csp_arg_"+self.name 
        ...
        self.Csp_arg = RooRealVar(self.Csp_arg_name,self.Csp_arg_name,0.,2*pi)
    ...
    def make(self):
        ...
        self.M8 = RooFormulaVar("M8_"+neim,"M8_"+neim,self.norm_int.GetName()+"*"+self.A0name+"*"+self.Asmname+"*cos("+self.dsm.GetName()+"+"+self.Csp_arg.GetName()+")"
                                ,RooArgList(self.norm_int,self.A0,self.Asm,self.dsm,self.Csp_arg))

        self.M9 = RooFormulaVar("M9_"+neim,"M9_"+neim,self.norm_int.GetName()+"*"+self.Apaname+"*"+self.Asmname+"*cos("+self.dsm.GetName()+"-"+self.dpa.GetName()+"+"+self.Csp_arg.GetName()+")"
                                ,RooArgList(self.norm_int,self.Apa,self.Asm,self.dsm,self.dpa,self.Csp_arg))

        self.M10 = RooFormulaVar("M10_"+neim,"M10_"+neim,self.norm_int.GetName()+"*"+self.Apename+"*"+self.Aspname+"*sin("+self.dsp.GetName()+"-"+self.dpe.GetName()+"+"+self.Csp_arg.GetName()+")"
                                 ,RooArgList(self.norm_int,self.Ape,self.Asp,self.dsp,self.dpe,self.Csp_arg))
