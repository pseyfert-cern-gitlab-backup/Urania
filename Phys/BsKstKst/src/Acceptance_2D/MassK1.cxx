...
// MassK1::MassK1()
// {
//   RooRealVar m1RV("m1RV","m1",896-150,896+150);
//   RooRealVar m2RV("m2RV","m2",,896-150,896+150);
//   RooRealVar m_kstRV("m_kstRV","m_kst",896);
//   RooRealVar g_kstRV("g_kstRV","g_kst",50);
//   RooRealVar m_kst0RV("m_kst0RV","m_kst0",1430.);
//   RooRealVar g_kst0RV("g_kst0RV","g_kst0",279.);
//   RooRealVar m_BsRV("m_BsRV","m_Bs",5366.3);
//   RooRealVar normRV("normRV","norm",1.);

//   RooArgList acc_coefListRV();


//   MassK1("MassK1","MassK1",m1RV,n2RV,m_kstRV,m_kst0RV,g_kstRV,g_kst0RV,m_BsRV,accTH_coefListRV,normRV);  

// }

Double_t MassK1::get_q( Double_t Mass, Double_t m1_, Double_t m2_)const // given the mass of the mother and the daughters, calculates the momentum of the daughters in mother's rest frame
{
