...
ClassImp(AngF8) 
 ...
 { 
   ...
   return -8*c1*c1*c2/sqrt(3)*acc_val; 
 } 



Double_t AngF8::analyticalIntegral(Int_t code, const char* rangeName) const
 { 
   ...
   if (code==1 || code==2 || code==4 || code==6){
     ...
     double x2 = pow(hic2,2)/2. + (c1_th*pow(hic2,3))/3. + (c2_th*pow(hic2,4))/4. + (c3_th*pow(hic2,5))/5. + (c4_th*pow(hic2,6))/6. + (c5_th*pow(hic2,7))/7.;
     double y2 = pow(loc2,2)/2. + (c1_th*pow(loc2,3))/3. + (c2_th*pow(loc2,4))/4. + (c3_th*pow(loc2,5))/5. + (c4_th*pow(loc2,6))/6. + (c5_th*pow(loc2,7))/7.;
   ...
   if (code==1 || code==3 || code==4 || code==7 ){
     ...
     double x3 = (hiph + (c1_ph*cos(c2_ph*hiph)*sin(c3_ph))/c2_ph + (c1_ph*cos(c3_ph)*sin(c2_ph*hiph))/c2_ph);
     double y3 = (loph + (c1_ph*cos(c2_ph*loph)*sin(c3_ph))/c2_ph + (c1_ph*cos(c3_ph)*sin(c2_ph*loph))/c2_ph);
