...
//   AngF3("AngF3","AngF3",c1RV,c2RV,phRV,accTH_coefListRV,accPH_coefListRV);  
// }

 Double_t AngF3::evaluate() const 
 { 
...
Double_t AngF3::analyticalIntegral(Int_t code, const char* rangeName) const
{ 
