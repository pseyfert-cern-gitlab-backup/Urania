...
class Testing_math : public RooAbsPdf {
public:
  Testing_math() {} ; 
  Testing_math(const char *name, const char *title,
	      ...
	      RooAbsReal& _c4th,
	      RooAbsReal& _yth);
  Testing_math(const Testing_math& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new Testing_math(*this,newname); }
  inline virtual ~Testing_math() { }
...
private:
  ...
  ClassDef(Testing_math,1) // Your description goes here...
};
