...
#ifndef ANGULARPDFACC_V3
#define ANGULARPDFACC_V3
...
class AngularPDFAcc_v3 : public RooAbsPdf {
public:
  AngularPDFAcc_v3() {} ; 
  AngularPDFAcc_v3(const char *name, const char *title,
	      ...
	      RooAbsReal& _c4th2,
	      RooAbsReal& _yth2);
  AngularPDFAcc_v3(const AngularPDFAcc_v3& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new AngularPDFAcc_v3(*this,newname); }
  inline virtual ~AngularPDFAcc_v3() { }
...
private:
  ...
  ClassDef(AngularPDFAcc_v3,1) // Your description goes here...
};
