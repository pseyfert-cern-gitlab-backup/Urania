...
class RooSecond : public RooAbsPdf {
public:
  RooSecond() {} ; 
  RooSecond(const char *name, const char *title,
	      ...
	      RooAbsReal& _c4th,
	      RooAbsReal& _yth);
  RooSecond(const RooSecond& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new RooSecond(*this,newname); }
  inline virtual ~RooSecond() { }
...
private:
  ...
  ClassDef(RooSecond,1) // Your description goes here...
};
