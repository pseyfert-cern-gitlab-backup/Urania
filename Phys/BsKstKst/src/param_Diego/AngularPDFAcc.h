...
#ifndef ANGULARPDFACC
#define ANGULARPDFACC
...
class AngularPDFAcc : public RooAbsPdf {
public:
  AngularPDFAcc() {} ; 
  AngularPDFAcc(const char *name, const char *title,
	      ...
	      RooAbsReal& _c4th,
	      RooAbsReal& _yth);
  AngularPDFAcc(const AngularPDFAcc& other, const char* name=0) ;
  virtual TObject* clone(const char* newname) const { return new AngularPDFAcc(*this,newname); }
  inline virtual ~AngularPDFAcc() { }
...
private:
  ...
  ClassDef(AngularPDFAcc,1) // Your description goes here...
};
