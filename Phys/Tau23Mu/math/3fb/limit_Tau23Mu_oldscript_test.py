...
outfilename="test1"
#unbfile = "../../params/deprecated/v5_unblinded.root"
#bkgfile="../../params/deprecated/v5_eta_bck_good_errors.root"
#sigfile="../../params/deprecated/v5_sigPDF.root"

#bkgfile="/mnt/people/mchrzaszcz/cmtuser/Bender_v22r7/Phys/Tau23Mu/fits_2012/bck_eta_cut450_v2.root"
#sigfile="/mnt/people/mchrzaszcz/cmtuser/Bender_v22r7/Phys/Tau23Mu/params/3fb/v2_2011_newcalib_down_PIDtrash.root"

bkgfile="/mnt/people/mchrzaszcz/cmtuser/Bender_v22r7/Phys/Tau23Mu/fits_2012/bck_eta_cut450_old.root";
sigfile="/mnt/people/mchrzaszcz/cmtuser/Bender_v22r7/Phys/Tau23Mu/params/3fb/GeoMVA_in_GeoMVAbinning_PIDtrash.root"


#outfilename="fixed_original"
#unbfile = "../params/v6_unblinded.root"
...
numberBkg_2011=bkgpdf.GetSum()
print "sum bck", numberBkg_2011
...
#for jj in range(0):
#           ii = jj+1
#           f_now = TFile("../../params/deprecated/v5_systematics_bkg"+str(ii)+".root")
...
fflist = []
#for jj in range(12):
#           f_now = TFile("../../params/deprecated/v5_systematics_sig"+str(jj)+".root")
#           pl = f_now.Get("plus")
#           mi = f_now.Get("minus")
#           fflist+=[f_now]
#           np_plist+=[pl]
