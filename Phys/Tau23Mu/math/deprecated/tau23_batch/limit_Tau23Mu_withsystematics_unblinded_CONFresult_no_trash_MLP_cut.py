...
outfilename="no_trash_check_MLPcut_"+str(sys.argv[1])
unbfile = "../../params/v5_unblinded_no_trash.root"
bkgfile="../../params/pdf_exp_MLP_cut.root"
...
for jj in range(16):
           ii = jj+1
           f_now = TFile("../../params/bck_MLP_cut"+str(ii)+".root")
