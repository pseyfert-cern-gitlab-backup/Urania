...
alpha = 2.515e-9/0.7588
NTOYS = 2000000
# systematics for which background bins
bkgpar = range(1,16)#[10,15,19,22,20,25,23,24] #20,25 missing
...
outfilename="no_trash_check"+str(sys.argv[1])
unbfile = "../../params/v5_unblinded_no_trash.root"
bkgfile="../../params/v5_eta_bck_good_errors_no_trash.root"
sigfile="../../params/v5_sigPDF_no_trash.root"
...
for jj in range(16):
           ii = jj+1
           f_now = TFile("../../params/v5_systematics_bkg_no_trash"+str(ii-1)+".root")
...
fflist = []
for jj in range(12):
           f_now = TFile("../../params/v5_systematics_sig_no_trash"+str(jj)+".root")
           pl = f_now.Get("plus")
           mi = f_now.Get("minus")
           fflist+=[f_now]
           np_plist+=[pl]
