...
// Mon May 13 13:48:05 2013 by ROOT version 5.34/05
// from TTree Tau23Mu/Tau23Mu
// found on file: largesig.root
//////////////////////////////////////////////////////////
...
public :
   ...
   Float_t         TMVA_0x109cf818;
   Float_t         TMVA_0x119cf818;
   Float_t         TMVA_0x129cf818;
   Float_t         TMVA_0x141cf818;
   Float_t         TMVA_0x145cf818;
   Float_t         TMVA_0x149c1818;
   Float_t         TMVA_0x149ce018;
   Float_t         TMVA_0x149ce718;
   Float_t         TMVA_0x149cf818;
   Float_t         TMVA_0x1c9cf818;
   Float_t         TMVA_0x549cf818;
   ...
   TBranch        *b_TMV_0x109cf818;   //!
   TBranch        *b_TMV_0x119cf818;   //!
   TBranch        *b_TMV_0x129cf818;   //!
   TBranch        *b_TMV_0x141cf818;   //!
   TBranch        *b_TMV_0x145cf818;   //!
   TBranch        *b_TMV_0x149c1818;   //!
   TBranch        *b_TMV_0x149ce018;   //!
   TBranch        *b_TMV_0x149ce718;   //!
   TBranch        *b_TMV_0x149cf818;   //!
   TBranch        *b_TMV_0x1c9cf818;   //!
   TBranch        *b_TMV_0x549cf818;   //!
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("largesig.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("largesig.root");
      }
...
//    fChain->SetBranchAddress("p2_IPSig", &p2_IPSig, &b_p2_IPSig);
   ...
   fChain->SetBranchAddress("TMVA_0x109cf818", &TMVA_0x109cf818, &b_TMV_0x109cf818);
   fChain->SetBranchAddress("TMVA_0x119cf818", &TMVA_0x119cf818, &b_TMV_0x119cf818);
   fChain->SetBranchAddress("TMVA_0x129cf818", &TMVA_0x129cf818, &b_TMV_0x129cf818);
   fChain->SetBranchAddress("TMVA_0x141cf818", &TMVA_0x141cf818, &b_TMV_0x141cf818);
   fChain->SetBranchAddress("TMVA_0x145cf818", &TMVA_0x145cf818, &b_TMV_0x145cf818);
   fChain->SetBranchAddress("TMVA_0x149c1818", &TMVA_0x149c1818, &b_TMV_0x149c1818);
   fChain->SetBranchAddress("TMVA_0x149ce018", &TMVA_0x149ce018, &b_TMV_0x149ce018);
   fChain->SetBranchAddress("TMVA_0x149ce718", &TMVA_0x149ce718, &b_TMV_0x149ce718);
   fChain->SetBranchAddress("TMVA_0x149cf818", &TMVA_0x149cf818, &b_TMV_0x149cf818);
   fChain->SetBranchAddress("TMVA_0x1c9cf818", &TMVA_0x1c9cf818, &b_TMV_0x1c9cf818);
   fChain->SetBranchAddress("TMVA_0x549cf818", &TMVA_0x549cf818, &b_TMV_0x549cf818);
   Notify();
}
