...
void TMVACC( TString myMethodList = "" , int varset = 0xFFFFFF)
{
   ...
   TString outfileName( Form("twobody_etap.root",varset) );
   ...
   TMVA::Factory *factory = new TMVA::Factory( Form("twobody_etap",varset), outputFile,
...
void TMVA_develope_twobody_eta() {
  TMVACC();
  int varset = 0000;
  TMVAGui(Form("twobody_etap.root",varset));
}
