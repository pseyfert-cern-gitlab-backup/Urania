...
void TMVACC( TString myMethodList = "" , int varset = 0xFFFFFF)
{
   ...
   TString outfileName( Form("twobody_catp.root",varset) );
   ...
   TMVA::Factory *factory = new TMVA::Factory( Form("twobody_catp",varset), outputFile,
...
factory->AddVariable("polarisationangle");
TString var = "Dalitz_m12:Dalitz_m23";
TString var2 = "Dalitz_m12:Dalitz_m23:polarisationangle";
...
*/
   ...
   //if (Use["BDT"])  // Adaptive Boost
      factory->BookMethod( TMVA::Types::kBDT, "BDT","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
   TMVA::MethodBase* cats = factory->BookMethod( TMVA::Types::kCategory,"BDTcat","");
   TMVA::MethodCategory* mcat = dynamic_cast<TMVA::MethodCategory*>(cats);
      mcat->AddMethod( "GeoMVA<0.05",var,TMVA::Types::kBDT, "BDT_1","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
      mcat->AddMethod( "GeoMVA>=0.05&&GeoMVA<0.35",var,TMVA::Types::kBDT, "BDT_2","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
      mcat->AddMethod( "GeoMVA>=0.35&&GeoMVA<0.55",var,TMVA::Types::kBDT, "BDT_3","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
      mcat->AddMethod( "GeoMVA>=0.55",var,TMVA::Types::kBDT, "BDT_4","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );

   TMVA::MethodBase* catsp = factory->BookMethod( TMVA::Types::kCategory,"BDTcatp","");
   TMVA::MethodCategory* mcatp = dynamic_cast<TMVA::MethodCategory*>(catsp);
      mcatp->AddMethod( "GeoMVA<0.05",var2,TMVA::Types::kBDT, "BDTp_1","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
      mcatp->AddMethod( "GeoMVA>=0.05&&GeoMVA<0.35",var2,TMVA::Types::kBDT, "BDTp_2","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
      mcatp->AddMethod( "GeoMVA>=0.35&&GeoMVA<0.55",var2,TMVA::Types::kBDT, "BDTp_3","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
      mcatp->AddMethod( "GeoMVA>=0.55",var2,TMVA::Types::kBDT, "BDTp_4","!H:!V:NTrees=288:nEventsMin=20:MaxDepth=7:BoostType=AdaBoost:AdaBoostBeta=1.5:SeparationType=GiniIndex:nCuts=20:PruneMethod=NoPruning" );
...
void TMVA_develope_twobody_cat() {
  TMVACC();
  int varset = 0000;
  TMVAGui(Form("twobody_catp.root",varset));
}
