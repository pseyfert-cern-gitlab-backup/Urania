...
void TMVACC( TString myMethodList = "" , int varset = 0xFFFFFF)
{
   ...
   TString outfileName( Form("twobody_noopt.root",varset) );
   ...
   TMVA::Factory *factory = new TMVA::Factory( Form("twobody_noopt",varset), outputFile,
...
//factory->AddVariable("p2_expectedTT");
   ...
   //factory->SetSignalWeightExpression("productionweight");
...
void TMVA_develope_twobody_noopt() {
  TMVACC();
  int varset = 0000;
  TMVAGui(Form("twobody_noopt.root",varset));
}
