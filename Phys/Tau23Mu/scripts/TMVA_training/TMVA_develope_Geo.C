...
void TMVACC( TString myMethodList = "" , int varset = 0xFFFFFF)
{
   ...
   TMVA::Factory *factory = new TMVA::Factory( Form("Geo_v4_%x",varset), outputFile,
...
*/
   ...
   TString Bbname1 = "/auto/data/pseyfert/NB_MC/mcbkg_2011trigger_MC10inclB_DOWN_TRUTHATTEMPT_sm0_flat.root";
   TString Bbname2 = "/auto/data/pseyfert/NB_MC/mcbkg_2011trigger_MC10inclB_UP_TRUTHATTEMPT_sm0_flat.root";
   TString Cbname1 = "/auto/data/pseyfert/NB_MC/mcbkg_2011trigger_MC10inclC_DOWN_TRUTHATTEMPT_sm0_flat.root";
   TString Cbname2 = "/auto/data/pseyfert/NB_MC/mcbkg_2011trigger_MC10inclC_UP_TRUTHATTEMPT_sm0_flat.root";
   TString fname1 = "/auto/data/pseyfert/NB_MC/mcselected_MC10tau23mu_md_TCKEMU_flat_78499evts.root";
   TString fname2 = "/auto/data/pseyfert/NB_MC/mcselected_MC10tau23mu_mu_TCKEMU_flat_83099evts.root";
   
   TFile *inputs1 = TFile::Open( fname1 );
   TFile *inputs2 = TFile::Open( fname2 );
   //TFile *inputb = TFile::Open( bname );
   TFile *inputbB1 = TFile::Open( Bbname1 );
   TFile *inputbC1 = TFile::Open( Cbname1 );
   TFile *inputbB2 = TFile::Open( Bbname2 );
   TFile *inputbC2 = TFile::Open( Cbname2 );
   
   // --- Register the training and test trees

   TTree *signal1    = (TTree*)inputs1->Get("Tau23Mu");
   TTree *signal2    = (TTree*)inputs2->Get("Tau23Mu");
   //TTree *background = (TTree*)inputb->Get("Tau23Mu");
   TTree *Cbackground1    = (TTree*)inputbC1->Get("Tau23Mu");
   TTree *Bbackground1    = (TTree*)inputbB1->Get("Tau23Mu");
   TTree *Cbackground2    = (TTree*)inputbC2->Get("Tau23Mu");
   TTree *Bbackground2    = (TTree*)inputbB2->Get("Tau23Mu");
   ...
   factory->AddBackgroundTree( Bbackground1, BbackgroundWeight );
   factory->AddBackgroundTree( Cbackground1, CbackgroundWeight );
   factory->AddBackgroundTree( Bbackground2, BbackgroundWeight );
   factory->AddBackgroundTree( Cbackground2, CbackgroundWeight );
   ...
   factory->SetSignalWeightExpression("productionweightMC11v3");
...
//   TCut mycutb = "cleaningcut&&L0Dec&&Hlt1Dec&&Hlt2Dec"; // for example: TCut mycutb = "abs(var1)<0.5";
     ...
     TCut mycuts;
     if (restricttods)
       mycuts = "L0Dec&&Hlt1Dec&&Hlt2Dec&&cleaningcut&&abs(mass_p0p2-1020)>20&&abs(mass_p1p2-1020)>20&&mass_p0p1>250&&LifeTime<0.025&&LifeTime>-0.01&&dira>0.99&&truetau==15&&(!(tauproduction&0x2220))";
     else
