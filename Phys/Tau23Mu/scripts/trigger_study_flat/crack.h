...
// Wed Jan  1 13:41:56 2014 by ROOT version 5.34/04
// from TTree Tau23Mu/Tau23Mu
// found on file: 2011DOWN.root
//////////////////////////////////////////////////////////
...
public :
   ...
   //Float_t         21513000_B_BDTGVF;
   //Float_t         21513000_B_BDTVF;
   //Float_t         21513000_B_MLPCJ_SIGVF;
   //Float_t         21513000_B_MLPCJVF;
   //Float_t         21513000_B_MLP_SIGVF;
   //Float_t         21513000_B_MLPVF;
   //Float_t         21513000_B_FisherVF;
   //Float_t         21513000_B_FisherGVF;
   //Float_t         21513000_B_FDA_GAVF;
   //Float_t         21513000_B_FDA_SAVF;
   //Float_t         21513000_B_LDVF;
   //Float_t         21513001_B_BDTGVF;
   //Float_t         21513001_B_BDTVF;
   //Float_t         21513001_B_MLPCJ_SIGVF;
   //Float_t         21513001_B_MLPCJVF;
   //Float_t         21513001_B_MLP_SIGVF;
   //Float_t         21513001_B_MLPVF;
   //Float_t         21513001_B_FisherVF;
   //Float_t         21513001_B_FisherGVF;
   //Float_t         21513001_B_FDA_GAVF;
   //Float_t         21513001_B_FDA_SAVF;
   //Float_t         21513001_B_LDVF;
   //Float_t         23513000_B_BDTGVF;
   //Float_t         23513000_B_BDTVF;
   //Float_t         23513000_B_MLPCJ_SIGVF;
   //Float_t         23513000_B_MLPCJVF;
   //Float_t         23513000_B_MLP_SIGVF;
   //Float_t         23513000_B_MLPVF;
   //Float_t         23513000_B_FisherVF;
   //Float_t         23513000_B_FisherGVF;
   //Float_t         23513000_B_FDA_GAVF;
   //Float_t         23513000_B_FDA_SAVF;
   //Float_t         23513000_B_LDVF;
   //Float_t         23513001_B_BDTGVF;
   //Float_t         23513001_B_BDTVF;
   //Float_t         23513001_B_MLPCJ_SIGVF;
   //Float_t         23513001_B_MLPCJVF;
   //Float_t         23513001_B_MLP_SIGVF;
   //Float_t         23513001_B_MLPVF;
   //Float_t         23513001_B_FisherVF;
   //Float_t         23513001_B_FisherGVF;
   //Float_t         23513001_B_FDA_GAVF;
   //Float_t         23513001_B_FDA_SAVF;
   //Float_t         23513001_B_LDVF;
   //Float_t         31113002_B_BDTGVF;
   //Float_t         31113002_B_BDTVF;
   //Float_t         31113002_B_MLPCJ_SIGVF;
   //Float_t         31113002_B_MLPCJVF;
   //Float_t         31113002_B_MLP_SIGVF;
   //Float_t         31113002_B_MLPVF;
   //Float_t         31113002_B_FisherVF;
   //Float_t         31113002_B_FisherGVF;
   //Float_t         31113002_B_FDA_GAVF;
   //Float_t         31113002_B_FDA_SAVF;
   //Float_t         31113002_B_LDVF;
   Double_t        LifeTime_N;
   Double_t        min_p_IPSig;
   Double_t        min_p_pt;
   Double_t        min_track;
   Double_t        min_DOCA;
   Double_t        min_Laura;
   Double_t        min_p_IP;
   Double_t        FlightD_FlightDE;
   Double_t        dira_N;
   Float_t         MN_B;
   Float_t         MN_D;
   Float_t         MN_D_B;
   ...
   //TBranch        *b_T21513000_B_BDTG;   //!
   //TBranch        *b_T21513000_B_BDT;   //!
   //TBranch        *b_T21513000_B_MLPCJ_SIG;   //!
   //TBranch        *b_T21513000_B_MLPCJ;   //!
   //TBranch        *b_T21513000_B_MLP_SIG;   //!
   //TBranch        *b_T21513000_B_MLP;   //!
   //TBranch        *b_T21513000_B_Fisher;   //!
   //TBranch        *b_T21513000_B_FisherG;   //!
   //TBranch        *b_T21513000_B_FDA_GA;   //!
   //TBranch        *b_T21513000_B_FDA_SA;   //!
   //TBranch        *b_T21513000_B_LD;   //!
   //TBranch        *b_T21513001_B_BDTG;   //!
   //TBranch        *b_T21513001_B_BDT;   //!
   //TBranch        *b_T21513001_B_MLPCJ_SIG;   //!
   //TBranch        *b_T21513001_B_MLPCJ;   //!
   //TBranch        *b_T21513001_B_MLP_SIG;   //!
   //TBranch        *b_T21513001_B_MLP;   //!
   //TBranch        *b_T21513001_B_Fisher;   //!
   //TBranch        *b_T21513001_B_FisherG;   //!
   //TBranch        *b_T21513001_B_FDA_GA;   //!
   //TBranch        *b_T21513001_B_FDA_SA;   //!
   //TBranch        *b_T21513001_B_LD;   //!
   //TBranch        *b_T23513000_B_BDTG;   //!
   //TBranch        *b_T23513000_B_BDT;   //!
   //TBranch        *b_T23513000_B_MLPCJ_SIG;   //!
   //TBranch        *b_T23513000_B_MLPCJ;   //!
   //TBranch        *b_T23513000_B_MLP_SIG;   //!
   //TBranch        *b_T23513000_B_MLP;   //!
   //TBranch        *b_T23513000_B_Fisher;   //!
   //TBranch        *b_T23513000_B_FisherG;   //!
   //TBranch        *b_T23513000_B_FDA_GA;   //!
   //TBranch        *b_T23513000_B_FDA_SA;   //!
   //TBranch        *b_T23513000_B_LD;   //!
   //TBranch        *b_T23513001_B_BDTG;   //!
   //TBranch        *b_T23513001_B_BDT;   //!
   //TBranch        *b_T23513001_B_MLPCJ_SIG;   //!
   //TBranch        *b_T23513001_B_MLPCJ;   //!
   //TBranch        *b_T23513001_B_MLP_SIG;   //!
   //TBranch        *b_T23513001_B_MLP;   //!
   //TBranch        *b_T23513001_B_Fisher;   //!
   //TBranch        *b_T23513001_B_FisherG;   //!
   //TBranch        *b_T23513001_B_FDA_GA;   //!
   //TBranch        *b_T23513001_B_FDA_SA;   //!
   //TBranch        *b_T23513001_B_LD;   //!
   //TBranch        *b_T31113002_B_BDTG;   //!
   //TBranch        *b_T31113002_B_BDT;   //!
   //TBranch        *b_T31113002_B_MLPCJ_SIG;   //!
   //TBranch        *b_T31113002_B_MLPCJ;   //!
   //TBranch        *b_T31113002_B_MLP_SIG;   //!
   //TBranch        *b_T31113002_B_MLP;   //!
   //TBranch        *b_T31113002_B_Fisher;   //!
   //TBranch        *b_T31113002_B_FisherG;   //!
   //TBranch        *b_T31113002_B_FDA_GA;   //!
   //TBranch        *b_T31113002_B_FDA_SA;   //!
   //TBranch        *b_T31113002_B_LD;   //!
   TBranch        *b_LifeTime_N;   //!
   TBranch        *b_min_p_IPSig;   //!
   TBranch        *b_min_p_pt;   //!
   TBranch        *b_min_track;   //!
   TBranch        *b_min_DOCA;   //!
   TBranch        *b_min_Laura;   //!
   TBranch        *b_min_p_IP;   //!
   TBranch        *b_FlightD_FlightDE;   //!
   TBranch        *b_dira_N;   //!
   TBranch        *b_MN_B;   //!
   TBranch        *b_MN_D;   //!
   TBranch        *b_MN_D_B;   //!
   ...
   virtual bool     skip_event(bool sigmc);
   virtual std::vector<crack_junkie>     Loop(bool sigmc);
   std::vector<crack_junkie> AddLoop(bool sigmc, std::vector<unsigned> order);
...
crack::crack(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("2011DOWN.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("2011DOWN.root");
      }
...
Int_t crack::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t crack::LoadTree(Long64_t entry)
{
...
void crack::Init(TTree *tree)
{
   ...
   //fChain->SetBranchAddress("21513000_B_BDTGVF", &21513000_B_BDTGVF, &b_T21513000_B_BDTG);
   //fChain->SetBranchAddress("21513000_B_BDTVF", &21513000_B_BDTVF, &b_T21513000_B_BDT);
   //fChain->SetBranchAddress("21513000_B_MLPCJ_SIGVF", &21513000_B_MLPCJ_SIGVF, &b_T21513000_B_MLPCJ_SIG);
   //fChain->SetBranchAddress("21513000_B_MLPCJVF", &21513000_B_MLPCJVF, &b_T21513000_B_MLPCJ);
   //fChain->SetBranchAddress("21513000_B_MLP_SIGVF", &21513000_B_MLP_SIGVF, &b_T21513000_B_MLP_SIG);
   //fChain->SetBranchAddress("21513000_B_MLPVF", &21513000_B_MLPVF, &b_T21513000_B_MLP);
   //fChain->SetBranchAddress("21513000_B_FisherVF", &21513000_B_FisherVF, &b_T21513000_B_Fisher);
   //fChain->SetBranchAddress("21513000_B_FisherGVF", &21513000_B_FisherGVF, &b_T21513000_B_FisherG);
   //fChain->SetBranchAddress("21513000_B_FDA_GAVF", &21513000_B_FDA_GAVF, &b_T21513000_B_FDA_GA);
   //fChain->SetBranchAddress("21513000_B_FDA_SAVF", &21513000_B_FDA_SAVF, &b_T21513000_B_FDA_SA);
   //fChain->SetBranchAddress("21513000_B_LDVF", &21513000_B_LDVF, &b_T21513000_B_LD);
   //fChain->SetBranchAddress("21513001_B_BDTGVF", &21513001_B_BDTGVF, &b_T21513001_B_BDTG);
   //fChain->SetBranchAddress("21513001_B_BDTVF", &21513001_B_BDTVF, &b_T21513001_B_BDT);
   //fChain->SetBranchAddress("21513001_B_MLPCJ_SIGVF", &21513001_B_MLPCJ_SIGVF, &b_T21513001_B_MLPCJ_SIG);
   //fChain->SetBranchAddress("21513001_B_MLPCJVF", &21513001_B_MLPCJVF, &b_T21513001_B_MLPCJ);
   //fChain->SetBranchAddress("21513001_B_MLP_SIGVF", &21513001_B_MLP_SIGVF, &b_T21513001_B_MLP_SIG);
   //fChain->SetBranchAddress("21513001_B_MLPVF", &21513001_B_MLPVF, &b_T21513001_B_MLP);
   //fChain->SetBranchAddress("21513001_B_FisherVF", &21513001_B_FisherVF, &b_T21513001_B_Fisher);
   //fChain->SetBranchAddress("21513001_B_FisherGVF", &21513001_B_FisherGVF, &b_T21513001_B_FisherG);
   //fChain->SetBranchAddress("21513001_B_FDA_GAVF", &21513001_B_FDA_GAVF, &b_T21513001_B_FDA_GA);
   //fChain->SetBranchAddress("21513001_B_FDA_SAVF", &21513001_B_FDA_SAVF, &b_T21513001_B_FDA_SA);
   //fChain->SetBranchAddress("21513001_B_LDVF", &21513001_B_LDVF, &b_T21513001_B_LD);
   //fChain->SetBranchAddress("23513000_B_BDTGVF", &23513000_B_BDTGVF, &b_T23513000_B_BDTG);
   //fChain->SetBranchAddress("23513000_B_BDTVF", &23513000_B_BDTVF, &b_T23513000_B_BDT);
   //fChain->SetBranchAddress("23513000_B_MLPCJ_SIGVF", &23513000_B_MLPCJ_SIGVF, &b_T23513000_B_MLPCJ_SIG);
   //fChain->SetBranchAddress("23513000_B_MLPCJVF", &23513000_B_MLPCJVF, &b_T23513000_B_MLPCJ);
   //fChain->SetBranchAddress("23513000_B_MLP_SIGVF", &23513000_B_MLP_SIGVF, &b_T23513000_B_MLP_SIG);
   //fChain->SetBranchAddress("23513000_B_MLPVF", &23513000_B_MLPVF, &b_T23513000_B_MLP);
   //fChain->SetBranchAddress("23513000_B_FisherVF", &23513000_B_FisherVF, &b_T23513000_B_Fisher);
   //fChain->SetBranchAddress("23513000_B_FisherGVF", &23513000_B_FisherGVF, &b_T23513000_B_FisherG);
   //fChain->SetBranchAddress("23513000_B_FDA_GAVF", &23513000_B_FDA_GAVF, &b_T23513000_B_FDA_GA);
   //fChain->SetBranchAddress("23513000_B_FDA_SAVF", &23513000_B_FDA_SAVF, &b_T23513000_B_FDA_SA);
   //fChain->SetBranchAddress("23513000_B_LDVF", &23513000_B_LDVF, &b_T23513000_B_LD);
   //fChain->SetBranchAddress("23513001_B_BDTGVF", &23513001_B_BDTGVF, &b_T23513001_B_BDTG);
   //fChain->SetBranchAddress("23513001_B_BDTVF", &23513001_B_BDTVF, &b_T23513001_B_BDT);
   //fChain->SetBranchAddress("23513001_B_MLPCJ_SIGVF", &23513001_B_MLPCJ_SIGVF, &b_T23513001_B_MLPCJ_SIG);
   //fChain->SetBranchAddress("23513001_B_MLPCJVF", &23513001_B_MLPCJVF, &b_T23513001_B_MLPCJ);
   //fChain->SetBranchAddress("23513001_B_MLP_SIGVF", &23513001_B_MLP_SIGVF, &b_T23513001_B_MLP_SIG);
   //fChain->SetBranchAddress("23513001_B_MLPVF", &23513001_B_MLPVF, &b_T23513001_B_MLP);
   //fChain->SetBranchAddress("23513001_B_FisherVF", &23513001_B_FisherVF, &b_T23513001_B_Fisher);
   //fChain->SetBranchAddress("23513001_B_FisherGVF", &23513001_B_FisherGVF, &b_T23513001_B_FisherG);
   //fChain->SetBranchAddress("23513001_B_FDA_GAVF", &23513001_B_FDA_GAVF, &b_T23513001_B_FDA_GA);
   //fChain->SetBranchAddress("23513001_B_FDA_SAVF", &23513001_B_FDA_SAVF, &b_T23513001_B_FDA_SA);
   //fChain->SetBranchAddress("23513001_B_LDVF", &23513001_B_LDVF, &b_T23513001_B_LD);
   //fChain->SetBranchAddress("31113002_B_BDTGVF", &31113002_B_BDTGVF, &b_T31113002_B_BDTG);
   //fChain->SetBranchAddress("31113002_B_BDTVF", &31113002_B_BDTVF, &b_T31113002_B_BDT);
   //fChain->SetBranchAddress("31113002_B_MLPCJ_SIGVF", &31113002_B_MLPCJ_SIGVF, &b_T31113002_B_MLPCJ_SIG);
   //fChain->SetBranchAddress("31113002_B_MLPCJVF", &31113002_B_MLPCJVF, &b_T31113002_B_MLPCJ);
   //fChain->SetBranchAddress("31113002_B_MLP_SIGVF", &31113002_B_MLP_SIGVF, &b_T31113002_B_MLP_SIG);
   //fChain->SetBranchAddress("31113002_B_MLPVF", &31113002_B_MLPVF, &b_T31113002_B_MLP);
   //fChain->SetBranchAddress("31113002_B_FisherVF", &31113002_B_FisherVF, &b_T31113002_B_Fisher);
   //fChain->SetBranchAddress("31113002_B_FisherGVF", &31113002_B_FisherGVF, &b_T31113002_B_FisherG);
   //fChain->SetBranchAddress("31113002_B_FDA_GAVF", &31113002_B_FDA_GAVF, &b_T31113002_B_FDA_GA);
   //fChain->SetBranchAddress("31113002_B_FDA_SAVF", &31113002_B_FDA_SAVF, &b_T31113002_B_FDA_SA);
   //fChain->SetBranchAddress("31113002_B_LDVF", &31113002_B_LDVF, &b_T31113002_B_LD);
   fChain->SetBranchAddress("LifeTime_N", &LifeTime_N, &b_LifeTime_N);
   fChain->SetBranchAddress("min_p_IPSig", &min_p_IPSig, &b_min_p_IPSig);
   fChain->SetBranchAddress("min_p_pt", &min_p_pt, &b_min_p_pt);
   fChain->SetBranchAddress("min_track", &min_track, &b_min_track);
   fChain->SetBranchAddress("min_DOCA", &min_DOCA, &b_min_DOCA);
   fChain->SetBranchAddress("min_Laura", &min_Laura, &b_min_Laura);
   fChain->SetBranchAddress("min_p_IP", &min_p_IP, &b_min_p_IP);
   fChain->SetBranchAddress("FlightD_FlightDE", &FlightD_FlightDE, &b_FlightD_FlightDE);
   fChain->SetBranchAddress("dira_N", &dira_N, &b_dira_N);
   fChain->SetBranchAddress("MN_B", &MN_B, &b_MN_B);
   fChain->SetBranchAddress("MN_D", &MN_D, &b_MN_D);
   fChain->SetBranchAddress("MN_D_B", &MN_D_B, &b_MN_D_B);
   fChain->SetBranchAddress("MN_Ds", &MN_Ds, &b_MN_Ds);
   fChain->SetBranchAddress("MN_Ds_B", &MN_Ds_B, &b_MN_Ds_B);
   fChain->SetBranchAddress("BLEND_MN", &BLEND_MN, &b_BLEND_MN);
   fChain->SetBranchAddress("BLEND_MN_FLAT", &BLEND_MN_FLAT, &b_BLEND_MN_FLAT);
   Notify();
}
...
void crack::Show(Long64_t entry)
{
...
Int_t crack::Cut(Long64_t entry)
{
