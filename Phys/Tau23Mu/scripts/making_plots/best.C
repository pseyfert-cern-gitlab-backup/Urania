...
void mcroc() {
  ...
  classifiers.push_back("oldTMVA_v3_0x141cf818");
  titles.push_back("old BDT 141");
  classifiers.push_back("TMVA_v3_0x141cf818");
  titles.push_back("best BDT 141");
  classifiers.push_back("oldTMVA_v3_0x149cf818");
  titles.push_back("old BDT 149");
  classifiers.push_back("TMVA_v3_0x149cf818");
  titles.push_back("best BDT 149");
  //classifiers.push_back("NeuroBayes_v3_0x149cf818");
  //titles.push_back("best NeuroBayes");
  //classifiers.push_back("MLPCJ_v3_0x141cf818");
  //titles.push_back("best MLP");
