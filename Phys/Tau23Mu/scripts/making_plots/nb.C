...
void mcroc() {
  ...
  classifiers.push_back("NeuroBayes_v1_0x149cf818");
  titles.push_back("NeuroBayes default");
  classifiers.push_back("NeuroBayes_v2_0x149cf818");
  titles.push_back("NeuroBayes recommendation");
  classifiers.push_back("NeuroBayes_v3_0x149cf818");
  titles.push_back("NeuroBayes default w/o peaking bkg");
  classifiers.push_back("NeuroBayes_v4_0x149cf818");
  titles.push_back("NeuroBayes recommendation w/o peaking bkg");
  //
  ...
  //classifiers.push_back("NeuroBayes_v1_0x149cf818");
  //classifiers.push_back("MLPCJ_v1_0x141cf818");
