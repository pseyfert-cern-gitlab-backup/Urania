...
void script()
{
  ...
  //  a->Add("/xdat1/lhcb/mchrzaszcz/tau23mu_FINAL/2012DOWN.root/Tau23Mu");
  // a->Add("/xdat1/lhcb/mchrzaszcz/tau23mu_FINAL/2012UP.root/Tau23Mu");
  a->Add("/mnt/data2/mchrzasz/Tau23mu_2012/2021DOWN.root/Tau23Mu");
  a->Add("/mnt/data2/mchrzasz/Tau23mu_2012/2021UP.root/Tau23Mu");
 ...
 delete tree;
   ...
   TFile* fj = new TFile("bck_eta_cut450_OBSERVED_2012.root","recreate");
