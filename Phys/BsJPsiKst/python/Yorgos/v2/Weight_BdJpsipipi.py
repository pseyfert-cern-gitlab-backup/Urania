...
#  the sum of the normalized weighst are 430 and the expected are 537
#######################################################################
...
###########################################################################
    Mmax = f_MC_tree_1.GetMaximum("Inv_mass")
    Mmin = f_MC_tree_1.GetMinimum("Inv_mass")
    ...
    term1 = re(As2['A_2pe']*As2['A_2pe'].conjugate()).n()
    term2 = re(As2['A_2pa']*As2['A_2pa'].conjugate()).n()
    term3 = re(As2['A_20']*As2['A_20'].conjugate()).n()
    term4 = re(As1['A_pa']*As1['A_pa'].conjugate()).n()
    term5 = re(As1['A_pe']*As1['A_pe'].conjugate()).n()
    term6 = re(As1['A_0']*As1['A_0'].conjugate()).n()
    term7 = re(As0['A_S']*As0['A_S'].conjugate()).n()
    ...
    const_old_pdf = integrate(1,(x,-1,1),(y,-1,1),(z,-pi,pi),(m,Mmin,Mmax))
...
#########################################################################
    ...
    for entry in range(int(f_MC_tree_1.GetEntries())):
        ...
        weight_addr[0]= W_exp * Afunc(angles[0],angles[1],angles[2],Invariant_mass,As2['A_2pe'],As2['A_2pa'],As2['A_20'],As1['A_0'],As1['A_pa'],As1['A_pe'],As0['A_S']).real
        Norm_weight_addr[0] = W_exp * Norm_Const * Afunc(angles[0],angles[1],angles[2],Invariant_mass,As2['A_2pe']*NB_2,As2['A_2pa']*NB_2,As2['A_20']*NB_2,As1['A_0']*NB_1,As1['A_pa']*NB_1,As1['A_pe']*NB_1,As0['A_S']*NB_0 ).real        
        weight_Branch.Fill()
