...
for key in pdf_split:
    ...
    my_time_exp[key] = timeExpression(key, time_mod_list)# *StrongPhases(key)  #changed in 7.30
...
## #new formula after delete strongphase in timeexpression in 7.30
## Nexp = 0
## for key in TristanWeights.keys():  
##    Nexp += TristanWeights[key]*my_time_exp[key]
## print  Nexp
## f = file("Nexp_new_formula", "w")
## import cPickle
## cPickle.dump(Nexp, f)
## f.close()
...
#f3.close
## results:
## Abs(A_pe)**2 7.49306674434
## Abs(A_S)**2 7.8297527491
## im(A_pe*conjugate(A_0)) -0.210262999226
## im(A_pe*conjugate(A_S)) 0.679561371969
## im(A_pa*conjugate(A_pe)) -0.278820292866
## Abs(A_pa)**2 8.47749100138
## re(A_pa*conjugate(A_S)) -0.461936273038
## re(A_pa*conjugate(A_0)) 1.74572911146
## re(A_S*conjugate(A_0)) -0.895600865393
## Abs(A_0)**2 7.10141633906
