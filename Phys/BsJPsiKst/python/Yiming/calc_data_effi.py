...
import cPickle
f = file("Nexp_new_formula")
#f = file("changeTweight_new_Nexp")  #this is using the result of change_Tweight_examine.py to examine if this program is right by set Tweight[00]=1,[11]=1,[01]=[10]=0
