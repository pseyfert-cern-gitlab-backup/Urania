...
#     BREAK
    ...
    #tmcd2 = fmcd.Get("T/T")
    fmcdx = TFile("/afs/cern.ch/user/d/diegoms/vol5/BdJpsiKstTotMC11_v2.root")
    tmcd2x = fmcdx.Get("T/T")
    fmcd = TFile("/afs/cern.ch/user/d/diegoms/vol5/BdJpsiKstTotMC11_v2_pionp.root")
    tmcd2 = fmcd.Get("T")
