...
Year        = str(sys.argv[3]) # string to tag the year: '2011' or '2012'
...
filename = "%s/MC/JpsiKst/"%NTUPLE_PATH
filename11 = filename
filename12 = filename
if Type=="Bd":
    TRUEID = 511
    filename11+="Bd2JpsiKst/2011-3500GeV-MagUpAndDown-Nu2-Pythia8_Sim08b_Digi13_Trig0x40760037_Reco14a_s20r1_dv33r4_WideLine_BDTG_wCosines.root"
    filename12+="Bd2JpsiKst/2012-4000GeV-MagUpAndDown-Nu2.5-Pythia8_Sim08a_Digi13_Trig0x409f0045_Reco14a_s20_dv33r4_WideLine_BDTG_wCosines.root"

if Type=="Bs":
    TRUEID = 531
    filename11+="Bs2JpsiKst/2011-3500GeV-MagUpAndDown-Nu2-Pythia8_Sim08c_Digi13_Trig0x40760037_Reco14a_s20r1_dv33r4_WideLine_BDTG_Loose_wCosines.root"
    filename12+="Bs2JpsiKst/2012-4000GeV-MagUpAndDown-Nu2.5-Pythia8_Sim08a_Digi13_Trig0x409f0045_Reco14a_s20_dv33r4_WideLine_BDTG_Loose_wCosines.root"
...
print"Number of events after selection for 2011:",nEntries11
...
print"Number of events after selection for 2012:",nEntries12
