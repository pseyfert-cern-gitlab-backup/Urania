from ROOT import *
from PDF_2013_Asym_singleHypathia import *
from Urania import *
...
massB11 = SignalMass_OneHypathia("signal11")
massB11.ipa_lambda.setVal(ipa_params.Bin["l"])
massB11.ipa_lambda.setConstant(1)#ipa_params.Bin[ibin]["l"])
massB11.a1_cb.setVal(ipa_params.Bin["a"])
massB11.a1_cb.setConstant(1)
massB11.a2_cb.setVal(ipa_params.Bin["a2"])
massB11.a2_cb.setConstant(1)
massB11.ncb1.setVal(ipa_params.Bin["n"])
massB11.ncb1.setConstant(1)
massB11.ncb2.setVal(ipa_params.Bin["n2"])
massB11.ncb2.setConstant(1)

massB12 = SignalMass_OneHypathia("signal12")
massB12.ipa_lambda.setVal(ipa_params.Bin["l"])
massB12.ipa_lambda.setConstant(1)#ipa_params.Bin[ibin]["l"])
massB12.a1_cb.setVal(ipa_params.Bin["a"])
massB12.a1_cb.setConstant(1)
massB12.a2_cb.setVal(ipa_params.Bin["a2"])
massB12.a2_cb.setConstant(1)
massB12.ncb1.setVal(ipa_params.Bin["n"])
massB12.ncb1.setConstant(1)
massB12.ncb2.setVal(ipa_params.Bin["n2"])
massB12.ncb2.setConstant(1)

#OUTPUT = "YIELDS"
#OUTPUT = "RATIO"

#MagUpAndDown3500GeVReco14s20r1dv33r4_1019pb_StrippingBetaSBs2JpsiPhiDetachedLine_2011_selected_BsJpsiphi.root
#MagUpAndDown4000GeVReco14s20r0p1dv33r4_2062pb_StrippingBetaSBs2JpsiPhiDetachedLine_2012_selected_BsJpsiphi.root

f11 = TFile("../MagUpAndDown3500GeVReco14s20r1dv33r4_1019pb_StrippingBetaSBs2JpsiPhiDetachedLine_2011_selected_BsJpsiphi.root")
#t11b = f11.Get("DecayTree")
t11 = f11.Get("DecayTree")
f12 = TFile("../MagUpAndDown4000GeVReco14s20r0p1dv33r4_2062pb_StrippingBetaSBs2JpsiPhiDetachedLine_2012_selected_BsJpsiphi.root")
#t12b = f12.Get("DecayTree")
t12 = f12.Get("DecayTree")

#f2 = TFile("merda_de_cabalo_eraseMe.root", "recreate")
...
ns = RooRealVar("nBs","nBs",0.,Nmax) #Bs2JpsiPhi
...
model11 = RooAddPdf("model11","model11" ,RooArgList(massB11.sigBs,bkgmodel11.massbkg),RooArgList(ns11,nbkg11))
model12 = RooAddPdf("model12","model12" ,RooArgList(massB12.sigBs,bkgmodel12.massbkg),RooArgList(ns12,nbkg12))
...
data = RooDataSet("data","data", RooArgSet(Mass), RooFit.Index(cat), RooFit. Import("2011", dataset11), RooFit.Import("2012", dataset12))
