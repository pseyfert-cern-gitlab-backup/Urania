...
gROOT.ProcessLine(".L /lhcb/users/akar/cmtuser/Urania_v2r4/Phys/Urania/src/RooAmorosoPdf.cxx+")
...
ipa_zeta = RooRealVar("ipatia_zeta" ,"ipatia_zeta", 1e-04)
...
class SignalMassIpatia:
    def __init__(self, samplename, year, ibin):
        self.meanBd = RooRealVar("meanBd"+samplename,"meanBd"+samplename, massParams["Bd"][year][ibin]["ipa_m"], 5276,5300)
        self.sigmaBd = RooRealVar("sigmaBd"+samplename,"sigmaBd"+samplename, massParams["Bd"][year][ibin]["ipa_s"], 0. ,30.)
        self.ipa_lambdaBd = RooRealVar("ipatia_lambdaBd" , "ipatia_lambdaBd" + samplename, massParams["Bd"][year][ibin]["l"], -10, -.1)
        self.a1_cbBd = RooRealVar("a1_cbBd"+samplename,"a1_cbBd"+samplename,massParams["Bd"][year][ibin]["a"],1,200)
        self.a2_cbBd = RooRealVar("a2_cbBd"+samplename,"a2_cbBd"+samplename,massParams["Bd"][year][ibin]["a2"],1,200)
        self.ncb1Bd = RooRealVar("ncb1Bd"+samplename,"ncb1Bd"+samplename,massParams["Bd"][year][ibin]["n"],0.8,60)
        self.ncb2Bd = RooRealVar("ncb2Bd"+samplename,"ncb2Bd"+samplename,massParams["Bd"][year][ibin]["n2"],0.8,60)
       
        self.meanBs = RooFormulaVar("meanBs"+samplename,"meanBs"+samplename, "meanBd"+samplename+" + delta_m" ,RooArgList(self.meanBd,delta_m) )
        self.sigmaBs = RooRealVar("sigmaBs"+samplename,"sigmaBs"+samplename, massParams["Bs"][year][ibin]["ipa_s"], 0. ,30.)
        self.ipa_lambdaBs = RooRealVar("ipatia_lambdaBs" , "ipatia_lambdaBs" + samplename, massParams["Bs"][year][ibin]["l"], -10, -.1)
        self.a1_cbBs = RooRealVar("a1_cbBs"+samplename,"a1_cbBs"+samplename,massParams["Bs"][year][ibin]["a"],1,200)
        self.a2_cbBs = RooRealVar("a2_cbBs"+samplename,"a2_cbBs"+samplename,massParams["Bs"][year][ibin]["a2"],1,200)
        self.ncb1Bs = RooRealVar("ncb1Bs"+samplename,"ncb1Bs"+samplename,massParams["Bs"][year][ibin]["n"],0.8,60)
        self.ncb2Bs = RooRealVar("ncb2Bs"+samplename,"ncb2Bs"+samplename,massParams["Bs"][year][ibin]["n2"],0.8,60)
