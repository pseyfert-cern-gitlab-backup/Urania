from ROOT import *
from math import *
from parameters import BlindingString
import os
...
gROOT.ProcessLine(".x ./TristanJpsiKpi_J1.cxx++")
...
cKname, cLname, phName = "helcosthetaK", "helcosthetaL", "helphi" ## other
...
#cor_sWeights_Bs =  Ro"oRealVar("cor_sWeights_Bs","cor_sWeights_Bs",-3.,3.)
myweight = RooRealVar("NSig_sw","NSig_sw",-3.,3.)
...
Aprod_s = RooRealVar("A_prod_s","A_prod_s", 0)#-0.00132)#wk 
Aprod_d = RooRealVar("A_prod_d","A_prod_d",0)# 0.00030)#wk 

A_D = RooRealVar("A_D","A_D", 0)#-0.01185)# ok  
BLIND = 0
...
class AngularPDFMOD:
    ...
    def OwnAcc(self):
        ...
        self.w_pe2 = RooRealVar("w_pepe" + name, "w_pepe", 1.17884)
        self.w_S2 = RooRealVar("w_SS" + name, "w_SS", 1.02904)
        self.w_0pe = RooRealVar("w_0pe" + name, "w_0pe",-0.000835991)
        self.w_Spe = RooRealVar("w_Spe" + name, "w_Spe", 0.001723)
        self.w_pape = RooRealVar("w_pape" + name, "w_pape",0.000156868)
        self.w_pa2 = RooRealVar("w_papa" + name, "w_papa", 1.17272)
        self.w_Spa  = RooRealVar("w_Spa" + name, "w_Spa", -0.0113217)
        self.w_0pa  = RooRealVar("w_0pa" + name, "w_0pa", -0.0111995)
        self.w_S0  = RooRealVar("w_S0" + name, "w_S0", -0.229217)
        self.w_00 = RooRealVar("w_00" + name, "w_00", 0.898537)
