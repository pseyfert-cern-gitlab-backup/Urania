...
ClassImp(TransF10) 
 ...
 TransF10::TransF10(const TransF10& other, const char* name) :  
 ...
 Double_t TransF10::evaluate() const 
 { 
   ...
   return 4.*sqrt(3.)/3.*CPsi*(1-STheta2*CPhi2) ; 
 } 



 Int_t TransF10::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const  
 { 
 ...
 Double_t TransF10::analyticalIntegral(Int_t code, const char* range) const  
 { 
   ...
   if (code>0 && code<5) { // integrate
     ...
     p0 = pow(hi,2)-pow(lo,2); p0/=2;                   // integral of cos^2 psi
   ...
   //This is the 3D integral over cpsi,ctheta and phi of the function F1 = 4.*sqrt(3.)/3.*CPsi*(1-STheta2*CPhi2) 
   return 4.*sqrt(3.)/3.*p0*(it*ip-ist2*icp2);
