...
TransF1::TransF1(const TransF1& other, const char* name) :  
 ...
 Double_t TransF1::evaluate() const 
 { 
   ...
   return 2*CPsi2*(1-STheta2*CPhi2) ; 
 } 



 Int_t TransF1::getAnalyticalIntegral(RooArgSet& allVars, RooArgSet& analVars, const char* /*rangeName*/) const  
 { 
 ...
 Double_t TransF1::analyticalIntegral(Int_t code, const char* range) const  
 { 
...
//    cout << "X is: "<< X << endl;
   ...
   if (code>0 && code<5) { // integrate
     ...
     p0 = pow(hi,3)-pow(lo,3); p0/=3;                   // integral of cos^2 psi
   ...
   //This is the 3D integral over cpsi,ctheta and phi of the function F1 = 2*cpsi*cpsi*(1-(1-ctheta*ctheta)*cphi*cphi). 
