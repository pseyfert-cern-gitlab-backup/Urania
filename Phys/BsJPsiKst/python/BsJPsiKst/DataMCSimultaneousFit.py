...
cv1.SaveAs("anglesBd_amp_ratio_sim_pol.root")
cv2.SaveAs("anglesBs_amp_ratio_sim_pol.root")
cv3.SaveAs("mass_amp_ratio_sim_pol.root")
cv4.SaveAs("MC_Bd_sim_pol.root")
cv5.SaveAs("MC_Bs_sim_pol.root")
