...
class AngularPDF:
    def __init__(self):
        ...
        self.c1_psi = RooRealVar("c1_psi","c1_psi",-5,1)#0.5,3.)
        self.c2_psi = RooRealVar("c2_psi","c2_psi",-5.,1)#-3.,-1.)
        self.c3_psi = RooRealVar("c3_psi","c3_psi",-5.,1.)#0.5,3.)#-1.,1.)
        self.c4_psi = RooRealVar("c4_psi","c4_psi",-5.,1.)#-3.,-1.)

        
        self.y = RooRealVar("y","y",1)#.,3.)
...
#     cuts += "&& Bmass_JC>5150 && Bmass_JC<5800"
    ...
    fit.c1_psi.setVal(-4.80166e-01)
    fit.c2_psi.setVal(-6.58519e-01)
    fit.c3_psi.setVal(-3.33605e-01)
    fit.c4_psi.setVal(0.)
    fit.y.setVal(8.92594e-10)
