...
from PDF_2013_Asym_Julian import *
#from OurSites import NTUPLE_PATH

if (not DWAVE): from parameters import KpiBins4 as KpiBins, myCsp4 as myCsp, translateWeights
else: from parameters import KpiBins4 as KpiBins, myCsp23 as myCsp, myCsd23 as myCsd, myCpd23 as myCpd, translateWeightsSPD as translateWeights
...
#AngBd_2011p.modParamAsym("CSP",1.,0.3,0.,kFALSE)
#if (DWAVE != 0):
#    AngBd_2011p.modParamAsym("CSD",1.,0.3,0.,kFALSE)
#    AngBd_2011p.modParamAsym("CPD",1.,0.3,0.,kFALSE)
...
#else:
#    AngBd_2011p.modParam("CSP",.75,.25,kFALSE)
#    if (DWAVE != 0):
#	AngBd_2011p.modParam("CSD",.75,.25,kFALSE)
#	AngBd_2011p.modParam("CPD",.75,.25,kFALSE)
...
#else:
#    AngBs_2011p.modParam("CSP",.75,.25,kFALSE)
#    if (DWAVE != 0):
#	AngBs_2011p.modParam("CSD",.75,.25,kFALSE)
#	AngBs_2011p.modParam("CPD",.75,.25,kFALSE)
...
def runFit(minos=0, offset = 0, numCPU = 1, dataset = "all"):
     ...
     #AngBs_2011p.ACPS.setConstant(noCP)    
     #AngBs_2011p.ACPL.setConstant(noCP)
     #AngBs_2011p.ACPpa.setConstant(noCP)
     #AngBs_2011p.ACPpe.setConstant(noCP)
     #if (DWAVE != 0):
     #     AngBs_2011p.ACP2L.setConstant(noCP)
     #     AngBs_2011p.ACP2pa.setConstant(noCP)
     #     AngBs_2011p.ACP2pe.setConstant(noCP)
     ...
     for i in range(len(KpiBins)-1): 
          ...
          if (DWAVE != 0):
	       ...
	       #if(len(sys.argv) == 1):
                    #argList.setRealValue("fD"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1]),myfD[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("f2L"+WEIGHT_CAT,myf2L[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("f2pa"+WEIGHT_CAT,myf2pa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("d20"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1]),myd20[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("d2pa"+WEIGHT_CAT,myd2pa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("d2pe"+WEIGHT_CAT,myd2pe[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
		    #argList["fD"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].setRange(argList["fD"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()-f_variation,argList["fD"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()+f_variation)
		    #argList["f2L"+WEIGHT_CAT].setRange(argList["f2L"+WEIGHT_CAT].getVal()-f_variation,argList["f2L"+WEIGHT_CAT].getVal()+f_variation)
		    #argList["f2pa"+WEIGHT_CAT].setRange(argList["f2pa"+WEIGHT_CAT].getVal()-f_variation,argList["f2pa"+WEIGHT_CAT].getVal()+f_variation)
		    #argList["d20"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].setRange(argList["d20"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()-phase_variation,argList["d20"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()+phase_variation)
		    #argList["d2pa"+WEIGHT_CAT].setRange(argList["d2pa"+WEIGHT_CAT].getVal()-phase_variation,argList["d2pa"+WEIGHT_CAT].getVal()+phase_variation)
		    #argList["d2pe"+WEIGHT_CAT].setRange(argList["d2pe"+WEIGHT_CAT].getVal()-phase_variation,argList["d2pe"+WEIGHT_CAT].getVal()+phase_variation)
	       #else:
                    #argList.setRealValue("fD"+WEIGHT_CAT,myfD[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("f2L"+WEIGHT_CAT,myf2L[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("f2pa"+WEIGHT_CAT,myf2pa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("d20"+WEIGHT_CAT,myd20[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("d2pa"+WEIGHT_CAT,myd2pa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
                    #argList.setRealValue("d2pe"+WEIGHT_CAT,myd2pe[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
		    #argList["fD"+WEIGHT_CAT].setRange(argList["fD"+WEIGHT_CAT].getVal()-f_variation,argList["fD"+WEIGHT_CAT].getVal()+f_variation)
		    #argList["f2L"+WEIGHT_CAT].setRange(argList["f2L"+WEIGHT_CAT].getVal()-f_variation,argList["f2L"+WEIGHT_CAT].getVal()+f_variation)
		    #argList["f2pa"+WEIGHT_CAT].setRange(argList["f2pa"+WEIGHT_CAT].getVal()-f_variation,argList["f2pa"+WEIGHT_CAT].getVal()+f_variation)
		    #argList["d20"+WEIGHT_CAT].setRange(argList["d20"+WEIGHT_CAT].getVal()-phase_variation,argList["d20"+WEIGHT_CAT].getVal()+phase_variation)
		    #argList["d2pa"+WEIGHT_CAT].setRange(argList["d2pa"+WEIGHT_CAT].getVal()-phase_variation,argList["d2pa"+WEIGHT_CAT].getVal()+phase_variation)
		    #argList["d2pe"+WEIGHT_CAT].setRange(argList["d2pe"+WEIGHT_CAT].getVal()-phase_variation,argList["d2pe"+WEIGHT_CAT].getVal()+phase_variation)
	  ...
	  #if(len(sys.argv) == 1):
               #argList.setRealValue("As2"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1]),myAs2[str(KpiBins[i])+"_"+str(KpiBins[i+1])])      
               #argList.setRealValue("fL"+WEIGHT_CAT,myfL[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("fpa"+WEIGHT_CAT,myfpa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("ds"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1]),myds[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("dpa"+WEIGHT_CAT,mydpa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("dpe"+WEIGHT_CAT,mydpe[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
	       #argList["As2"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].setRange(argList["As2"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()-f_variation,argList["As2"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()+f_variation)
	       #argList["fL"+WEIGHT_CAT].setRange(argList["fL"+WEIGHT_CAT].getVal()-f_variation,argList["fL"+WEIGHT_CAT].getVal()+f_variation)
	       #argList["fpa"+WEIGHT_CAT].setRange(argList["fpa"+WEIGHT_CAT].getVal()-f_variation,argList["fpa"+WEIGHT_CAT].getVal()+f_variation)
	       #argList["ds"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].setRange(argList["ds"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()-phase_variation,argList["ds"+WEIGHT_CAT+"_" + str(KpiBins[i]) +  "_" + str(KpiBins[i+1])].getVal()+phase_variation)
	       #argList["dpa"+WEIGHT_CAT].setRange(argList["dpa"+WEIGHT_CAT].getVal()-phase_variation,argList["dpa"+WEIGHT_CAT].getVal()+phase_variation)
	       #argList["dpe"+WEIGHT_CAT].setRange(argList["dpe"+WEIGHT_CAT].getVal()-phase_variation,argList["dpe"+WEIGHT_CAT].getVal()+phase_variation)
	  #else:
               #argList.setRealValue("As2"+WEIGHT_CAT,myAs2[str(KpiBins[i])+"_"+str(KpiBins[i+1])])      
               #argList.setRealValue("fL"+WEIGHT_CAT,myfL[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("fpa"+WEIGHT_CAT,myfpa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("ds"+WEIGHT_CAT,myds[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("dpa"+WEIGHT_CAT,mydpa[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
               #argList.setRealValue("dpe"+WEIGHT_CAT,mydpe[str(KpiBins[i])+"_"+str(KpiBins[i+1])])
	       #argList["As2"+WEIGHT_CAT].setRange(argList["As2"+WEIGHT_CAT].getVal()-f_variation,argList["As2"+WEIGHT_CAT].getVal()+f_variation)
	       #argList["fL"+WEIGHT_CAT].setRange(argList["fL"+WEIGHT_CAT].getVal()-f_variation,argList["fL"+WEIGHT_CAT].getVal()+f_variation)
	       #argList["fpa"+WEIGHT_CAT].setRange(argList["fpa"+WEIGHT_CAT].getVal()-f_variation,argList["fpa"+WEIGHT_CAT].getVal()+f_variation)
	       #argList["ds"+WEIGHT_CAT].setRange(argList["ds"+WEIGHT_CAT].getVal()-phase_variation,argList["ds"+WEIGHT_CAT].getVal()+phase_variation)
	       #argList["dpa"+WEIGHT_CAT].setRange(argList["dpa"+WEIGHT_CAT].getVal()-phase_variation,argList["dpa"+WEIGHT_CAT].getVal()+phase_variation)
	       #argList["dpe"+WEIGHT_CAT].setRange(argList["dpe"+WEIGHT_CAT].getVal()-phase_variation,argList["dpe"+WEIGHT_CAT].getVal()+phase_variation)
...
if YEAR == 1112 or YEAR == 1211: my_res = runFit(numCPU = 3)
