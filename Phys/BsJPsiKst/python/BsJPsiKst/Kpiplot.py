...
beta = RooRealVar("beta","beta",0)#3.,0,20)
...
m0D = RooRealVar("m0D","m0D",1432.4,(1-1e-02)*1432.4,1433)
gamma0D = RooRealVar("gamma0D","gamma0D",109.)#,100.,120.)
#dwave = SingleBW("dwave","dwave",P1mass, m0D, gamma0D,L2,mb,mv)
kappaD = RooRealVar("kappaD","kappaD",0.)#,0.1,3)
phaseD = RooRealVar("phaseD","phaseD",0.)#15)#,0,2*pi)

dwave = Kmatrix_nonRes("dwave","dwave",P1mass, m0D, gamma0D,kappaD,phaseD,mb,mv,L2)
...
m0F = RooRealVar("m0F","m0F",1776.,(1-1e-02)*1776,1783)
gamma0F= RooRealVar("gamma0F","gamma0F",159.,130.,180.)
kappaF = RooRealVar("kappaF","kappaF",0.)#,0.1,3)
fwave = Kmatrix_nonRes("fwave","fwave",P1mass, m0F, gamma0F,kappaF,L0,mb,mv,L3)

### H wave

m0H = RooRealVar("m0H","m0H",2045.,(1-1e-02)*2045,2052)
gamma0H= RooRealVar("gamma0H","gamma0H",198)#.,160.,24.)
kappaH = RooRealVar("kappaH","kappaH",0.)#,0.1,3)
hwave = Kmatrix_nonRes("hwave","hwave",P1mass, m0H, gamma0H,kappaH,L0,mb,mv,L4)
...
Lwaves = RooAddPdf("Lwave","Lwave",swave,dwave,f_swave)
Gwaves = RooAddPdf("Gwave","Gwave",fwave,hwave,f_fwave)

Zwaves = RooAddPdf("Zwave","Zwave",Lwaves,Gwaves,f_Lwave)
