...
c1_psi = RooRealVar("c1_psi","c1_psi", -7.31765e-01 )#,-0.488-s_a*0.014,-0.488+s_a*.014)
c2_psi = RooRealVar("c2_psi","c2_psi",-6.71152e-01)#,-0.642-s_a*0.022,-0.642+s_a*0.022)
c3_psi = RooRealVar("c3_psi","c3_psi",-4.17060e-02 )#,-0.331-3*s_a,0.331+3*s_a)
c4_psi = RooRealVar("c4_psi","c4_psi",2.38053e-01)#,0.092-s_a*0.023,0.092+s_a*0.023)

        
y = RooRealVar("y","y", 4.42624e-03)#,0.,s_a*1.6e-04)
...
c2_theta = RooRealVar("c2_theta","c2_theta", -1.66695e-01 )#,-0.1783-s_a*0.0075,-0.1783+s_a*0.0075)

c1_phi = RooRealVar("c1_phi","c1_phi",8.27164e-02)#,0.0784-s_a*0.0039,0.0784+s_a*0.0039)
c2_phi = RooRealVar("c2_phi","c2_phi",2.00600e+00 )#,1.958-s_a*0.029,1.958+s_a*0.029)
c3_phi = RooRealVar("c3_phi","c3_phi",-3.56605e-04)#,.25-s_a*0.048,.25+s_a*0.048)
...
c1_psi_Bs =  RooRealVar("c1_psi_Bs","c1_psi_Bs", -7.53006e-01 )#,-0.488-s_a*0.014,-0.488+s_a`*.014)
c2_psi_Bs =  RooRealVar("c2_psi_Bs","c2_psi_Bs",-5.55647e-01)#,-0.642-s_a*0.022,-0.642+s_a*0.022)
c3_psi_Bs =  RooRealVar("c3_psi_Bs","c3_psi_Bs", -5.54030e-02 )#,-0.331-3*s_a,0.331+3*s_a)
c4_psi_Bs =  RooRealVar("c4_psi_Bs","c4_psi_Bs", 1.00271e-01 )#,0.092-s_a*0.023,0.092+s_a*0.023)

        
y_Bs =  RooRealVar("y_Bs","y_Bs", 1.62915e-08 )#,0.,s_a*1.6e-04)
...
c2_theta_Bs =  RooRealVar("c2_theta_Bs","c2_theta_Bs", -1.66695e-01 )#,-0.1783-s_a*0.0075,-0.1783+s_a*0.0075)

c1_phi_Bs =  RooRealVar("c1_phi_Bs","c1_phi_Bs", 6.65170e-02)#,0.0784-s_a*0.0039,0.0784+s_a*0.0039)
c2_phi_Bs =  RooRealVar("c2_phi_Bs","c2_phi_Bs",2.09638e+00  )#,1.958-s_a*0.029,1.958+s_a*0.029)
c3_phi_Bs =  RooRealVar("c3_phi_Bs","c3_phi_Bs",1.41482e-01)#,.25-s_a*0.048,.25+s_a*0.048)
...
a1_cb = RooRealVar("a1_cb","a1_cb",2.8)#, 0.5,3.5)
a2_cb = RooRealVar("a2_cb","a2_cb",2.3+0.43)#, 0.5,3.5)
