...
#NTUPLE_PATH = "~/w7folder/NTuples/Bs_Jpsi_Kst_2013/walaa/"
...
timeZero = time.time()
#RooDataSet::all Data[sample,helcosthetaK,helcosthetaL,B0_Phi,binCat,weight:cor_sWeights_Bd] = 217127 entries (0 weighted)  ### (0 0)
ACC_FREE = 0
FIX_Bd = ACC_FREE
SAME_ACC = 1
YEAR = 1112# choose 2011, 2012 or 1211->2011+2012 data  
...
#NTUPLE_PATH = "~/NTuplesFast/Lb_testing/"#Carlos_NS_sw/"
SampleSizes = {}
