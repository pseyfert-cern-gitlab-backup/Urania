...
c1_psi = RooRealVar("c1_psi","c1_psi",-0.488)#-5.02248e-01)#-0.488)#,-0.488-s_a*0.014,-0.488+s_a*.014)
c2_psi = RooRealVar("c2_psi","c2_psi",-0.642)#-5.77800e-01)#-0.642)#,-0.642-s_a*0.022,-0.642+s_a*0.022)
c3_psi = RooRealVar("c3_psi","c3_psi",-0.331)#-3.93354e-01)#-0.331)#,-0.331-3*s_a,0.331+3*s_a)
c4_psi = RooRealVar("c4_psi","c4_psi",0.092)#4.24607e-02)#0.092)#,0.092-s_a*0.023,0.092+s_a*0.023)
...
c2_theta = RooRealVar("c2_theta","c2_theta",-0.1783)#-1.77624e-01)#-0.1783)#,-0.1783-s_a*0.0075,-0.1783+s_a*0.0075)

c1_phi = RooRealVar("c1_phi","c1_phi",0.0784)#7.31919e-02)#0.0784)#,0.0784-s_a*0.0039,0.0784+s_a*0.0039)
c2_phi = RooRealVar("c2_phi","c2_phi",1.958)#2.10633e+00)#1.958)#,1.958-s_a*0.029,1.958+s_a*0.029)
c3_phi = RooRealVar("c3_phi","c3_phi",.25)#2.24757e-01)#.25)#,.25-s_a*0.048,.25+s_a*0.048)
...
foutput=TFile("results/output_amplit_ratio_MC10_bgk_sin.root","recreate")
