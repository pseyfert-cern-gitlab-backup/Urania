...
from mass_params import paramsDATA as massParams
import os
...
BLIND = 0 # : 0 for a NOT BLINDED analysis / 1 for a BLINDED analysis
...
gROOT.ProcessLine(".L RooIpatia2_cxx.so")
#gROOT.ProcessLine(".L RooIpatia2.cxx+")
gROOT.ProcessLine(".x RooAmorosoPdf.cxx+")
