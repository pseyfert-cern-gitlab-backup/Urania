## Carlos Vazquez Sierra, 20 May 2014
...
rect_cuts_loose += " && B0_MM > 5150. && B0_MM < 5650."
cuts_loose = rect_cuts_loose + " && piminus_ProbNNk<0.01 && Kplus_ProbNNk>0.21"
cuts_loose += " && Kplus_ProbNNk/Kplus_ProbNNp>0.99 && piminus_ProbNNpi/piminus_ProbNNp>21.9"
cuts_loose_2011 = cuts_loose + " && BDTG>0.2"
cuts_loose_2012 = cuts_loose + " && BDTG>0.12"
cuts12noKpi = cuts_loose_2012.replace("abs(Kst_892_0_MM-896) < 70.","(1>0)")
cuts11noKpi = cuts_loose_2011.replace("abs(Kst_892_0_MM-896) < 70.","(1>0)")
cuts12noKpi_nopPID = cuts12noKpi.replace(" && Kplus_ProbNNk/Kplus_ProbNNp>0.99 && piminus_ProbNNpi/piminus_ProbNNp>21.9","")
cuts11noKpi_nopPID = cuts11noKpi.replace(" && Kplus_ProbNNk/Kplus_ProbNNp>0.99 && piminus_ProbNNpi/piminus_ProbNNp>21.9","")
...
cuts_tightnote_2012 = cuts_tightnote + " && BDTG>0.12"
