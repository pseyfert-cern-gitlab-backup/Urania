...
class AngularPDF:
    def __init__(self):
        ...
        self.c4_psi = RooRealVar("c4_psi","c4_psi",-0.2,0.7)#-3.,-1.)
...
#     cuts += "&& Bmass_JC>5150 && Bmass_JC<5800"
    ...
    def set_gen_acc(fit):
        fit.c1_psi.setVal(-7.32e-01)
        fit.c2_psi.setVal(-6.71e-01)
        fit.c3_psi.setVal(-.42e-01)
        fit.c4_psi.setVal(0.238)
        fit.y.setVal(4.4e-03)
        fit.c1_theta.setVal(0.)
        fit.c2_theta.setVal(-.167)
        fit.c1_phi.setVal(0.083)
        fit.c2_phi.setVal(2.01)
        fit.c3_phi.setVal(0)
    ...
    def set_fit_acc(fit):
        fit.c1_psi.setVal(-5.22e-01)
        fit.c2_psi.setVal(-7.23e-01)
        fit.c3_psi.setVal(-1.9e-01)
        fit.c4_psi.setVal(0.208)
        fit.y.setVal(0.)
        fit.c1_theta.setVal(0.)
        fit.c2_theta.setVal(-0.178)
        fit.c1_phi.setVal(0.09)
        fit.c2_phi.setVal(2.019)
        fit.c3_phi.setVal(0.09)
