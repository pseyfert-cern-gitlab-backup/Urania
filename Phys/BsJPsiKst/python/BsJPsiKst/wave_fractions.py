...
spins = [0,1]
charge = 1
massbin = str(KpiBins[Bin]) + "_" + str(KpiBins[Bin + 1]) 
if charge == 1: samplename = "2011n_"
else: samplename = "2011p_"

W_dat = WeightsBd[samplename + massbin]
...
#CSP70 = 1.
W_dat["0S"] = W_dat["0S"] * CSP
W_dat["S0"] = W_dat["0S"]
W_dat["0pa"] = W_dat["0pa"] * CSP
W_dat["pa0"] = W_dat["0pa"]
W_dat["0pe"] = W_dat["0pe"] * CSP
W_dat["pe0"] = W_dat["0pe"]

W_MC["0S"] = W_MC["0S"] * CSP
W_MC["S0"] = W_MC["0S"] 
W_MC["0pa"] = W_MC["0pa"] * CSP
W_MC["pa0"] = W_MC["0pa"]
W_MC["0pe"] = W_MC["0pe"] * CSP
W_MC["pe0"] = W_MC["0pe"]
...
dpa = Results["dpa"]
dpe = Results["dpe"]
Fs = Results["Fs" + str(Bin+1)]
dS = Results["ds" + str(Bin+1)]
...
print "Pwave", swc* Yields[massbin]
print "Swave", TristanIntegral_d_dat.subs( [(T["0_0"],sqrt(Fs)),(T["1_pa"], 0),(T["1_pe"],0),(T["1_0"],0),(P["0_0"],dS),(P["1_pa"],0),(P["1_pe"],0)]) * 1/swc_den*Yields[massbin]
