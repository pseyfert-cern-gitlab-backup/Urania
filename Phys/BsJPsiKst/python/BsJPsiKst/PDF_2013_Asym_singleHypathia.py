...
NO_CP = 1 # : 0 to INCLUDE CP ASYMMETRIES / 1 to NOT INCLUDE CP ASYMMETRIES
if NO_CP : BLIND =- 0
################################################################################################
...
mvar = "B_s0_MM"# "B_s0_LOKI_MASS_JpsiConstr"
...
cKname, cLname, phName = "helcosthetaK", "helcosthetaL", "B_s0_Phi" ## other
