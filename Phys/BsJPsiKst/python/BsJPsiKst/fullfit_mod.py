...
class AngularPDFMOD:
    def __init__(self, neim = "Bd"):
        ...
        self.dpa = RooRealVar("dpa"+neim,"dpa" + neim, -pi,pi)
        self.ds = RooRealVar("ds"+neim,"ds"+neim,-pi,pi)
...
cv1.SaveAs("Bs_fit_FL_MC11MC11.root")
cv2.SaveAs("Bs_fit_FL_MC11MC11.root")
cv3.SaveAs("Mass_fit_FL_MC11MC11.root")
