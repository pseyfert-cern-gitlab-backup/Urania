print "Create job"
job=Job(application=DaVinci(version='v33r0p1') ,  name ='upDimuon' )
...
job.inputdata =  DaVinci().readInputData('/lhcb/users/oleroy/public/walaa/code/20121010/LHCbCollision12Beam4000GeV-VeloClosed-MagUpRealDataReco14Stripping2090000000DIMUONDST.py')
