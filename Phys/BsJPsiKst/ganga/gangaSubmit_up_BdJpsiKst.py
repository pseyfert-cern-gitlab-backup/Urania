print "Create job"
job=Job(application=DaVinci(version='v33r0p1') ,  name ='MCBdJpsiKst_up' )
...
job.inputdata =  DaVinci().readInputData('/lhcb/users/oleroy/public/walaa/code/20121201-MCtuple/MCMC11a11144001Beam3500GeV-2011-MagUp-Nu2-EmNoCutsSim05Trig0x40760037FlaggedReco12aStripping17NoPrescalingFlaggedSTREAMSDST.py')
