print "Create job"
job=Job(application=DaVinci(version='v33r0p1') ,  name ='downDimuon2011' )
...
job.inputdata =  DaVinci().readInputData('/lhcb/users/oleroy/public/walaa/code/20121010/LHCbCollision11Beam3500GeV-VeloClosed-MagDownRealDataReco12Stripping17b90000000DIMUONDST.py')
