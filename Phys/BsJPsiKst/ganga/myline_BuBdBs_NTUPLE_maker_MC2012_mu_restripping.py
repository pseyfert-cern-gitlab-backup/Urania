...
### Including the NoPID stripping line:
from StrippingSelections.StrippingBs2JpsiKstNoPID import Bs2JpsiKstNoPIDConf
from StrippingSelections.StrippingBs2JpsiKstNoPID import default_config

B2JpsiKstNoPIDBuilder = Bs2JpsiKstNoPIDConf(name="B2JpsiKstNoPIDLines",config=default_config)
myStream.appendLines(B2JpsiKstNoPIDBuilder.lines())
### -----------------------------------
...
BdPartVtxlocation = "Phys/Bs2JpsiKstarWideLineNoPID/Particles" # NoPID stripping line.
##############################################################################################
...
BdTuple.Branches={
    "B0" :  "[^(B_s0 -> (J/psi(1S) -> mu+ mu-) (K*(892)~0 -> K- pi+))]CC",
