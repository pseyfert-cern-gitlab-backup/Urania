...
if is_microDST and stripping == '21':
    ...
    B2HHInput =      "Phys/Bs2MuMusNoMuIDLine/Particles"
    B2MuMuInput =    "Phys/Bs2MuMusWideMassLine/Particles"
    B2JpsiKInput =   "Phys/Bs2MuMusBu2JPsiKLine/Particles"
    B2JpsiKstInput = "Phys/Bs2MuMusBd2JPsiKstLine/Particles"
    B2JpsiPhiInput = "Phys/Bs2MuMusBs2JPsiPhiLine/Particles"
    LTUBBs2MuMuInput = 'Phys/Bs2MuMusLTUBLine/Particles'
    LTUBB2KKInput = 'Phys/Bs2MuMusBs2KKLTUBLine/Particles'
    B2SSInput = 'Phys/Bs2MuMusSSLine/Particles'
...
if stripping == '20':
   DaVinci().MoniSequence += [B2JpsiKTuple, B2JpsiKstTuple, B2JpsiPhiTuple, B2SSTuple]
...
if stripping == '24' and is_microDST:
    DaVinci().MoniSequence += [ B2JpsiKstTuple, B2JpsiPhiTuple,  Bs2MuMuLTUBTuple, Bs2KKLTUBTuple, B2SSTuple]
