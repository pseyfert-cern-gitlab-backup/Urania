...
ntName="_tmp"
TUPLE_FILE = os.environ["HOME"] + "/NTuples/bkpi0x0024002c_smeared" + SIMULATION*("MC" + VERSION) + string+".root"
...
datacards = "$BSMUMUPYROOT/data/MC/stp_MC/0x0024002c/mc_2010_sim3rec3_bkpi_nu1_stripped_0x0024002c_pfn.opts"
