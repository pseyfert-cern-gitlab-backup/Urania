...
opts['SAVE_WORKSPACE'] = askUser('SAVE_WORKSPACE')
...
opts['FIT_WITH_OFFSET'] = askUser('FIT_WITH_OFFSET')
opts['FIT_WITH_CPU_8'] = askUser('FIT_WITH_CPU_8')
opts['FIT_WITH_OPTIMIZE'] = askUser('FIT_WITH_OPTIMIZE')
...
opts['INCLUDE_BD']= 1
opts['FIX_BRd' ]= askUser('FIX_BRd')
opts['FIX_BRs' ]= askUser('FIX_BRs')
...
if opts.get('INCLUDE_BD'):
    ...
    nbd = RooFormulaVar("NBd","NBd", "@0*1e-10*@1/(@2*1.e-7)", RooArgList(BR_d,timeAccCorrBd,alpha_d))
...
sigmaBs ,sigmaBs_m ,sigmaBs_s ,sigmaBs_cons = createConst(TheTable.MassResoBs,TheTable.MassResoErrBs, "sigmaBs")
