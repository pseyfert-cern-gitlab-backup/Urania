...
seqB2JpsiX.Members       = [locationFilter, evtTuple, smear, TupleSeq]
...
DaVinci().CondDBtag = "Sim08-20130503-vc-md100" ## Magnet down (md).
#DaVinci().CondDBtag = "Sim08-20130503-vc-mu100" ## Magnet up (mu).
