...
## Take the detached stream
JpsiList = DataOnDemand(Location = "/Event/AllStreams/Phys/FullDSTDiMuonJpsi2MuMuDetachedLine/Particles")
KaonList = DataOnDemand(Location = "/Event/AllStreams/Phys/StdAllLooseKaons/Particles")
...
BsPartVtxlocationStripping = "/Event/AllStreams/Phys/BetaSBs2JpsiPhiDetachedLine/Particles"
...
## IOHelper().inputFiles(['DSTs/00013431_00000001_1.allstreams.dst'])
