...
#Kaons    =  DataOnDemand("/Event/Dimuon/Phys/StdAllLooseKaons/Particles")
...
if isMC:
        ...
        #Jpsi_loc =  DataOnDemand("/Event/Dimuon/Phys/FullDSTDiMuonJpsi2MuMuDetachedLine/Particles")
...
comb_KK.CombinationCut  = "(AM < 2000.*MeV) & (ADOCACHI2CUT(30, ''))"
...
combB.MotherCut       =   "(in_range(5150,mBs,5550)) & (dtf_prob > 10E-8) & (mKK < 1700) & (BPVLTIME() > 0.2*ps)"
#combB.MotherCut       =   "(in_range(5000,mBs,5800)) & (dtf_prob > 10E-8) & (mKK < 1700) & (BPVLTIME() > 0.2*ps)"
combB.ReFitPVs = True
combB.Preambulo = [
