def getconfig() :
    ...
    configdict["ACP"] = {}
    configdict["ACP"]["Signal"] = { "Gamma"                : [6.5835e-01, 0.0, 2.0],#[1.0/1.519068, 0.0, 2.0],#[1.0 / 1.520, 0.1, 2.0], #Inverse lifetime from HFAG (http://www.slac.stanford.edu/xorg/hfag/osc/summer_2016/)
                                    "DeltaGamma"           : [0.0],
                                    "DeltaM"               : [5.1037e-01, 0.01, 2.0],#[0.510, 0.01, 2.0],#[0.5050, 0.01, 2.0], #Global average from HFAG (http://www.slac.stanford.edu/xorg/hfag/osc/summer_2016/)
    ...
    configdict["ProductionAsymmetry"]["Signal"] = [6.4126e-03, -1.0, 1.0]#[-0.0124, -1.0, 1.0] #from ANA note v2
    configdict["DetectionAsymmetry"]["Signal"] = [4.2975e-03, -1.0, 1.0]#[0.0086, -1.0, 1.0] #from arXiv:1408.0275v2 (OPPOSITE SIGN!!!)
    ...
    configdict["randomiseParams"] = {'Sf'                          : {'min': -0.1,   'max': -0.0001},
                                     'Sfbar'                       : {'min': -0.1, 'max': -0.0001}
                                     }
