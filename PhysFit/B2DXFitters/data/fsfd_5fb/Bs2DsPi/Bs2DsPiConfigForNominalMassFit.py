def getconfig() :
    ...
    configdict["BasicVariables"]["BacPIDK"]       = { "Range" : [-200.0,    0.0     ], "InputName" : "lab1_PIDK"} #-7.0,6.0
    ...
    configdict["WeightingMassTemplates"]= { "PIDBachEff":            { "FileLabel": { "2011":"#PIDK Pion 2011", "2012":"#PIDK Pion 2012"}, 
                                            ...
                                            "PIDChildKaonPionMisID": { "FileLabel": { "2011":"#PIDK Pion 2011", "2012":"#PIDK Pion 2012"}, 
                                                                       "Var":["nTracks","lab3_P"], "HistName":"MyPionMisID_5"}, 
    ...
    configdict["BsSignalShape"]["sigma1"]  = {"Run1": {"KKPi" : 17.4755,   "PhiPi" : 18.3892,   "KstK" : 12.392,    },  "Fixed" : True}
    configdict["BsSignalShape"]["sigma2"]  = {"Run1": {"KKPi" : 11.5424,   "PhiPi" : 11.4315,   "KstK" : 16.0298,   },  "Fixed" : True}
    configdict["BsSignalShape"]["alpha1"]  = {"Run1": {"KKPi" : -2.18147,  "PhiPi" : -2.18571,  "KstK" : -1.83432,  },  "Fixed" : True}
    configdict["BsSignalShape"]["alpha2"]  = {"Run1": {"KKPi" : 2.15494,   "PhiPi" : 2.24804,   "KstK" : 1.25656,   },  "Fixed" : True}
    configdict["BsSignalShape"]["n1"]      = {"Run1": {"KKPi" : 2.53609,   "PhiPi" : 2.36718,   "KstK" : 2.82347,   },  "Fixed" : True}
    configdict["BsSignalShape"]["n2"]      = {"Run1": {"KKPi" : 0.518479,  "PhiPi" : 0.410215,  "KstK" : 5.16839,   },  "Fixed" : True}
    configdict["BsSignalShape"]["frac"]    = {"Run1": {"KKPi":0.5,         "PhiPi":0.5,         "KstK":0.5,         },  "Fixed" : True}
    configdict["BsSignalShape"]["R"]       = {"Run1": {"KKPi":1.00,        "PhiPi":1.0,          "Kstk":1.0,        },  "Fixed" : False}
    ...
    configdict["DsSignalShape"]["sigma1"]  = {"Run1": {"KKPi" : 5.94251,   "PhiPi" : 5.37138,   "KstK" : 5.63019,   },  "Fixed" : True}
    configdict["DsSignalShape"]["sigma2"]  = {"Run1": {"KKPi" : 5.50472,   "PhiPi" : 5.89377,   "KstK" : 6.17574,   },  "Fixed" : True}
    configdict["DsSignalShape"]["alpha1"]  = {"Run1": {"KKPi" : -1.1612,   "PhiPi" : -1.1131,   "KstK" : -1.18225,  },  "Fixed" : True}
    configdict["DsSignalShape"]["alpha2"]  = {"Run1": {"KKPi" : 1.2832,    "PhiPi" : 1.14251,   "KstK" : 1.26344,   },  "Fixed" : True}
    configdict["DsSignalShape"]["n1"]      = {"Run1": {"KKPi" : 16.048,    "PhiPi" : 8.68961,   "KstK" : 11.378,    },  "Fixed" : True}
    configdict["DsSignalShape"]["n2"]      = {"Run1": {"KKPi" : 3.68624,   "PhiPi" : 5.8552,    "KstK" : 5.88566,   },  "Fixed" : True}
    configdict["DsSignalShape"]["frac"]    = {"Run1": {"KKPi":0.50,        "PhiPi":0.50,        "KstK":0.50,        },  "Fixed" : True}
    configdict["DsSignalShape"]["R"]       = {"Run1": {"KKPi":1.00,        "PhiPi":1.00,        "KstK":1.00,        },  "Fixed" : False}

    # combinatorial background                                                                                                                              
    configdict["BsCombinatorialShape"] = {}
    configdict["BsCombinatorialShape"]["type"]  = "DoubleExponential"
    configdict["BsCombinatorialShape"]["cB1"]   = {"Run1": {"KKPi":-3.5211e-02,  "PhiPi":-3.0873e-02,  "KstK":-2.3392e-02 }, "Fixed": False}
    configdict["BsCombinatorialShape"]["cB2"]   = {"Run1": {"KKPi":0.0,          "PhiPi":0.0,          "KstK":0.0},          "Fixed": True }
    configdict["BsCombinatorialShape"]["frac"]  = {"Run1": {"KKPi":4.3067e-01,   "PhiPi":6.5400e-01,   "KstK":3.7409e-01,},  "Fixed": False}
    ...
    configdict["DsCombinatorialShape"]["sigma1"]  = {"Run1": {"KKPi":5.2639e+00,  "PhiPi":5.7789e+00,  "KstK":5.5277e+00},  "Fixed":True}
    configdict["DsCombinatorialShape"]["sigma2"]  = {"Run1": {"KKPi":5.7588e+00,  "PhiPi":5.3142e+00,  "KstK":5.9173e+00},  "Fixed":True}
    configdict["DsCombinatorialShape"]["alpha1"]  = {"Run1": {"KKPi":-1.1429e+00, "PhiPi":-1.0496e+00, "KstK":-1.1662e+00}, "Fixed":True}
    configdict["DsCombinatorialShape"]["alpha2"]  = {"Run1": {"KKPi":1.1400e+00,  "PhiPi":1.1819e+00,  "KstK":1.1958e+00},  "Fixed":True}
    configdict["DsCombinatorialShape"]["n1"]      = {"Run1": {"KKPi":1.1892e+01,  "PhiPi":4.9291e+01,  "KstK":1.7661e+01},  "Fixed":True}
    configdict["DsCombinatorialShape"]["n2"]      = {"Run1": {"KKPi":7.6655e+00,  "PhiPi":4.9162e+00,  "KstK":9.4543e+00},  "Fixed":True}
    configdict["DsCombinatorialShape"]["frac"]    = {"Run1": {"KKPi":0.50,        "PhiPi":0.50,        "KstK":0.50},        "Fixed":True}
    configdict["DsCombinatorialShape"]["R"]       = {"Run1": {"KKPi":1.00,        "PhiPi":1.5,         "Kstk":1.5},         "Fixed":False}
    configdict["DsCombinatorialShape"]["cD"]      = {"Run1": {"KKPi":-5.7520e-03, "PhiPi":-5.7273e-03, "KstK":-8.3967e-03}, "Fixed":False}
    configdict["DsCombinatorialShape"]["fracD"]   = {"Run1": {"KKPi":0.88620,      "PhiPi":0.37379,    "KstK":0.59093},     "Fixed":False}
    ...
    configdict["PIDKCombinatorialShape"]["fracPIDK1"]   = { "Run1":{"KKPi":0.9, "PhiPi":0.9, "KstK":0.9, "KPiPi":0.8, "PiPiPi":0.8 }, "Fixed":False }
    configdict["PIDKCombinatorialShape"]["fracPIDK2"]   = { "Run1":{"KKPi":0.9, "PhiPi":0.9, "KstK":0.9, "KPiPi":0.8, "PiPiPi":0.8 }, "Fixed":False }
    ...
    #expected yields                                                                                                                                                       
    configdict["Yields"] = {}
    configdict["Yields"]["Bd2DsPi"]         = {"2011": { "KKPi":400.0,   "PhiPi":500.0,   "KstK":500.0},
                                               "2012": { "KKPi":400.0,   "PhiPi":500.0,   "KstK":500.0},  "Fixed":False}
    configdict["Yields"]["Bd2DPi"]          = {"2011": { "KKPi":50.4,    "PhiPi":3.5,     "KstK":10.3},
                                               "2012": { "KKPi":150.9,   "PhiPi":7.8,     "KstK":21.4},  "Fixed":True}
    configdict["Yields"]["Lb2LcPi"]         = {"2011": { "KKPi":140.4,   "PhiPi":30.7,    "KstK":46.2},
                                               "2012": { "KKPi":482.4,   "PhiPi":64.7,    "KstK":108.0},  "Fixed":True}
    configdict["Yields"]["Bs2DsK"]          = {"2011": { "KKPi":30.5,    "PhiPi":77.8,    "KstK":41.6},
                                               "2012": { "KKPi":116.2,    "PhiPi":184.1,   "KstK":121.0}, "Fixed":True}
    configdict["Yields"]["Bs2DsDsstPiRho"]  = {"2011": { "KKPi":10000.0, "PhiPi":10000.0, "KstK":10000.0},
                                               "2012": { "KKPi":20000.0, "PhiPi":20000.0, "KstK":20000.0}, "Fixed":False}
    configdict["Yields"]["CombBkg"]         = {"2011": { "KKPi":10000.0, "PhiPi":10000.0, "KstK":10000.0},
                                               "2012": { "KKPi":50000.0, "PhiPi":20000.0, "KstK":20000.0},"Fixed":False}
    configdict["Yields"]["Signal"]          = {"2011": { "KKPi":10000.0, "PhiPi":10000.0, "KstK":10000.0},
                                               "2012": { "KKPi":100000.0, "PhiPi":20000.0, "KstK":20000.0},"Fixed":False}
