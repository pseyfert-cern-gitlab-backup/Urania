...
export save=${workpath}"work_dpi_mc_large_largetime.root"
...
export save=${workpath}"work_dpi_mc_splinePreCalib_truetime.root"
export conf="/afs/cern.ch/user/v/vibattis/cmtuser/UraniaDev_v6r1/PhysFit/B2DXFitters/data/Bd2DPi_3fbCPV/Bd2DPi/Bd2DPiConfigForWorkspace_PiHypo_MC_splinePreCalib.py"
#${runpath}run python ${scriptpath}prepareWorkspace.py --noRooKeysPdf --Signal --debug -s $save --configName $conf
#rm Trash/*.root
