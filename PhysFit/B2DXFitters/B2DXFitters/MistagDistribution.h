...
class MistagDistribution : public RooAbsPdf {
	...
	TObject* clone(const char* newname) const override { return new MistagDistribution(*this,newname); }
	virtual ~MistagDistribution();

	Int_t getAnalyticalIntegral(RooArgSet& integ, RooArgSet& anaIntSet, const char* rangeName = 0) const override;
