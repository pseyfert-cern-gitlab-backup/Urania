...
public:
    ...
    /// clone method
    RooSwimmingAcceptance* clone(const char* newname) const override { return new RooSwimmingAcceptance(*this, newname); }
    ...
    std::complex<double> productAnalyticalIntegral(Double_t umin, Double_t umax, Double_t scale, Double_t offset, const std::complex<double>& z) const override;
