...
eventFracs       = [  dict( N_sigMass = 0.711, N_cbkgMass = 0.095, N_cbkg2Mass = 0.067, N_cbkg3Mass = None )
...
if not simulation :
    ...
    nBackground3 = nEvents * ( 1. - sigFrac - bkgFrac - bkg2Frac )
    ...
    massComps  = [ sigMassComps, cbkgMassComps, cbkg2MassComps, cbkg3MassComps ]
...
#    from P2VV.Parameterizations.MassPDFs import BreitWigner_Signal_Mass as SignalBMass
...
#    from P2VV.Parameterizations.MassPDFs import Bs2JpsieePhi_BkgChebychev_Mass as BackgroundBMass
    ...
    cbkg2MassArgs = dict( Name = 'cbkg2_m', mass = observables['mass'], Mean = 4700 )
    ...
    cbkg3MassArgs = dict( Name = 'cbkg3_m', mass = observables['mass'], Mean = 5100 )
...
if not simulation :
    ...
    weightVars = [ ]
    for wName in [ 'N_sigMass_sw', 'N_cbkgMass_sw', 'N_cbkg2Mass_sw', 'N_cbkg3Mass_sw' ] :
...
if not simulation :
    ...
    dataSets['cbkg3SWeight'] = ( RooDataSet( 'JpsiKK_cbkg2SWeight', 'JpsiKK_cbkg3SWeight', obsSets['N_cbkg3Mass_sw']
...
if not simulation and plotsFilePath :
    ...
    from ROOT import TCanvas, kBlue, kRed, kGreen, kMagenta, kViolet, kFullDotLarge, TPaveText
