...
{ 
	...
	fitter.setnCPU(4);
	fitter.loadWS(("/afs/cern.ch/user/l/lohenry/cmtuser/Urania_v2r4/PhysFit/V0hhFitter/KShh/WS/Fit-WS-"+option+"-Louis-"+selectionType+"-"+otherComb+"-Standard.root").c_str(),"newDesktop");
	fitter.attachFile(("/afs/cern.ch/user/l/lohenry/cmtuser/Urania_v2r4/PhysFit/V0hhFitter/KShh/temp/Temp-SystII-CombShape-"+otherComb+"-"+option+"-"+selectionType+"-"+combModel+"-"+name+".root").c_str(),"RECREATE");
	...
	toy.saveResults(("/afs/cern.ch/user/l/lohenry/cmtuser/Urania_v2r4/PhysFit/V0hhFitter/KShh/temp/SystII-CombShape-"+otherComb+"-"+option+"-"+selectionType+"-"+combModel+"-"+name+".root").c_str());
	return 0;
}
