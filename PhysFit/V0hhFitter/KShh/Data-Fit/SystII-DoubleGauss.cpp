...
{ 
	...
	fitter.setnCPU(4);
	fitter.loadWS(("/afs/cern.ch/user/l/lohenry/cmtuser/Urania_v2r4/PhysFit/V0hhFitter/KShh/WS/Data-WS-"+selectionType+"-DoubleGauss.root").c_str(),"newDesktop");
	fitter.attachFile(("/afs/cern.ch/user/l/lohenry/cmtuser/Urania_v2r4/PhysFit/V0hhFitter/KShh/temp/Temp-SystII-DoubleGauss-"+selectionType+"-"+name+".root").c_str(),"RECREATE");
	...
	fitter_official.loadWS((saveDir+"WS/Data-WS-"+selectionType+"-Vanilla"+".root").c_str(), "newDesktop", false );
