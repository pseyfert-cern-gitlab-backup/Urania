...
//    part_reco.insert(std::make_pair("KK","Bu2Kstphi2KS0piKK"));
    ...
    TString file_WS_Sig   = (saveDir+"WS/MC-Sig-WS-"+selectionType+".root").c_str(); 
    ...
    */
    ...
    fitter.addConstraint("combinatoric_KSKKLL_2011_pdf_slope","@0*@1","combinatoric_KSKKDD_2011_pdf_slope,ratio_combinatoric_2011");
    fitter.addConstraint("combinatoric_KSKKLL_2012a_pdf_slope","@0*@1","combinatoric_KSKKDD_2012a_pdf_slope,ratio_combinatoric_2012a");
    fitter.addConstraint("combinatoric_KSKKLL_2012b_pdf_slope","@0*@1","combinatoric_KSKKDD_2012b_pdf_slope,ratio_combinatoric_2012b");
    fitter.addConstraint("combinatoric_KSKpiLL_2011_pdf_slope","@0*@1","combinatoric_KSKpiDD_2011_pdf_slope,ratio_combinatoric_2011");
    fitter.addConstraint("combinatoric_KSKpiLL_2012a_pdf_slope","@0*@1","combinatoric_KSKpiDD_2012a_pdf_slope,ratio_combinatoric_2012a");
    fitter.addConstraint("combinatoric_KSKpiLL_2012b_pdf_slope","@0*@1","combinatoric_KSKpiDD_2012b_pdf_slope,ratio_combinatoric_2012b");
    fitter.addConstraint("combinatoric_KSpiKLL_2011_pdf_slope","@0*@1","combinatoric_KSpiKDD_2011_pdf_slope,ratio_combinatoric_2011");
    fitter.addConstraint("combinatoric_KSpiKLL_2012a_pdf_slope","@0*@1","combinatoric_KSpiKDD_2012a_pdf_slope,ratio_combinatoric_2012a");
    fitter.addConstraint("combinatoric_KSpiKLL_2012b_pdf_slope","@0*@1","combinatoric_KSpiKDD_2012b_pdf_slope,ratio_combinatoric_2012b");
    ...
    */
    ...
    if (vm.count("integral"))
    {
       ...
       while ( (arg = dynamic_cast<RooRealVar*>( iter->Next() ) ) ) {
          ...
          } else if (varName == "Bd2KSpipiDD_2011_pdf_sigma"){ sigmaDD = arg->getVal();
          } else if (varName == "Bd2KSpipiLL_2011_pdf_sigma"){ sigmaLL = arg->getVal();
