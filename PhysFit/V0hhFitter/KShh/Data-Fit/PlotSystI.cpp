...
int main(int argc, char* argv[])
{
  ...
  while (i < 200) //Cap
	  {
		  std::stringstream ss;
		  ss << i;
		  temp = TFile::Open(("/afs/cern.ch/user/l/lohenry/cmtuser/Urania_v2r4/PhysFit/V0hhFitter/KShh/temp/SystI-PartReco-"+selectionType+"-"+ss.str()+".root").c_str());
		  if (!temp)
			  break;
		  temp->Close();
  ...
  fPulls.plotSystI("KShh/temp/plots/","MIAMIA",2);
