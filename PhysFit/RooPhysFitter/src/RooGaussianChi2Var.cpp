...
//ClassImp(RooGaussianChi2Var);

RooArgSet RooGaussianChi2Var::_emptySet ;

/*
//-----------------------------------------------------------------------------
// Implementation file for class : RooGaussianChi2Var
//
...
//////////////////////////////////////////////////////////////////////////////
// 
// Class RooGaussianChi2Var implements a the Pearson's chi^2 statistical test
...
//=============================================================================
*/
RooGaussianChi2Var::RooGaussianChi2Var(const char *name, const char* title,
  ...
  RooAbsOptTestStatistic(name,title,func,hdata,_emptySet,
                         RooCmdConfig::decodeStringOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var",
                                                            "RangeWithName",0,"",arg1,arg2,arg3,
                                                            arg4,arg5,arg6,arg7,arg8,arg9),
                         0,
                         RooCmdConfig::decodeIntOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","NumCPU",0,1,
                                                         arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9),
                         RooFit::Interleave,
                         RooCmdConfig::decodeIntOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","Verbose",
                                                         0,1,arg1,arg2,arg3,arg4,arg5,
                                                         arg6,arg7,arg8,arg9),
                         0)
{

    RooCmdConfig pc("RooGaussianChi2Var::RooGaussianChi2Var") ;
...
RooGaussianChi2Var::RooGaussianChi2Var(const char *name, const char* title,
        ...
        RooAbsOptTestStatistic(name,title,pdf,hdata,
                               *(const RooArgSet*)RooCmdConfig::decodeObjOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var",
                                                                                  "ProjectedObservables",
                                                                                  0,&_emptySet
                                                                                  ,arg1,arg2,arg3,arg4,
                                                                                  arg5,arg6,arg7,arg8,arg9),
                               RooCmdConfig::decodeStringOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","RangeWithName",
                                                                  0,"",arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9),
                               RooCmdConfig::decodeStringOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","AddCoefRange",
                                                                  0,"",arg1,arg2,arg3,arg4,arg5,
                                                                  arg6,arg7,arg8,arg9),
                               RooCmdConfig::decodeIntOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","NumCPU",0,1,
                                                               arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9),
                               RooFit::Interleave,
                               RooCmdConfig::decodeIntOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","Verbose",0,1,
                                                               arg1,arg2,arg3,arg4,arg5,arg6,arg7,
                                                               arg8,arg9),
                               RooCmdConfig::decodeIntOnTheFly("RooGaussianChi2Var::RooGaussianChi2Var","SplitRange",
                                                               0,0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,
                                                               arg8,arg9))
        //  RooGaussianChi2Var constructor. Optional arguments taken
        //
...
RooGaussianChi2Var::RooGaussianChi2Var(const char *name, const char *title,
                                       ...
                                       RooGaussianChi2Var::FuncMode fmode,
                                       const char* cutRange,
                                       const char* addCoefRange,
                                       Int_t nCPU,
                                       RooFit::MPSplit interleave,
...
RooGaussianChi2Var::RooGaussianChi2Var(const RooGaussianChi2Var& other, const char* name) :
...
// Destructor
//=============================================================================
RooGaussianChi2Var::~RooGaussianChi2Var()
{}

//=============================================================================

Double_t RooGaussianChi2Var::evaluatePartition(Int_t firstEvent,
        Int_t lastEvent,
        Int_t stepSize) const
{
    ...
    for (i=firstEvent ; i<lastEvent ; i+=stepSize)
    {
        ...
        if (eInt==0. && nData==0. && nPdf==0)
        {
            continue ;
        }

        // Reject bins where eInt=0
        if (eInt==0.)
        {
            coutI(Eval) << "RooGaussianChi2Var::RooGaussianChi2Var(" << GetName() << ") : bin " << i
            << " has zero error, but function is not zero (" << nPdf << "). "
            << "Will ignore this bin. " << endl ;
            continue;
        }

        ccoutD(Eval) << "Chi2Var[" << i << "]" << " nData = " << nData << " nPdf = " << nPdf << " errorExt = "
        << eExt << " errorInt = " << eInt << " contrib = " << eExt*eExt/(eInt*eInt) << endl ;
