...
//ClassImp(RooYatesChi2Var);

RooArgSet RooYatesChi2Var::_emptySet ;

/*
//-----------------------------------------------------------------------------
// Implementation file for class : RooYatesChi2Var
//
...
//////////////////////////////////////////////////////////////////////////////
// 
// Class RooYatesChi2Var implements a the Pearson's chi^2 statistical test
// with Yates' correction for continuity from a binned dataset and a PDF.
// The Yates' corrected chi^2 test statistic is calculated as 
//
//             / |(f_PDF * N_tot/ V_bin) - N_bin| - 0.5 \+2
//  Sum[bins] |  -------------------------------------- |
//            \                  N_bin                 /
//
...
RooYatesChi2Var::RooYatesChi2Var(const char *name, const char* title,
        ...
        RooAbsOptTestStatistic(name,title,func,hdata,_emptySet,
                               RooCmdConfig::decodeStringOnTheFly("RooYatesChi2Var::RooYatesChi2Var",
                                                                  "RangeWithName",0,"",arg1,arg2,arg3,
                                                                  arg4,arg5,arg6,arg7,arg8,arg9),
                               0,
                               RooCmdConfig::decodeIntOnTheFly("RooYatesChi2Var::RooYatesChi2Var","NumCPU",0,1,
                                                               arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9),
                               RooFit::Interleave,
                               RooCmdConfig::decodeIntOnTheFly("RooYatesChi2Var::RooYatesChi2Var","Verbose",
                                                               0,1,arg1,arg2,arg3,arg4,arg5,
                                                               arg6,arg7,arg8,arg9),
                               0)
{

    RooCmdConfig pc("RooYatesChi2Var::RooYatesChi2Var") ;
...
RooYatesChi2Var::RooYatesChi2Var(const char *name, const char* title,
        ...
        RooAbsOptTestStatistic(name,title,pdf,hdata,
                               *(const RooArgSet*)RooCmdConfig::decodeObjOnTheFly("RooYatesChi2Var::RooYatesChi2Var",
                                       "ProjectedObservables",
                                       0,&_emptySet
                                       ,arg1,arg2,arg3,arg4,
                                       arg5,arg6,arg7,arg8,arg9),
                               RooCmdConfig::decodeStringOnTheFly("RooYatesChi2Var::RooYatesChi2Var","RangeWithName",
                                                                  0,"",arg1,arg2,arg3,arg4,arg5,
                                                                  arg6,arg7,arg8,arg9),
                               RooCmdConfig::decodeStringOnTheFly("RooYatesChi2Var::RooYatesChi2Var","AddCoefRange",
                                                                  0,"",arg1,arg2,arg3,arg4,arg5,
                                                                  arg6,arg7,arg8,arg9),
                               RooCmdConfig::decodeIntOnTheFly("RooYatesChi2Var::RooYatesChi2Var","NumCPU",0,1,
                                                               arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9),
                               RooFit::Interleave,
                               RooCmdConfig::decodeIntOnTheFly("RooYatesChi2Var::RooYatesChi2Var","Verbose",0,1,
                                                               arg1,arg2,arg3,arg4,arg5,arg6,arg7,
                                                               arg8,arg9),
                               RooCmdConfig::decodeIntOnTheFly("RooYatesChi2Var::RooYatesChi2Var","SplitRange",
                                                               0,0,arg1,arg2,arg3,arg4,arg5,arg6,arg7,
                                                               arg8,arg9))
        //  RooYatesChi2Var constructor. Optional arguments taken
        //
...
RooYatesChi2Var::RooYatesChi2Var(const char *name, const char *title,
                                 ...
                                 RooYatesChi2Var::FuncMode fmode,
                                 const char* cutRange,
                                 const char* addCoefRange,
                                 Int_t nCPU,                                        
                                 RooFit::MPSplit interleave,
...
RooYatesChi2Var::RooYatesChi2Var(const RooYatesChi2Var& other, const char* name) :
...
// Destructor
//=============================================================================
RooYatesChi2Var::~RooYatesChi2Var()
{}

//=============================================================================

Double_t RooYatesChi2Var::evaluatePartition(Int_t firstEvent,
        Int_t lastEvent,
        Int_t stepSize) const
{
    ...
    for (i=firstEvent ; i<lastEvent ; i+=stepSize)
    {
        ...
        Double_t eExt = TMath::Abs(nPdf-nData) - 0.5;
        ...
        if (nData==0.)
        {
            coutI(Eval) << "RooYatesChi2Var::RooYatesChi2Var(" << GetName()
            << ") : bin " << i
        ...
        ccoutD(Eval) << "YatesChi2Var[" << i << "]" << " nData = " << nData << " nPdf = " << nPdf << " errorExt = "
