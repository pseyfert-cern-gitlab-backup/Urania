// $Id: $
#ifndef ROOPHYSFITTER_ROOGAUSSIANCHI2VAR_H
#define ROOPHYSFITTER_ROOGAUSSIANCHI2VAR_H 1
...
/** @class RooGaussianChi2Var RooGaussianChi2Var.h RooPhysFitter/RooGaussianChi2Var.h
 *  
 *
...
class RooGaussianChi2Var : public RooAbsOptTestStatistic
{
public:
    enum FuncMode { Function, Pdf, ExtendedPdf };

    /// constructors
    RooGaussianChi2Var( const char* name, const char* title,
    ...
    RooGaussianChi2Var(const char* name, const char* title,
                       ...
                       RooGaussianChi2Var::FuncMode funcMode,
    ...
    /// copy constructor
    RooGaussianChi2Var(const RooGaussianChi2Var& other, const char* name=0);
  ...
  {
        // Virtual constructor
        return new RooGaussianChi2Var(name,title,(RooAbsPdf&)pdf,
                                      (RooDataHist&)dhist,projDeps,
                                      _funcMode,rangeName,
                                      addCoefRangeName,nCPU,interleave,
                                      verbose, splitCutRange,_etype) ;
    }

    virtual ~RooGaussianChi2Var( ); ///< Destructor

    /// virtual clone method
    virtual TObject* clone(const char* newname) const
    {
        return new RooGaussianChi2Var(*this,newname);
    }
...
protected:
    ...
    RooGaussianChi2Var::FuncMode _funcMode; // Function, p.d.f. or extended p.d.f.
    virtual Double_t evaluatePartition(Int_t firstEvent, Int_t lastEvent,
                                       Int_t stepSize) const;
    ClassDef(RooGaussianChi2Var,1);

private:

};
#endif // ROOPHYSFITTER_ROOGAUSSIANCHI2VAR_H
