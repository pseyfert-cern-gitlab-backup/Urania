...
/// Bd -->JpsiK*
 ...
 ClassImp(RooExpAndGaussInv) 

 RooExpAndGaussInv::RooExpAndGaussInv(const char *name, const char *title, 
                        RooAbsReal& _x,
                        RooAbsReal& _sh_mean,
 ...
 RooExpAndGaussInv::RooExpAndGaussInv(const RooExpAndGaussInv& other, const char* name) :  
 ...
 Double_t RooExpAndGaussInv::evaluate() const 
 { 
