             ...
             Bool_t exitOnBadFit)
{
  ...
  TString muonUnBiasedCut = TString::Format("%s_MuonTisTagged==1", pName);
  ...
  //==================================================//
  /* massFitter->MakeDMassSigTriGauss(jpsiMassPDG, jpsiMassPDG-5, jpsiMassPDG+5,
                                   12.0, 8.0, 18.0,
                                   2.0, 1.0, 4.0,
                                   5.0, 1.0, 7.0,
                                   0.3,
...
//  plotParams+=",dmass_bkg_poly_c1,dmass_bkg_poly_c2";
  ...
  //==================================================//
  RooPlot* rp_probnnpi = massFitter->PlotVariable("Mu_ProbNNpi",
                                                 "", "", kTRUE);
  ...
  RooPlot* rp_probnnmu = massFitter->PlotVariable("Mu_ProbNNmu",
                                                 "", "isMuonRange", kTRUE);
...
int main(int argc, char *argv[])
{
  ...
  ssMap muonNames = bass::map_list_of("Positive", "Mu0")("Negative", "Mu1");
  // map of charge to other muon name
  ssMap otherMuonNames = bass::map_list_of("Positive", "Mu1")("Negative", "Mu0");
