...
int main(int argc, char *argv[])
{
  ...
  // Fit -ve, Low P tracks 
  //---------------------------------------------------//
  Lam0Fit_MuonUnBiased(t_lo,
          "Negative",
          "LoP",
          argv[1],
          "Lam0Calib",
          TString::Format("%s/Lam0_MuonUnBiased_%sMinus_LoP_Mag%s_Strip%s_%s.root",
                          argv[5],
                          argv[1],
                          argv[2],
                          argv[3],
  ...
  //---------------------------------------------------//
  Lam0Fit_MuonUnBiased(t_hi,
          "Negative",
          "HiP",
          argv[1],
          "Lam0Calib",
          TString::Format("%s/Lam0_MuonUnBiased_%sMinus_HiP_Mag%s_Strip%s_%s.root",
                          argv[5],
                          argv[1],
                          argv[2],
                          argv[3],
  ...
  Lam0Fit_MuonUnBiased(t_lo,
          ...
          argv[1],
          "Lam0Calib",
          TString::Format("%s/Lam0_MuonUnBiased_%sPlus_LoP_Mag%s_Strip%s_%s.root",
                          argv[5],
                          argv[1],
                          argv[2],
                          argv[3],
  ...
  Lam0Fit_MuonUnBiased(t_hi,
          ...
          argv[1],
          "Lam0Calib",
          TString::Format("%s/Lam0_MuonUnBiased_%sPlus_HiP_Mag%s_Strip%s_%s.root",
                          argv[5],
                          argv[1],
                          argv[2],
                          argv[3],
