...
//-----------------------------------------------------------------------------
// Implementation file for class : MergeProtonLines_MuonUnBiased
//
// 2012-26-09 : Juan Martin Otalora Goicochea
//
// Example Usage:
// $CALIBDATASCRIPTSROOT/$CMTCONFIG/MergeProtonLines_MuonUnBiased.exe $PWD P Plus Up 19 $PWD 0
//-----------------------------------------------------------------------------
int main(int argc, char *argv[])
{
  ...
  m_ws->writeToFile(TString::Format("%s/Lam0_MuonUnBiased_%s%s_Mag%s_Strip%s_%s.root",
                                    argv[6],
                                    argv[2],
                                    argv[3],
                                    argv[4],
                       ...
                       RooWorkspace*& ws)
{
  ...
  // Open file
  //=============================================================================
  f = new TFile(TString::Format(path+"Lam0_MuonUnBiased_%s%s_%sP_Mag%s_Strip%s_%s.root",
                                PartName,
                                Charge,
                                MomType,
                                FieldPolarity,
