...
int main(int argc, char *argv[])
{
  ...
  RooWorkspace* Myws_VhiP = NULL;
  RooDataSet* Mydata_VhiP = getDataSet(argv[1],
                                      "P",
                                      argv[3],
                                      "Vhi",
                                      argv[4],
...
cout<<"****** VhiP Sum:   "<<Mydata_VhiP->numEntries()<<endl;
  ...
  m_ws->writeToFile(TString::Format("%s/Lam0_%s%s_Mag%s_Strip%s_%s.root",
                                    argv[6],
                                    "P",
                                    argv[3],
                                    argv[4],
                       ...
                       RooWorkspace*& ws)
{
  ...
  // Open file
  //=============================================================================
  f = new TFile(TString::Format(path+"Lam0_P%s_%sP_Mag%s_Strip%s_%s.root",
                                                                Charge,
                                MomType,
                                FieldPolarity,
                                StripVersion,
  ...
  if(f==NULL)
  {
    cerr<<"No File "<<TString::Format(path+"Lam0_P%s_%sP_Mag%s_Strip%s_%s.root",
