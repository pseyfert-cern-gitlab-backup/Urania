...
int main(int argc, char *argv[])
{
  ...
  if((strcmp(argv[1],"DSt")==0)||(strcmp(argv[1],"DSt_MuonUnBiased")==0)) {
    ...
    ws_name = "JpsiCalib";
  } else if(strcmp(argv[1],"LcfB")==0) {
    ws_name = "IncLcCalib";
  } else if(strcmp(argv[1],"TotLc")==0) {
    ws_name = "IncLcCalib";
  ...
  if (strcmp(ws_name, "JpsieeCalib") == 0) {
    ...
    RooWorkspace* Myws_Neg_1Brem = NULL;
    RooDataSet* Mydata_Neg_1Brem = getDataSet(argv[2],
                                        argv[1],
                                        argv[3],
                                        "Minus",
                                        argv[4],
                                        ...
                                        bremSuffix,
                                        Myws_Neg_1Brem);
    if(Mydata_Neg_1Brem==NULL)
    {
      cerr<<"DataSet (Negative, 1 brem) not found"<<endl;
      return EXIT_FAILURE;
    }

    RooWorkspace* Myws_Pos_1Brem = NULL;
    RooDataSet* Mydata_Pos_1Brem = getDataSet(argv[2],
                                        argv[1],
                                        argv[3],
                                        "Plus",
                                        argv[4],
                                        ...
                                        bremSuffix,
                                        Myws_Pos_1Brem);
    if(Mydata_Pos_1Brem==NULL)
    {
      cerr<<"DataSet (Positive, 1 brem) not found"<<endl;
      return EXIT_FAILURE;
    }

    RooDataSet* DataSet_comb_1Brem = new RooDataSet(TString::Format("%s %s",argv[1],argv[3]).Data()
                                              ,"Combined DataSet"
                                              ,*Params
                                              ,Index(Charges)
                                              ,Import("Negative", *Mydata_Neg_1Brem)
                                              ,Import("Positive", *Mydata_Pos_1Brem)
                                              );


    DataSet_comb->append(*DataSet_comb_1Brem);


    DataSet_comb->Print("v");

    cout<<"****** Neg 0Brem Sum:    "<<Mydata_Neg->numEntries()  <<endl;
    cout<<"****** Pos 0Brem Sum:    "<<Mydata_Pos->numEntries()  <<endl;
    cout<<"****** Neg 1 Brem Sum: "<<Mydata_Neg_1Brem->numEntries()  <<endl;
    cout<<"****** Pos 1 Brem Sum: "<<Mydata_Pos_1Brem->numEntries()  <<endl;

    cout<<"****** Merged Sum:      "<<DataSet_comb->numEntries()<<endl;

    delete Mydata_Neg_1Brem;
    delete Mydata_Pos_1Brem;
