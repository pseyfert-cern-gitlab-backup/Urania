...
def chopTrees(fname_in, ntpname_list, fname_pkl, fileSuffix, out_path=''):
    ...
    for i, runRange in enumerate(runLims):
        ...
        #==================================================
        cut = '(Lc_BPVLTCHI2>100) && (fabs(Lc_WM_KKPi-1968)>25) && (fabs(Lc_WM_KKPi-1870)>25) && (fabs(Lc_WM_PiKPi-2010)>20) && (Lc_WM_PiKPi <1800 || Lc_WM_PiKPi >1905) && (p_Loki_MINIPCHI2>9) && (K_Loki_MINIPCHI2>9) && (pi_Loki_MINIPCHI2>9) && (K_V2ProbNNghost<0.35) && (pi_V2ProbNNghost<0.35) && (K_V2ProbNNk>0.3) && (pi_V2ProbNNpi>0.2) && (K_PT>400) && (pi_PT>400) && (runNumber >= {runMin:d}) && (runNumber <= {runMax:d})'.format(
