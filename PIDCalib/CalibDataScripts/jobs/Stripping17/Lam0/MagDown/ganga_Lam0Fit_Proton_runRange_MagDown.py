...
j = Job (
 name = 'Lam0Fit_Proton_MagDown_Strip17' ,
 ...
 application = Executable (
    exe = File('/home/$USER/cmtuser/Erasmus_v6r0/PIDCalib/CalibDataScripts/jobs/Lam0Job_runRange.sh'),
    args = ['57', 'P', 'Down', '17', '0', '175', '9']  
    ) ,
 outputdata = None ,
 splitter = None ,
 backend = bck
