...
do
    ...
    #DATA=/afs/cern.ch/work/j/jotalora/PID_Calib/gangadir/workspace/jotalora/LocalXML/${JOB_ID}/*/output/PID_Modes.root
    ...
    $CALIBDATASCRIPTSROOT/$CMTCONFIG/DStFit_MuonUnBiased.exe $PART_NAME $MAG_POL $STRIP_VER $n $OUT_DIR $MYDATA
    sleep 3
    $CALIBDATASCRIPTSROOT/$CMTCONFIG/MergeCharges.exe DSt_MuonUnBiased $OUT_DIR $PART_NAME $MAG_POL $STRIP_VER $OUT_DIR $n
    sleep 3
