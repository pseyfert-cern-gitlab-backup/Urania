...
treeList='[JpsiFromBNoPIDNoMipTuple/CalibPID,Lam02PPi_LoPTuple/CalibPID,Lam02PPi_HiPTuple/CalibPID]'
...
for jid in jobIDs:
    ...
    app= GaudiPython(
        ...
        script = [basedir+'/scripts/python/chopTrees_MUON.py'],
        args = ['--jobID=%d' %jid,
