...
# the 'CalibPID' nTuple
tupleDir = "DSt2D0Pi_D02RSKPiTuple"
...
maxEntries=int(1e10) # N.B. python treats numbers with exponents as floats
minFrac=0.8
stepFrac=0.01
...
#gangadir='/data/lhcb/users/malde/FakeGangadir/LocalXML'
