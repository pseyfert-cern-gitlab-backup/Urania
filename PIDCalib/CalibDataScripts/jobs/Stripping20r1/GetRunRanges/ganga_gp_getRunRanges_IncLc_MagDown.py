...
gangadir='%s/workspace/%s/%s' %(config['Configuration']['gangadir'], config['Configuration']['user'], config['Configuration']['repositorytype'])

print "Gangadir is: ",gangadir
# uncomment to use a different input directory
#gangadir='$DATADISK/gangadir_calib/workspace/powell/LocalXML'
#gangadir='/afs/cern.ch/work/z/zhangy/private/gangadir/workspace/zhangy/LocalXML'
