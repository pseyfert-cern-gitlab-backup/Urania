...
pbsopts = "-l cput=5:59:00,walltime=4:00:00"

# list of input directories (as a comma-separated list)
treeList='Lb2LcMuNu_Lc2PKiPiTuple'
...
for jid in jobIDs:
    ...
    print  UraniaVersion, platform, jid, pklFile,  treeList, gangadir, fileSuffix, splitIDs
    ...
    app= Executable(
        exe = basedir+'/scripts/sh/ChopTrees_LcfB.sh',
        )
