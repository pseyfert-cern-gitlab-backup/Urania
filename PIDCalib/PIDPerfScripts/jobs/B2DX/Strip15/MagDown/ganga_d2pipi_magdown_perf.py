...
j = Job (
 name = 'B2DX_EvtData_B2DPi_D2PiPi_MagDown_Perf_Strip15' ,
 ...
 application = Executable (
    exe = File('/home/powell/cmtuser/Erasmus_v6r0/PIDCalib/PIDPerfScripts/jobs/JobPerf.sh'),
    args = ['Down', 'pipi', '153', '14'] 
    ) ,
 outputdata = None ,
 splitter = None ,
 backend = bck
