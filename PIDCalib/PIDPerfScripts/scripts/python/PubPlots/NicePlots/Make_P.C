{
  	...
  	TFile PasP("PubPlots_P_as_P.root");
  	
  	TFile PiasP("PubPlots_Pi_as_P.root");
  	
  	TH1F* Pion_0 = (TH1F*)PiasP.Get("Pi_DLLp > 0.0_All");
  	TH1F* Pion_5 = (TH1F*)PiasP.Get("Pi_DLLp > 5.0_All");
  	
  	TH1F* Proton_0 = (TH1F*)PasP.Get("P_DLLp > 0.0_All");
  	TH1F* Proton_5 = (TH1F*)PasP.Get("P_DLLp > 5.0_All");
    ...
    c1->SetBottomMargin(0.161017);
 	...
 	PlotFourTH1FwErrors(Proton_0,Pion_0,Proton_5, Pion_5);
    ...
    leg1->AddEntry(Proton_5,"","pe");
  	...
  	lhcbLatex->DrawLatex(25000, 0.30, "#pi #rightarrow p");
	...
	TMarker* Marker_Pion_5 = new TMarker(66000, 1.125, 21);
  	...
  	c1->Print("Plot_2017Validation_PPi_P.eps");
  	c1->Print("Plot_2017Validation_PPi_P.pdf");
