{
  ...
  TFile Scan_1_d("PerfCurve_KVsPi_Strip20_MagDown_DLLK>K_hasRich>0 && nTracks>0 && nTracks<100.root");
 TFile Scan_2_d("PerfCurve_KVsPi_Strip20_MagDown_DLLK>K_hasRich>0 && nTracks>100 && nTracks<200.root");
...
TFile Scan_1_u("PerfCurve_KVsPi_Strip20_MagUp_DLLK>K_hasRich>0 && nTracks>0 && nTracks<100.root");
 ...
 Kpi1_Scan->SetLineColor(kOrange+1);
  Kpi1_Scan->SetMarkerColor(kOrange+1);
  Kpi1_Scan->SetMarkerSize(1.1);
  Kpi1_Scan->SetMarkerStyle(20);
  Kpi2_Scan->SetLineColor(kRed);
  Kpi2_Scan->SetMarkerColor(kRed);
  Kpi2_Scan->SetMarkerSize(1.1);
  Kpi2_Scan->SetMarkerStyle(21);
 ...
 leg = new TLegend(0.17,0.52,0.44,0.92);
  ...
  leg->AddEntry(Kpi1_Scan,"[0,100]","lp");
  leg->AddEntry(Kpi2_Scan,"[100,200]","lp");
