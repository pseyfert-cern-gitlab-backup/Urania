...
if __name__=='__main__':
    ...
    parser = ShowArgumentsParser(
        ...
        description=("""Make histograms of PID performance vs. """
        """momentum (or another varaible in the dataset) for a given:
        a) Stripping version <stripVersion> (e.g. \"20\")
        b) magnet polarity  <magPol> (\"MagUp\" or \"MagDown\")
        c) particle type <partName> (\"K\", \"P\", \"Pi\", \"e\" \"P_IncLc"\, or \"Mu\")
