...
TPaveText *lhcb7TeVPrelimBR = new TPaveText(0.70 - lhcbStyle->GetPadRightMargin(),
                                            0.25 - lhcbStyle->SetPadTopMargin(0.05),
                                            0.95 - lhcbStyle->GetPadRightMargin(),
                                            0.35 - lhcbStyle->SetPadTopMargin(0.05),
					   "BRNDC");
lhcb7TeVPrelimBR->SetFillColor(0);
lhcb7TeVPrelimBR->SetTextAlign(12);
lhcb7TeVPrelimBR->SetBorderSize(0);
lhcb7TeVPrelimBR->AddText("#splitline{#splitline{LHCb}{Preliminary}}{#scale[0.7]{#sqrt{s} = 7 TeV Data}}");

TPaveText *lhcb0_9TeVPrelimR = new TPaveText(0.70 - lhcbStyle->GetPadRightMargin(),
                                             0.75 - lhcbStyle->SetPadTopMargin(0.05),
                                             0.95 - lhcbStyle->GetPadRightMargin(),
                                             0.85 - lhcbStyle->SetPadTopMargin(0.05),
                                             "BRNDC");
lhcb0_9TeVPrelimR->SetFillColor(0);
lhcb0_9TeVPrelimR->SetTextAlign(12);
lhcb0_9TeVPrelimR->SetBorderSize(0);
lhcb0_9TeVPrelimR->AddText("#splitline{#splitline{LHCb}{Preliminary}}{#scale[0.7]{#sqrt{s} = 900 eV Data}}");
...
TPaveText *lhcb7TeVMCL = new TPaveText(lhcbStyle->GetPadLeftMargin() + 0.05,
					   0.78 - lhcbStyle->SetPadTopMargin(0.05),
					   lhcbStyle->GetPadLeftMargin() + 0.30,
					   0.88 - lhcbStyle->SetPadTopMargin(0.05),
					   "BRNDC");
lhcb7TeVMCL->SetFillColor(0);
lhcb7TeVMCL->SetTextAlign(12);
lhcb7TeVMCL->SetBorderSize(0);
lhcb7TeVMCL->SetTextSize(0.07);
lhcb7TeVMCL->AddText("#splitline{#splitline{LHCb}{Monte Carlo}}{#scale[0.7]{#sqrt{s} = 7 TeV}}");
