...
void BinnedKernelDensity::init(AbsPhaseSpace* thephaseSpace, 
  ...
  Logger::print(0,"%20.20s INFO: Creating binned kernel density over %dD phase space\n", m_name, m_dim ); 
  
  if (m_binning.size() != m_dim) {
    Logger::print(0,"%20.20s ERROR: Dimensionality of phase space (%d) does not match binning vector size (%d)\n", 
